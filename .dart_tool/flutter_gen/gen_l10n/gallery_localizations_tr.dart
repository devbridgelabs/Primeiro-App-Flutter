...
class GalleryLocalizationsTr extends GalleryLocalizations {
  ...
  @override
  String get bannerDemoText => 'Şifreniz diğer cihazınızda güncellendi. Lütfen tekrar oturum açın.';
  ...
  @override
  String get cardsDemoTravelDestinationTitle1 => 'Tamil Nadu\'da Gezilecek İlk 10 Şehir';
  ...
  @override
  String get cardsDemoTravelDestinationTitle2 => 'Güney Hindistan\'ın Zanaatkarları';
  ...
  @override
  String get replyDescription => 'Verimli, hedef odaklı bir e-posta uygulaması';
  ...
  @override
  String get rallyAccountDetailDataAnnualPercentageYield => 'Yıllık Faiz Getirisi';
  ...
  @override
  String get rallyAccountDetailDataInterestPaidLastYear => 'Geçen Yıl Ödenen Faiz';
  ...
  String rallyAlertsMessageHeadsUpShopping(Object percent) {
    return 'Dikkat! Bu ayki alışveriş bütçenizi $percent oranında harcadınız.';
  }
  ...
  String rallyAlertsMessageATMFees(Object amount) {
    return 'Bu ay $amount ATM komisyonu ödediniz';
  }
  ...
  String rallyAlertsMessageUnassignedTransactions(num count) {
    return intl.Intl.pluralLogic(
      count,
      locale: localeName,
      one: 'Olası vergi iadenizi artırın. 1 atanmamış işleme kategoriler atayın.',
      other: 'Olası vergi iadenizi artırın. $count atanmamış işleme kategoriler atayın.',
    );
  }
  ...
  @override
  String get demoOptionsFeatureDescription => 'Bu demodaki kullanılabilir seçenekleri görmek için buraya dokunun.';
  ...
  @override
  String get demoAppBarTitle => 'Uygulama çubuğu';

  @override
  String get demoAppBarSubtitle => 'Geçerli ekranla ilgili bilgileri ve işlemleri gösterir';

  @override
  String get demoAppBarDescription => 'Uygulama çubuğu, geçerli ekranla ilgili içerikleri ve işlemleri gösterir. Bu çubuk; marka bilinci oluşturma, ekran başlıkları, gezinme ve işlemler için kullanılır';

  @override
  String get demoBottomAppBarTitle => 'Alt uygulama çubuğu';

  @override
  String get demoBottomAppBarSubtitle => 'Gezinmeyi ve işlemleri altta gösterir';

  @override
  String get demoBottomAppBarDescription => 'Alt uygulama çubuğu, hem alt gezinme çekmecesine hem de kayan işlem düğmesi dahil olmak üzere dörde kadar işleme erişim sağlar.';
  ...
  @override
  String get demoBannerDescription => 'Bannerlar önemli kısa mesajlar görüntüler ve kullanıcıların yerine getirmeleri (veya banner\'ı kapatmaları) için işlemler sunar. Banner\'ın kapanması için kullanıcının işlem yapması gerekir.';

  @override
  String get demoBottomNavigationTitle => 'Alt gezinme';

  @override
  String get demoBottomNavigationSubtitle => 'Çapraz şeffaflaşan görünümlü alt gezinme';
  ...
  @override
  String get demoBottomNavigationDescription => 'Alt gezinme çubukları, ekranın altında 3 ila beş arasında varış noktası görüntüler. Her bir varış noktası bir simge ve tercihe bağlı olarak metin etiketiyle temsil edilir. Kullanıcı, bir alt gezinme simgesine dokunduğunda, bu simge ile ilişkilendirilmiş üst düzey gezinme varış noktasına gider.';

  @override
  String get demoButtonTitle => 'Düğmeler';

  @override
  String get demoButtonSubtitle => 'Metin, yükseltilmiş, dış çizgili ve daha fazlası';

  @override
  String get demoTextButtonTitle => 'Metin Düğmesi';

  @override
  String get demoTextButtonDescription => 'Basıldığında mürekkep sıçraması görüntüleyen ancak basıldıktan sonra yukarı kalkmayan metin düğmesi. Metin düğmelerini araç çubuklarında, iletişim kutularında ve dolgulu satır içinde kullanın';

  @override
  String get demoElevatedButtonTitle => 'Yükseltilmiş Düğme';

  @override
  String get demoElevatedButtonDescription => 'Yükseltilmiş düğmeler çoğunlukla düz düzenlere boyut ekler. Yoğun veya geniş alanlarda işlevleri vurgular.';

  @override
  String get demoOutlinedButtonTitle => 'Dış Çizgili Düğme';

  @override
  String get demoOutlinedButtonDescription => 'Dış çizgili düğmeler basıldığında opak olur ve yükselir. Alternatif, ikincil işlemi belirtmek için genellikle yükseltilmiş düğmelerle eşlenirler.';

  @override
  String get demoToggleButtonTitle => 'Açma/Kapatma Düğmeleri';

  @override
  String get demoToggleButtonDescription => 'Açma/kapatma düğmeleri benzer seçenekleri gruplamak için kullanılabilir. Benzer açma/kapatma düğmesi gruplarını vurgulamak için grubun ortak bir kapsayıcıyı paylaşması gerekir.';

  @override
  String get demoFloatingButtonTitle => 'Kayan İşlem Düğmesi';

  @override
  String get demoFloatingButtonDescription => 'Kayan işlem düğmesi, uygulamadaki birincil işlemi öne çıkarmak için içeriğin üzerine gelen dairesel bir simge düğmesidir.';
  ...
  @override
  String get demoCardDescription => 'Kartlar; albüm, coğrafi konum, yemek, iletişim bilgileri gibi alakalı bilgileri temsil etmek için kullanılan Materyal sayfalarıdır.';

  @override
  String get demoChipSubtitle => 'Giriş, özellik ve işlem temsil eden kompakt öğeler';

  @override
  String get demoActionChipTitle => 'İşlem Çipi';

  @override
  String get demoActionChipDescription => 'İşlem çipleri, asıl içerikle ilgili bir işlemi tetikleyen bir dizi seçenektir. İşlem çipleri, kullanıcı arayüzünde dinamik ve içeriğe dayalı olarak görünmelidir.';

  @override
  String get demoChoiceChipTitle => 'Seçenek Çipi';

  @override
  String get demoChoiceChipDescription => 'Seçenek çipleri, bir dizi seçenekten tek bir seçeneği temsil eder. Seçenek çipleri ilgili açıklayıcı metin veya kategoriler içerir.';

  @override
  String get demoFilterChipTitle => 'Filtre çipi';

  @override
  String get demoFilterChipDescription => 'Filtre çipleri, içeriği filtreleme yöntemi olarak etiketler ve açıklayıcı kelimeler kullanır.';

  @override
  String get demoInputChipTitle => 'Giriş Çipi';

  @override
  String get demoInputChipDescription => 'Giriş çipleri, bir varlık (kişi, yer veya şey) gibi karmaşık bir bilgi parçasını ya da kompakt bir formda konuşma dili metnini temsil eder.';
  ...
  @override
  String get demoDataTableDescription => 'Veri tabloları bilgileri ızgara biçimindeki satırlar ve sütunlarda görüntüler. Kullanıcıların model ve sonuç arayabilmesi için bilgiyi kolayca taranabilecek şekilde düzenler.';
  ...
  @override
  String get demoAlertDialogDescription => 'Uyarı iletişim kutusu, kullanıcıyı onay gerektiren durumlar hakkında bilgilendirir. Uyarı iletişim kutusunun isteğe bağlı başlığı ve isteğe bağlı işlemler listesi vardır.';
  ...
  @override
  String get demoSimpleDialogDescription => 'Basit iletişim kutusu, kullanıcıya birkaç seçenek arasından seçim yapma olanağı sunar. Basit iletişim kutusunun seçeneklerin üzerinde görüntülenen isteğe bağlı bir başlığı vardır.';

  @override
  String get demoDividerTitle => 'Ayırıcı';

  @override
  String get demoDividerSubtitle => 'Ayırıcı, içeriği listelerde ve düzenlerde gruplandıran ince bir çizgidir.';

  @override
  String get demoDividerDescription => 'Ayırıcılar, içeriği ayırmak için listelerde, çekmecelerde ve başka yerlerde kullanılabilir.';

  @override
  String get demoVerticalDividerTitle => 'Dikey Ayırıcı';
  ...
  @override
  String get demoGridListsDescription => 'Tablo Listeler, genellikle resimler gibi benzer türdeki verileri sunmanın en uygun yöntemidir. Tablodaki her öğeye kutu denir.';
  ...
  @override
  String get demoSlidersSubtitle => 'Kaydırarak bir değer seçmeyi sağlayan widget';

  @override
  String get demoSlidersDescription => 'Kullanıcılar, kaydırma çubuklarını kullanarak belirtilen değer aralığı içinde bir değeri seçebilir. Kaydırma çubukları, ses düzeyi ve parlaklık gibi ayarları düzenlemek veya görüntü filtreleri uygulamak için idealdir.';

  @override
  String get demoRangeSlidersTitle => 'Aralık Kaydırma Çubukları';

  @override
  String get demoRangeSlidersDescription => 'Kaydırma çubukları, bir çubuk boyunca çeşitli değerler yansıtır. Kaydırma çubuklarının her iki ucunda değer aralığının alt ve üst değerlerini gösteren simgeler bulunabilir. Kaydırma çubukları, ses düzeyi ve parlaklık gibi ayarları düzenlemek veya görüntü filtreleri uygulamak için idealdir.';

  @override
  String get demoCustomSlidersTitle => 'Özel Kaydırma Çubukları';

  @override
  String get demoCustomSlidersDescription => 'Kullanıcılar, kaydırma çubuklarını kullanarak belirtilen değer aralığı içinde bir değer veya değer aralığını seçebilir. Kaydırma çubukları temalı veya özelleştirilmiş olabilir.';

  @override
  String get demoSlidersContinuousWithEditableNumericalValue => 'Düzenlenebilir Sayısal Değere Sahip Kesintisiz';

  @override
  String get demoSlidersDiscrete => 'Ayrık';

  @override
  String get demoSlidersDiscreteSliderWithCustomTheme => 'Özelleştirilmiş Temaya Sahip Ayrık Değerli Kaydırma Çubuğu';

  @override
  String get demoSlidersContinuousRangeSliderWithCustomTheme => 'Özelleştirilmiş Temaya Sahip Sürekli Aralık Değerli Çubuğu';

  @override
  String get demoSlidersContinuous => 'Sürekli';

  @override
  String get demoSlidersEditableNumericalValue => 'Düzenlenebilir sayısal değer';
  ...
  @override
  String get demoMenuDescription => 'Menü, geçici bir yüzeyde seçenekler listesini görüntüler. Menüler, kullanıcılar bir düğme, işlem veya başka bir kontrolle etkileşimde bulunduğunda görünür.';
  ...
  @override
  String get demoMenuAnItemWithASectionedMenu => 'Bölümlere ayrılmış menüsü olan öğe';
  ...
  @override
  String get demoNavigationDrawerTitle => 'Gezinme Çekmecesi';

  @override
  String get demoNavigationDrawerSubtitle => 'Uygulama çubuğunda çekmece görüntüleme';

  @override
  String get demoNavigationDrawerDescription => 'Uygulamada gezinme bağlantılarını göstermek için ekranın köşesinden yatay olarak kayan Materyal Tasarım paneli.';

  @override
  String get demoNavigationDrawerUserName => 'Kullanıcı Adı';

  @override
  String get demoNavigationDrawerUserEmail => 'user.name@example.com';

  @override
  String get demoNavigationDrawerToPageOne => 'Birinci Öğe';

  @override
  String get demoNavigationDrawerToPageTwo => 'İkinci Öğe';

  @override
  String get demoNavigationDrawerText => 'Çekmeceyi görmek için kenardan kaydırın veya sol üstteki simgeye dokunun';

  @override
  String get demoNavigationRailTitle => 'Gezinme Sütunu';

  @override
  String get demoNavigationRailSubtitle => 'Uygulamada Gezinme Sütunu\'nu görüntüleme';

  @override
  String get demoNavigationRailDescription => 'Az sayıda, genellikle üç ila beş görünüm arasında gezinmek için uygulamanın solunda veya sağında görüntülenmesi amaçlanan bir materyal widget\'ı.';

  @override
  String get demoNavigationRailFirst => 'Birinci';

  @override
  String get demoNavigationRailSecond => 'İkinci';

  @override
  String get demoNavigationRailThird => 'Üçüncü';
  ...
  @override
  String get demoFullscreenDialogDescription => 'Tam ekran iletişim kutusu özelliği, gelen sayfanın tam ekran kalıcı bir iletişim kutusu olup olmadığını belirtir.';

  @override
  String get demoCupertinoActivityIndicatorTitle => 'Etkinlik göstergesi';

  @override
  String get demoCupertinoActivityIndicatorSubtitle => 'iOS stili işlem göstergeleri';

  @override
  String get demoCupertinoActivityIndicatorDescription => 'Saat yönünde dönen iOS-tarzında işlem göstergesi';
  ...
  @override
  String get demoCupertinoButtonsDescription => 'iOS tarzı düğme. Dokunulduğunda rengi açılan ve kararan metin ve/veya simge içerir. İsteğe bağlı olarak arka planı bulunabilir.';

  @override
  String get demoCupertinoContextMenuTitle => 'İçerik Menüsü';

  @override
  String get demoCupertinoContextMenuSubtitle => 'iOS stili içerik menüsü';

  @override
  String get demoCupertinoContextMenuDescription => 'Bir öğeye uzun basıldığında görünen iOS stili tam ekran içerik menüsü.';

  @override
  String get demoCupertinoContextMenuActionOne => 'Birinci işlem';

  @override
  String get demoCupertinoContextMenuActionTwo => 'İkinci işlem';

  @override
  String get demoCupertinoContextMenuActionText => 'İçerik menüsünü görmek için Flutter logosuna dokunup basılı tutun.';
  ...
  @override
  String get demoCupertinoAlertDescription => 'Uyarı iletişim kutusu, kullanıcıyı onay gerektiren durumlar hakkında bilgilendirir. Uyarı iletişim kutusunun isteğe bağlı başlığı, isteğe bağlı içeriği ve isteğe bağlı işlemler listesi vardır. Başlık içeriğin üzerinde görüntülenir ve işlemler içeriğin altında görüntülenir.';
  ...
  @override
  String get demoCupertinoActionSheetDescription => 'İşlem sayfası, kullanıcıya geçerli bağlamla ilgili iki veya daha fazla seçenek sunan belirli bir uyarı tarzıdır. Bir işlem sayfasının başlığı, ek mesajı ve işlemler listesi olabilir.';
  ...
  @override
  String get demoCupertinoNavigationBarDescription => 'iOS stili bir gezinme çubuğu. Gezinme çubuğu, ortasında sayfa başlığını minimum düzeyde içeren bir araç çubuğudur.';
  ...
  @override
  String get demoCupertinoPickerDescription => 'Tarih, saat veya hem tarih hem de saat seçmek için kullanılabilen iOS stili seçici widget\'ı.';
  ...
  @override
  String get demoCupertinoPullToRefreshSubtitle => 'iOS stili yenilemek için aşağı çekme denetimi';

  @override
  String get demoCupertinoPullToRefreshDescription => 'iOS stili yenilemek için aşağı çekme denetimini uygulayan widget.';

  @override
  String get demoCupertinoSegmentedControlTitle => 'Bölümlere ayrılmış kontrol';

  @override
  String get demoCupertinoSegmentedControlSubtitle => 'iOS-tarzı bölümlere ayrılmış kontrol';

  @override
  String get demoCupertinoSegmentedControlDescription => 'Birbirini dışlayan bir dizi seçenek arasında seçim yapmak için kullanıldı. Segmentlere ayrılmış kontrolde bir seçenek belirlendiğinde, segmentlere ayrılmış denetimdeki diğer seçenek belirlenemez.';
  ...
  @override
  String get demoCupertinoSliderDescription => 'Kaydırma çubukları sürekli veya aralıklı değerler içinden seçim yapmak için kullanılır.';
  ...
  @override
  String get demoCupertinoSwitchDescription => 'Anahtarlar tek bir ayarın açık/kapalı durumunu değiştirmek için kullanılır.';
  ...
  @override
  String get demoCupertinoTabBarDescription => 'iOS tarzında alt gezinme sekmesi çubuğu. Birden fazla sekme gösterilir. Varsayılan olarak ilk sekme olmak üzere içlerinden biri etkin durumda olur.';
  ...
  @override
  String get demoCupertinoTextFieldDescription => 'Metin alanı, kullanıcının donanım klavyesi veya ekran klavyesi ile metin girmesini sağlar.';
  ...
  @override
  String get demoContainerTransformDemoInstructions => 'Kartlar, Listeler ve FAB';

  @override
  String get demoSharedXAxisDemoInstructions => 'İleri ve Geri Düğmeleri';

  @override
  String get demoSharedYAxisDemoInstructions => '\"Son Çalınanlar\"a göre sıralama';

  @override
  String get demoSharedZAxisDemoInstructions => 'Ayarlar simge düğmesi';

  @override
  String get demoFadeThroughDemoInstructions => 'Alt gezinme';

  @override
  String get demoFadeScaleDemoInstructions => 'Kalıcı iletişim kutusu ve FAB';

  @override
  String get demoContainerTransformTitle => 'Kapsayıcı Dönüşümü';

  @override
  String get demoContainerTransformDescription => 'Kapsayıcı dönüşüm deseni, kapsayıcı içeren kullanıcı arayüzü öğeleri arasındaki geçişler için tasarlanmıştır. Bu desen, iki kullanıcı arayüzü öğesi arasında görünür bir bağlantı oluşturur';

  @override
  String get demoContainerTransformModalBottomSheetTitle => 'Şeffaflaştırma modu';
  ...
  @override
  String get demoSharedAxisDescription => 'Paylaşılan eksen deseni, uzamsal veya gezinme ilişkisi olan kullanıcı arayüzü öğeleri arasındaki geçişler için kullanılır. Bu desen, öğeler arasındaki ilişkiyi güçlendirmek için x, y veya z eksenlerinde paylaşılan bir dönüşüm kullanır.';
  ...
  @override
  String get demoSharedXAxisCoursePageSubtitle => 'Pakete dahil edilen kategoriler, feed\'inizde grup olarak görünür. Bunu daha sonra istediğiniz zaman değiştirebilirsiniz.';
  ...
  @override
  String get demoSharedXAxisIndividualCourseSubtitle => 'Ayrı Olarak Gösterilir';
  ...
  @override
  String get demoSharedXAxisSignInTextFieldLabel => 'E-posta adresi veya telefon numarası';

  @override
  String get demoSharedXAxisForgotEmailButtonText => 'E-POSTA ADRESİNİZİ Mİ UNUTTUNUZ?';
  ...
  @override
  String get demoSharedZAxisShrimpPlateRecipeDescription => 'Karides tabağı tarifi';

  @override
  String get demoSharedZAxisCrabPlateRecipeTitle => 'Yengeç';

  @override
  String get demoSharedZAxisCrabPlateRecipeDescription => 'Yengeç tabağı tarifi';

  @override
  String get demoSharedZAxisBeefSandwichRecipeTitle => 'Etli Sandviç';

  @override
  String get demoSharedZAxisBeefSandwichRecipeDescription => 'Etli Sandviç tarifi';
  ...
  @override
  String get demoFadeThroughDescription => 'Şeffaflaşarak geçiş deseni, birbiriyle güçlü bir ilişkisi olmayan kullanıcı arayüzü öğeleri arasındaki geçişler için kullanılır.';
  ...
  @override
  String get demoFadeScaleDescription => 'Şeffaflaşan desen, ekranın ortasında kararan iletişim kutusu gibi ekran sınırları içine giren veya dışına çıkan kullanıcı arayüzü öğeleri için kullanılır.';

  @override
  String get demoFadeScaleShowAlertDialogButton => 'KALICI İLETİŞİM KUTUSUNU GÖSTER';
  ...
  @override
  String get demoColorsDescription => 'Materyal Tasarımın renk paletini temsil eden renk ve renk örneği sabitleri.';
  ...
  @override
  String get demoTypographyDescription => 'Materyal Tasarımında bulunan çeşitli tipografik stillerin tanımları.';

  @override
  String get demo2dTransformationsTitle => '2D dönüşümler';

  @override
  String get demo2dTransformationsSubtitle => 'Kaydırma, yakınlaştırma, döndürme';

  @override
  String get demo2dTransformationsDescription => 'Blokları düzenlemek için dokunun ve sahnede farklı yerlere taşımak için hareketleri kullanın. Kaydırmak için sürükleyin, yakınlaştırmak için sıkıştırın, iki parmağınızla döndürün. Başlangıç yönüne geri döndürmek için sıfırlama düğmesine basın.';
  ...
  @override
  String get demoBottomSheetPersistentDescription => 'Sürekli görüntülenen alt sayfa, uygulamanın asıl içeriğine ek bilgileri gösterir ve kullanıcı uygulamanın diğer bölümleriyle etkileşimde bulunurken görünmeye devam eder.';

  @override
  String get demoBottomSheetModalTitle => 'Kalıcı alt sayfa';

  @override
  String get demoBottomSheetModalDescription => 'Kalıcı alt sayfa, alternatif bir menü veya iletişim kutusudur ve kullanıcının uygulamanın geri kalanı ile etkileşimde bulunmasını önler.';
  ...
  @override
  String get demoListsDescription => 'Tipik olarak biraz metnin yanı sıra başında veya sonunda simge olan sabit yükseklikli tek satır.';
  ...
  @override
  String get demoCircularProgressIndicatorTitle => 'Dairesel İlerleme Durumu Göstergesi';

  @override
  String get demoCircularProgressIndicatorDescription => 'Dönerek uygulamanın meşgul olduğunu gösteren Materyal Tasarıma sahip dairesel ilerleme durumu göstergesi';

  @override
  String get demoLinearProgressIndicatorTitle => 'Doğrusal İlerleme Durumu Göstergesi';

  @override
  String get demoLinearProgressIndicatorDescription => 'İlerleme çubuğu olarak da bilinen, Materyal Tasarıma sahip doğrusal ilerleme durumu göstergesi';
  ...
  @override
  String get demoDatePickerDescription => 'Materyal Tasarıma sahip tarih seçici içeren bir iletişim kutusu gösterir.';

  @override
  String get demoTimePickerTitle => 'Saat Seçici';

  @override
  String get demoTimePickerDescription => 'Materyal Tasarıma sahip saat seçici içeren bir iletişim kutusu gösterir.';

  @override
  String get demoDateRangePickerTitle => 'Tarih Aralığı Seçici';

  @override
  String get demoDateRangePickerDescription => 'Materyal Tasarıma sahip tarih seçici içeren bir iletişim kutusu gösterir.';
  ...
  @override
  String get demoTabsSubtitle => 'Bağımsız olarak kaydırılabilen görünümlü sekmeler';

  @override
  String get demoTabsDescription => 'Sekmeler farklı ekranlarda, veri kümelerinde ve diğer etkileşimlerde bulunan içeriği düzenler.';

  @override
  String get demoSnackbarsTitle => 'Snackbar\'lar';

  @override
  String get demoSnackbarsSubtitle => 'Snackbar\'lar ekranın alt bölümünde mesaj gösterir';

  @override
  String get demoSnackbarsDescription => 'Snackbar\'lar bir uygulamanın gerçekleştirdiği veya gerçekleştireceği bir işlemi kullanıcılara bildirir. Ekranın altına yakın bir yerde geçici olarak görünür. Kullanıcı deneyimini engellememeli ve ekrandan kaybolması için kullanıcının bir işlem yapmasını gerektirmemelidir.';
  ...
  @override
  String get demoSelectionControlsSubtitle => 'Onay kutuları, radyo düğmeleri ve anahtarlar';

  @override
  String get demoSelectionControlsCheckboxTitle => 'Onay Kutusu';

  @override
  String get demoSelectionControlsCheckboxDescription => 'Onay kutuları, kullanıcıya bir dizi seçenek arasından birden fazlasını belirlemesine olanak sağlar. Normal bir onay kutusunun değeri true (doğru) veya false (yanlış) olur. Üç durumlu onay kutusunun değeri boş da olabilir.';

  @override
  String get demoSelectionControlsRadioTitle => 'Radyo düğmesi';

  @override
  String get demoSelectionControlsRadioDescription => 'Radyo düğmeleri, kullanıcının bir dizi seçenek arasından birini belirlemesine olanak sağlar. Kullanıcının tüm mevcut seçenekleri yan yana görmesi gerektiğini düşünüyorsanız özel seçim için radyo düğmelerini kullanın.';

  @override
  String get demoSelectionControlsSwitchTitle => 'Anahtar';

  @override
  String get demoSelectionControlsSwitchDescription => 'Açık/kapalı anahtarları, tek bir ayarlar seçeneğinin durumunu açar veya kapatır. Anahtarın kontrol ettiği seçeneğin yanı sıra seçeneğin bulunduğu durum, karşılık gelen satır içi etikette açıkça belirtilmelidir.';
  ...
  @override
  String get demoTextFieldSubtitle => 'Tek satır düzenlenebilir metin ve sayılar';

  @override
  String get demoTextFieldDescription => 'Metin alanları, kullanıcıların bir kullanıcı arayüzüne metin girmesini sağlar. Genellikle formlarda ve iletişim kutularında görünürler.';
  ...
  @override
  String get demoTextFieldFormErrors => 'Göndermeden önce lütfen kırmızı renkle belirtilen hataları düzeltin';

  @override
  String get demoTextFieldNameRequired => 'Ad gerekli.';

  @override
  String get demoTextFieldOnlyAlphabeticalChars => 'Lütfen sadece alfabetik karakterler girin.';

  @override
  String get demoTextFieldEnterUSPhoneNumber => '(###) ###-#### - ABD\'ye ait bir telefon numarası girin.';
  ...
  @override
  String get demoTextFieldWhatDoPeopleCallYou => 'Size hangi adla hitap ediliyor?';
  ...
  @override
  String get demoTextFieldTellUsAboutYourself => 'Bize kendinizden bahsedin (örneğin, ne iş yaptığınızı veya hobilerinizi yazın)';
  ...
  @override
  String get demoTooltipSubtitle => 'Uzun basmada veya fareyle üzerine gelmede görüntülenen kısa mesaj';

  @override
  String get demoTooltipDescription => 'İpuçları, bir düğmenin işlevini veya diğer kullanıcı arayüzü işlemini açıklamaya yardımcı olan metin etiketleri sağlar. İpuçları, kullanıcı fareyle bir öğenin üzerine geldiğinde veya öğeye odaklandığında ya da uzun bastığında bilgilendirici metin görüntüler.';

  @override
  String get demoTooltipInstructions => 'İpucunu görüntülemek için uzun basın veya fareyle üzerine gelin.';
  ...
  @override
  String get dialogLocationDescription => 'Google\'ın, uygulamaların konum tespiti yapmasına yardımcı olmasına izin verin. Bu, hiçbir uygulama çalışmıyorken bile anonim konum verilerinin Google\'a gönderilmesi anlamına gelir.';
  ...
  @override
  String get cupertinoAlertLocationTitle => 'Uygulamayı kullanırken \"Haritalar\"ın konumunuza erişmesine izin verilsin mi?';

  @override
  String get cupertinoAlertLocationDescription => 'Geçerli konumunuz haritada gösterilecek, yol tarifleri, yakındaki arama sonuçları ve tahmini seyahat süreleri için kullanılacak.';
  ...
  @override
  String get cupertinoAlertDessertDescription => 'Lütfen aşağıdaki listeden en sevdiğiniz tatlı türünü seçin. Seçiminiz, bölgenizdeki önerilen restoranlar listesini özelleştirmek için kullanılacak.';
  ...
  @override
  String get craneFly0SemanticLabel => 'Yaprak dökmeyen ağaçların bulunduğu karla kaplı bir arazideki şale';
  ...
  @override
  String get craneFly6SemanticLabel => 'Güzel Sanatlar Sarayı\'nın havadan görünüşü';
  ...
  @override
  String get craneFly10SemanticLabel => 'Gün batımında El-Ezher Camisi\'nin minareleri';
  ...
  @override
  String get craneSleep1SemanticLabel => 'Yaprak dökmeyen ağaçların bulunduğu karla kaplı bir arazideki şale';
  ...
  @override
  String get craneSleep4SemanticLabel => 'Dağların yamacında, göl kenarında otel';
  ...
  @override
  String get craneSleep7SemanticLabel => 'Ribeira Meydanı\'nda renkli apartmanlar';

  @override
  String get craneSleep8SemanticLabel => 'Sahilin üst tarafında falezdeki Maya kalıntıları';

  @override
  String get craneSleep9SemanticLabel => 'Denizde tuğla deniz feneri';

  @override
  String get craneSleep10SemanticLabel => 'Gün batımında El-Ezher Camisi\'nin minareleri';
  ...
  @override
  String get fortnightlyHeadlineHealthcare => 'Sessiz, Ancak Güçlü Bir Sağlık Reformu';

  @override
  String get fortnightlyHeadlineWar => 'Amerikalıların Savaş Sırasında Bölünmüş Yaşamları';
  ...
  @override
  String get fortnightlyHeadlineStocks => 'Hisse Senetleri Piyasası Durgunlaştıkça Çoğu Yatırımcı Dövize Yöneliyor';

  @override
  String get fortnightlyHeadlineFabrics => 'Tasarımcılar Modern Fabrikalar İnşa Etmek için Teknolojiden Yararlanıyorlar';

  @override
  String get fortnightlyHeadlineFeminists => 'Partizanlıkta Feministler Öne Çıkıyor';

  @override
  String get fortnightlyHeadlineBees => 'Çiftlik Arılarında Azalma';

  @override
  String get replyInboxLabel => 'Gelen Kutusu';

  @override
  String get replyStarredLabel => 'Yıldızlı';

  @override
  String get replySentLabel => 'Gönderilmiş';

  @override
  String get replyTrashLabel => 'Çöp Kutusu';

  @override
  String get replySpamLabel => 'Spam';

  @override
  String get replyDraftsLabel => 'Taslaklar';

  @override
  String get demoTwoPaneFoldableLabel => 'Katlanabilir';

  @override
  String get demoTwoPaneFoldableDescription => 'TwoPane, katlanabilir bir cihazda bu şekilde davranır.';

  @override
  String get demoTwoPaneSmallScreenLabel => 'Küçük Ekran';

  @override
  String get demoTwoPaneSmallScreenDescription => 'TwoPane, küçük ekranlı bir cihazda bu şekilde davranır.';

  @override
  String get demoTwoPaneTabletLabel => 'Tablet/Masaüstü';

  @override
  String get demoTwoPaneTabletDescription => 'TwoPane, tablet veya masaüstü gibi büyük bir ekranda bu şekilde davranır.';

  @override
  String get demoTwoPaneTitle => 'TwoPane';

  @override
  String get demoTwoPaneSubtitle => 'Katlanabilir, büyük ve küçük ekranlarla uyumlu düzenler';

  @override
  String get splashSelectDemo => 'Demo seçin';

  @override
  String get demoTwoPaneList => 'Liste';

  @override
  String get demoTwoPaneDetails => 'Ayrıntılar';

  @override
  String get demoTwoPaneSelectItem => 'Öğe seçin';
