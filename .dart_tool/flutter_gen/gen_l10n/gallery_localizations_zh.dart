...
class GalleryLocalizationsZhHk extends GalleryLocalizationsZh {
  ...
  @override
  String get replyDescription => '有效率、目標更清晰的電郵應用程式';
  ...
  @override
  String rallyBillAmount(Object billName, Object date, Object amount) {
    return '$billName帳單於 $date 到期，金額為 $amount。';
  }
  ...
  @override
  String get demoAppBarTitle => '應用程式列';

  @override
  String get demoAppBarSubtitle => '顯示與目前畫面相關的資料和動作';

  @override
  String get demoAppBarDescription => '應用程式列會提供與目前畫面相關的內容和動作，用於品牌經營、顯示畫面標題、提供導覽及動作';
  ...
  @override
  String get demoButtonSubtitle => '文字按鈕、凸起的按鈕、外框按鈕等';
  ...
  @override
  String get demoDividerTitle => '分隔線';

  @override
  String get demoDividerSubtitle => '分隔線是一條細線，可分隔清單及版面配置中的內容。';

  @override
  String get demoDividerDescription => '分隔線可用分隔內容，無論是清單、導覽列或其他地方均可使用。';

  @override
  String get demoVerticalDividerTitle => '垂直分隔線';
  ...
  @override
  String get demoNavigationDrawerTitle => '導覽列';
  ...
  @override
  String get demoNavigationDrawerToPageOne => '第一個項目';

  @override
  String get demoNavigationDrawerToPageTwo => '第二個項目';

  @override
  String get demoNavigationDrawerText => '從邊緣滑動或輕按左上方的圖示以查看導覽列';

  @override
  String get demoNavigationRailTitle => '導覽欄';
  ...
  @override
  String get demoNavigationRailSecond => '第二個';

  @override
  String get demoNavigationRailThird => '第三個';
  ...
  @override
  String get demoCupertinoContextMenuTitle => '內容選單';

  @override
  String get demoCupertinoContextMenuSubtitle => 'iOS 樣式內容選單';

  @override
  String get demoCupertinoContextMenuDescription => '常按某個元素時，畫面上就會出現 iOS 樣式的全螢幕內容選單。';

  @override
  String get demoCupertinoContextMenuActionOne => '動作一';

  @override
  String get demoCupertinoContextMenuActionTwo => '動作二';

  @override
  String get demoCupertinoContextMenuActionText => '按住 Flutter 標誌即可查看內容選單。';
  ...
  @override
  String get demoContainerTransformDemoInstructions => '資訊卡、清單和懸浮動作按鈕';

  @override
  String get demoSharedXAxisDemoInstructions => '「繼續」和「返回」按鈕';

  @override
  String get demoSharedYAxisDemoInstructions => '按「最近播放」排序';

  @override
  String get demoSharedZAxisDemoInstructions => '設定圖示按鈕';

  @override
  String get demoFadeThroughDemoInstructions => '底部導覽';

  @override
  String get demoFadeScaleDemoInstructions => '強制回應和懸浮動作按鈕';
  ...
  @override
  String get demoDateRangePickerTitle => '日期範圍點選器';

  @override
  String get demoDateRangePickerDescription => '顯示載有 Material Design 日期範圍點選器的對話框。';
  ...
  @override
  String get replyStarredLabel => '已加星號';

  @override
  String get replySentLabel => '已傳送';

  @override
  String get replyTrashLabel => '垃圾桶';

  @override
  String get replySpamLabel => '垃圾內容';

  @override
  String get replyDraftsLabel => '草稿';

  @override
  String get demoTwoPaneFoldableLabel => '摺疊式';

  @override
  String get demoTwoPaneFoldableDescription => '這是 TwoPane 在摺疊式裝置上的行為方式。';

  @override
  String get demoTwoPaneSmallScreenLabel => '小螢幕';

  @override
  String get demoTwoPaneSmallScreenDescription => '這是 TwoPane 在小螢幕裝置上的行為方式。';

  @override
  String get demoTwoPaneTabletLabel => '平板電腦/桌面電腦';

  @override
  String get demoTwoPaneTabletDescription => '這是 TwoPane 在平板電腦或桌面電腦等較大螢幕上的行為方式。';

  @override
  String get demoTwoPaneTitle => 'TwoPane';

  @override
  String get demoTwoPaneSubtitle => '摺疊式裝置、大螢幕和小螢幕上的回應式版面配置';

  @override
  String get splashSelectDemo => '選取示範';

  @override
  String get demoTwoPaneList => '清單';

  @override
  String get demoTwoPaneDetails => '詳情';

  @override
  String get demoTwoPaneSelectItem => '選取項目';
...
class GalleryLocalizationsZhTw extends GalleryLocalizationsZh {
  ...
  @override
  String get replyDescription => '一款可協助你專注處理事務的高效率電子郵件應用程式';
  ...
  @override
  String rallyBillAmount(Object billName, Object date, Object amount) {
    return '$billName帳單繳費期限為 $date，金額為 $amount。';
  }
  ...
  @override
  String get demoAppBarSubtitle => '顯示與目前畫面相關的資訊和動作';

  @override
  String get demoAppBarDescription => '應用程式列會提供與目前畫面相關的資訊和動作，可用來宣傳品牌、顯示畫面標題、提供導覽及動作';
  ...
  @override
  String get demoButtonSubtitle => '文字、升起效果、外框和其他設計元素';
  ...
  @override
  String get demoDataTableDescription => '資料表格是透過網格格式顯示資訊。網格由列和欄構成，並以方便瀏覽的方式整理資訊，讓使用者能夠找出模式和進行深入分析。';
  ...
  @override
  String get demoDividerSubtitle => '分隔線是一條細線，可分類清單及版面配置中的內容。';

  @override
  String get demoDividerDescription => '分隔線可用來分隔清單、導覽匣等內容。';
  ...
  @override
  String get demoNavigationDrawerTitle => '導覽匣';
  ...
  @override
  String get demoNavigationDrawerToPageOne => '項目一';

  @override
  String get demoNavigationDrawerToPageTwo => '項目二';

  @override
  String get demoNavigationDrawerText => '從邊緣滑動或輕觸左上角圖示即可查看導覽匣';

  @override
  String get demoNavigationRailTitle => '導覽邊欄';
  ...
  @override
  String get demoCupertinoContextMenuSubtitle => 'iOS 樣式的內容選單';

  @override
  String get demoCupertinoContextMenuDescription => '長按某個元素時，畫面上就會出現 iOS 樣式的全螢幕內容選單。';
  ...
  @override
  String get demoContainerTransformDemoInstructions => '卡片、清單和懸浮動作按鈕 (FAB)';

  @override
  String get demoSharedXAxisDemoInstructions => '繼續和返回按鈕';

  @override
  String get demoSharedYAxisDemoInstructions => '依「最近播放」排序';
  ...
  @override
  String get demoFadeScaleDemoInstructions => '強制回應和懸浮動作按鈕 (FAB)';
  ...
  @override
  String get demoDateRangePickerTitle => '日期範圍挑選器';

  @override
  String get demoDateRangePickerDescription => '顯示內含質感設計日期範圍挑選器的對話方塊。';
  ...
  @override
  String get demoSnackbarsDescription => 'Snackbar 可通知使用者應用程式已執行的處理程序，或即將執行的處理程序。這個元件只會暫時出現在畫面底部，不會影響使用者體驗。使用者不必採取任何動作，這個元件就會自動消失。';
  ...
  @override
  String get demoSelectionControlsSwitchDescription => '「開啟/關閉」切換按鈕是用來切換單一設定選項的狀態。切換按鈕控制的選項及其目前狀態都應在對應的內嵌標籤上清楚顯示。';
  ...
  @override
  String get replyInboxLabel => '收件匣';
  ...
  @override
  String get replySpamLabel => '垃圾郵件';

  @override
  String get replyDraftsLabel => '草稿';

  @override
  String get demoTwoPaneFoldableLabel => '折疊式裝置';

  @override
  String get demoTwoPaneFoldableDescription => '這是 TwoPane 在折疊式裝置上的運作方式。';

  @override
  String get demoTwoPaneSmallScreenLabel => '小螢幕';

  @override
  String get demoTwoPaneSmallScreenDescription => '這是 TwoPane 在小螢幕裝置上的運作方式。';

  @override
  String get demoTwoPaneTabletLabel => '平板電腦/電腦';

  @override
  String get demoTwoPaneTabletDescription => '這是 TwoPane 在平板電腦或電腦這類大螢幕裝置上的運作方式。';

  @override
  String get demoTwoPaneTitle => 'TwoPane';

  @override
  String get demoTwoPaneSubtitle => '在折疊式裝置、大螢幕和小螢幕上的回應式版面配置';
  ...
  @override
  String get demoTwoPaneDetails => '詳細資料';
