...
class GalleryLocalizationsRo extends GalleryLocalizations {
  ...
  @override
  String get bannerDemoText => 'Parola a fost actualizată pe celălalt dispozitiv. Conectați-vă din nou.';
  ...
  @override
  String get cardsDemoTravelDestinationTitle1 => 'Top 10 orașe de vizitat în Tamil Nadu';
  ...
  @override
  String get replyDescription => 'O aplicație pentru e-mail eficientă și utilă';
  ...
  @override
  String get rallyAccountDetailDataAnnualPercentageYield => 'Randamentul anual procentual';

  @override
  String get rallyAccountDetailDataInterestRate => 'Rata dobânzii';

  @override
  String get rallyAccountDetailDataInterestYtd => 'Dobânda de la începutul anului până în prezent';

  @override
  String get rallyAccountDetailDataInterestPaidLastYear => 'Dobânda plătită anul trecut';
  ...
  @override
  String get rallySettingsPersonalInformation => 'Informații cu caracter personal';
  ...
  String rallyAlertsMessageUnassignedTransactions(num count) {
    return intl.Intl.pluralLogic(
      count,
      locale: localeName,
      one: 'Creșteți-vă potențiala deducere fiscală! Atribuiți categorii unei tranzacții neatribuite.',
      few: 'Creșteți-vă potențiala deducere fiscală! Atribuiți categorii pentru $count tranzacții neatribuite.',
      other: 'Creșteți-vă potențiala deducere fiscală! Atribuiți categorii pentru $count de tranzacții neatribuite.',
    );
  }
  ...
  @override
  String get demoCodeViewerCopiedToClipboardMessage => 'S-a copiat în clipboard.';
  ...
  @override
  String get demoOptionsFeatureDescription => 'Atingeți aici pentru a vedea opțiunile disponibile pentru această demonstrație.';
  ...
  @override
  String get demoAppBarTitle => 'Bara de aplicații';

  @override
  String get demoAppBarSubtitle => 'Afișează informații și acțiuni legate de ecranul actual';

  @override
  String get demoAppBarDescription => 'Bara de aplicații oferă conținut și acțiuni legate de ecranul actual. Se folosește pentru branding, titluri de ecran, navigare și acțiuni';

  @override
  String get demoBottomAppBarTitle => 'Bara de aplicații din partea de jos';

  @override
  String get demoBottomAppBarSubtitle => 'Afișează navigarea și acțiunile în partea de jos';

  @override
  String get demoBottomAppBarDescription => 'Barele de aplicații din partea de jos oferă acces la un panou de navigare din partea de jos și la maximum patru acțiuni, între care butonul flotant pentru acțiuni.';
  ...
  @override
  String get demoBannerDescription => 'Bannerul afișează un mesaj succint important și acțiuni pe care le pot face utilizatorii (inclusiv închiderea bannerului). Pentru închiderea acestuia este necesară o acțiune din partea utilizatorului.';

  @override
  String get demoBottomNavigationTitle => 'Navigarea în partea de jos';

  @override
  String get demoBottomNavigationSubtitle => 'Navigarea în partea de jos cu vizualizări cu suprapunere atenuată';
  ...
  @override
  String get demoBottomNavigationDescription => 'Barele de navigare din partea de jos afișează între trei și cinci destinații în partea de jos a ecranului. Fiecare destinație este reprezentată de o pictogramă și o etichetă cu text opțională. Când atinge o pictogramă de navigare din partea de jos, utilizatorul este direcționat la destinația de navigare principală asociată pictogramei respective.';

  @override
  String get demoButtonTitle => 'Butoane';

  @override
  String get demoButtonSubtitle => 'Text, în relief, conturate și altele';

  @override
  String get demoTextButtonTitle => 'Butonul text';

  @override
  String get demoTextButtonDescription => 'Butonul text reacționează vizibil la apăsare, dar nu se ridică. Folosiți butoanele text în bare de instrumente, casete de dialog și în linie cu chenarul interior.';

  @override
  String get demoElevatedButtonTitle => 'Butonul în relief';

  @override
  String get demoElevatedButtonDescription => 'Butoanele în relief conferă dimensiune aspectelor în mare parte plate. Acestea evidențiază funcții în spații pline sau ample.';

  @override
  String get demoOutlinedButtonTitle => 'Butonul conturat';

  @override
  String get demoOutlinedButtonDescription => 'Butoanele conturate devin opace și se ridică la apăsare. Sunt de multe ori asociate cu butoane ridicate, pentru a indica o acțiune secundară alternativă.';

  @override
  String get demoToggleButtonTitle => 'Butoane de comutare';

  @override
  String get demoToggleButtonDescription => 'Butoanele de comutare pot fi folosite pentru a grupa opțiunile similare. Pentru a evidenția grupuri de butoane de comutare similare, este necesar ca un grup să aibă un container comun.';

  @override
  String get demoFloatingButtonTitle => 'Buton de acțiune flotant';

  @override
  String get demoFloatingButtonDescription => 'Butonul de acțiune flotant este un buton cu pictogramă circulară plasat deasupra conținutului, care promovează o acțiune principală în aplicație.';
  ...
  @override
  String get demoCardDescription => 'Cardul este o bucată de material folosită pentru a prezenta informații conexe, de exemplu, un album, o locație geografică, o masă, date de contact etc.';

  @override
  String get demoChipSubtitle => 'Elemente compacte care reprezintă o intrare, un atribut sau o acțiune';

  @override
  String get demoActionChipTitle => 'Cip de acțiune';

  @override
  String get demoActionChipDescription => 'Cipurile de acțiune sunt un set de opțiuni care declanșează o acțiune legată de conținutul principal. Ele trebuie să apară dinamic și contextual într-o IU.';

  @override
  String get demoChoiceChipTitle => 'Cip de opțiune';

  @override
  String get demoChoiceChipDescription => 'Cipurile de opțiune reprezintă o singură opțiune dintr-un set. Ele conțin categorii sau texte descriptive asociate.';

  @override
  String get demoFilterChipTitle => 'Cip de filtrare';

  @override
  String get demoFilterChipDescription => 'Cipurile de filtrare folosesc etichete sau termeni descriptivi pentru a filtra conținutul.';

  @override
  String get demoInputChipTitle => 'Cip de intrare';

  @override
  String get demoInputChipDescription => 'Cipurile de intrare reprezintă informații complexe, cum ar fi o entitate (o persoană, o locație sau un obiect) sau un text conversațional, în formă compactă.';
  ...
  @override
  String get demoDataTableDescription => 'Tabelele de date afișează informații sub formă de grilă, cu rânduri și coloane. Acestea organizează informațiile astfel încât să fie ușor de consultat, pentru ca utilizatorii să poată căuta modele și statistici.';
  ...
  @override
  String get demoAlertDialogDescription => 'Caseta de dialog pentru alerte informează utilizatorul despre situații care necesită confirmare. Caseta de dialog pentru alerte are un titlu opțional și o listă de acțiuni opțională.';
  ...
  @override
  String get demoSimpleDialogDescription => 'Caseta de dialog simplă îi oferă utilizatorului posibilitatea de a alege dintre mai multe opțiuni. Caseta de dialog simplă are un titlu opțional, afișat deasupra opțiunilor.';

  @override
  String get demoDividerTitle => 'Separator';

  @override
  String get demoDividerSubtitle => 'Un separator este o linie subțire care grupează conținutul în liste și aspecte.';

  @override
  String get demoDividerDescription => 'Separatoarele se pot folosi în liste, panouri și alte locuri pentru a separa conținutul.';

  @override
  String get demoVerticalDividerTitle => 'Separator vertical';
  ...
  @override
  String get demoGridListsDescription => 'Listele grilă sunt ideale pentru prezentarea datelor omogene, de obicei, a imaginilor. Fiecare element al unei liste grilă se numește secțiune.';
  ...
  @override
  String get demoSlidersSubtitle => 'Widgeturi pentru selectarea unei valori prin glisare';

  @override
  String get demoSlidersDescription => 'Glisoarele reflectă un interval de valori de-a lungul unei bare, din care utilizatorii pot selecta o singură valoare. Acestea sunt ideale pentru reglarea setărilor, precum volumul, luminozitatea sau aplicarea filtrelor de imagine.';

  @override
  String get demoRangeSlidersTitle => 'Glisoare pentru interval';

  @override
  String get demoRangeSlidersDescription => 'Glisoarele reprezintă un interval de valori de-a lungul unei bare. Acestea pot avea pictograme la ambele capete ale barei, care reflectă un interval de valori. Sunt ideale pentru reglarea setărilor, precum volumul, luminozitatea sau aplicarea filtrelor de imagine.';

  @override
  String get demoCustomSlidersTitle => 'Glisoare personalizate';

  @override
  String get demoCustomSlidersDescription => 'Glisoarele reprezintă un interval de valori de-a lungul unei bare, din care utilizatorii pot selecta o singură valoare sau un interval de valori. Glisoarele pot să fie personalizate sau să aibă teme.';

  @override
  String get demoSlidersContinuousWithEditableNumericalValue => 'Continuu cu valoare numerică ce poate fi editată';

  @override
  String get demoSlidersDiscrete => 'Distinct';

  @override
  String get demoSlidersDiscreteSliderWithCustomTheme => 'Glisor distinct cu temă personalizată';

  @override
  String get demoSlidersContinuousRangeSliderWithCustomTheme => 'Glisor cu interval continuu și temă personalizată';

  @override
  String get demoSlidersContinuous => 'Continuu';

  @override
  String get demoSlidersEditableNumericalValue => 'Valoare numerică ce poate fi editată';
  ...
  @override
  String get demoMenuDescription => 'Meniul afișează o listă de opțiuni pe o suprafață temporară. Acestea apar atunci când utilizatorii interacționează cu un buton, o acțiune sau altă comandă.';
  ...
  @override
  String get demoMenuAnItemWithAContextMenuButton => 'Element cu meniu contextual';
  ...
  @override
  String get demoMenuContextMenuItemThree => 'Elementul de meniu contextual trei';
  ...
  @override
  String get demoNavigationDrawerTitle => 'Panou de navigare';

  @override
  String get demoNavigationDrawerSubtitle => 'Afișarea unui panou în bara de aplicații';

  @override
  String get demoNavigationDrawerDescription => 'Un panou pentru design material care glisează pe orizontală dinspre marginea ecranului pentru a afișa linkuri de navigare într-o aplicație.';

  @override
  String get demoNavigationDrawerUserName => 'Nume de utilizator';

  @override
  String get demoNavigationDrawerUserEmail => 'user.name@example.com';

  @override
  String get demoNavigationDrawerToPageOne => 'Primul element';

  @override
  String get demoNavigationDrawerToPageTwo => 'Al doilea element';

  @override
  String get demoNavigationDrawerText => 'Glisați dinspre margine sau atingeți pictograma din stânga sus ca să vedeți panoul';

  @override
  String get demoNavigationRailTitle => 'Bară de navigare';

  @override
  String get demoNavigationRailSubtitle => 'Afișarea unei bare de navigare într-o aplicație';

  @override
  String get demoNavigationRailDescription => 'Un widget pentru design material care se afișează în stânga sau în dreapta unei aplicații, pentru a putea naviga prin câteva vizualizări, de obicei între trei și cinci.';

  @override
  String get demoNavigationRailFirst => 'Prima';

  @override
  String get demoNavigationRailSecond => 'A doua';

  @override
  String get demoNavigationRailThird => 'A treia';

  @override
  String get demoMenuAnItemWithASimpleMenu => 'Element cu meniu simplu';

  @override
  String get demoMenuAnItemWithAChecklistMenu => 'Element cu meniu cu listă de verificare';

  @override
  String get demoFullscreenDialogTitle => 'Ecran complet';

  @override
  String get demoFullscreenDialogDescription => 'Proprietatea casetei de dialog pe ecran complet arată dacă pagina următoare este o casetă de dialog modală pe ecran complet';

  @override
  String get demoCupertinoActivityIndicatorTitle => 'Indicator de activitate';

  @override
  String get demoCupertinoActivityIndicatorSubtitle => 'Indicatori de activitate în stil iOS';

  @override
  String get demoCupertinoActivityIndicatorDescription => 'Indicator de activitate în stil iOS care se rotește spre dreapta.';
  ...
  @override
  String get demoCupertinoButtonsDescription => 'Buton în stil iOS. Preia text și/sau o pictogramă care se estompează sau se accentuează la atingere. Poate să aibă un fundal opțional.';

  @override
  String get demoCupertinoContextMenuTitle => 'Meniu contextual';

  @override
  String get demoCupertinoContextMenuSubtitle => 'Meniu contextual în stil iOS';

  @override
  String get demoCupertinoContextMenuDescription => 'Un meniu contextual în stil iOS pe ecran complet care apare când se apasă lung pe un element.';

  @override
  String get demoCupertinoContextMenuActionOne => 'Prima acțiune';

  @override
  String get demoCupertinoContextMenuActionTwo => 'A doua acțiune';

  @override
  String get demoCupertinoContextMenuActionText => 'Atingeți lung sigla Flutter ca să vedeți meniul contextual';

  @override
  String get demoCupertinoAlertsTitle => 'Alerte';

  @override
  String get demoCupertinoAlertsSubtitle => 'Casete de dialog pentru alerte în stil iOS';

  @override
  String get demoCupertinoAlertTitle => 'Alertă';

  @override
  String get demoCupertinoAlertDescription => 'Caseta de dialog pentru alerte informează utilizatorul despre situații care necesită confirmare. Caseta de dialog pentru alerte are un titlu opțional, conținut opțional și o listă de acțiuni opțională. Titlul este afișat deasupra conținutului, iar acțiunile sub conținut.';
  ...
  @override
  String get demoCupertinoActionSheetDescription => 'Foaia de acțiune este un tip de alertă care îi oferă utilizatorului două sau mai multe opțiuni asociate contextului actual. Foaia de acțiune poate să conțină un titlu, un mesaj suplimentar și o listă de acțiuni.';

  @override
  String get demoCupertinoNavigationBarTitle => 'Bară de navigare';

  @override
  String get demoCupertinoNavigationBarSubtitle => 'Bară de navigare în stil iOS';

  @override
  String get demoCupertinoNavigationBarDescription => 'Bară de navigare în stil iOS. Bara de navigare este o bară de instrumente formată cel puțin dintr-un titlu de pagină plasat în centru.';

  @override
  String get demoCupertinoPickerTitle => 'Selectori';

  @override
  String get demoCupertinoPickerSubtitle => 'Selectori pentru dată și oră în stil iOS';

  @override
  String get demoCupertinoPickerDescription => 'Widget de selector în stil iOS care poate fi folosit pentru a selecta data, ora sau data și ora.';
  ...
  @override
  String get demoCupertinoPullToRefreshSubtitle => 'Setarea Trageți pentru a actualiza în stil iOS';

  @override
  String get demoCupertinoPullToRefreshDescription => 'Widget care implementează setarea pentru conținut Trageți pentru a actualiza în stil iOS.';

  @override
  String get demoCupertinoSegmentedControlTitle => 'Control segmentat';

  @override
  String get demoCupertinoSegmentedControlSubtitle => 'Control segmentat în stil iOS';

  @override
  String get demoCupertinoSegmentedControlDescription => 'Folosit pentru a alege opțiuni care se exclud reciproc. Când selectați o opțiune din controlul segmentat, celelalte opțiuni sunt deselectate.';
  ...
  @override
  String get demoCupertinoSliderDescription => 'Glisorul poate fi folosit pentru a selecta dintr-un set de valori continue sau distincte.';
  ...
  @override
  String get demoCupertinoSwitchDescription => 'Comutatorul este folosit pentru a comuta între stările activat și dezactivat ale unei setări.';

  @override
  String get demoCupertinoTabBarTitle => 'Bară cu file';

  @override
  String get demoCupertinoTabBarSubtitle => 'Bară cu file din partea de jos în stil iOS';

  @override
  String get demoCupertinoTabBarDescription => 'Bară cu file de navigare din partea de jos în stil iOS. Afișează mai multe file, dintre care una este activă, în mod prestabilit prima filă.';
  ...
  @override
  String get demoCupertinoTextFieldDescription => 'Într-un câmp de text, utilizatorul poate să introducă text folosind o tastatură hardware sau o tastatură de pe ecran.';
  ...
  @override
  String get demoContainerTransformDemoInstructions => 'Carduri, Liste și Butonul de acțiune flotant';

  @override
  String get demoSharedXAxisDemoInstructions => 'Butoanele Înainte și Înapoi';

  @override
  String get demoSharedYAxisDemoInstructions => 'Sortați după „Redate recent”';

  @override
  String get demoSharedZAxisDemoInstructions => 'Butonul cu pictograma Setări';

  @override
  String get demoFadeThroughDemoInstructions => 'Navigarea în partea de jos';

  @override
  String get demoFadeScaleDemoInstructions => 'Modal și Butonul de acțiune flotant';

  @override
  String get demoContainerTransformTitle => 'Transformarea containerului';

  @override
  String get demoContainerTransformDescription => 'Modelul cu transformarea containerului este creat pentru tranziții între elementele IU care includ un container. Acest model creează o legătură vizibilă între două elemente IU.';

  @override
  String get demoContainerTransformModalBottomSheetTitle => 'Modul Afișare gradată/Estompare';
  ...
  @override
  String get demoSharedAxisDescription => 'Modelul cu axă comună este folosit pentru tranziții între elemente IU care au o relație spațială sau de navigare. Acest model folosește o transformare comună pe axa x, y, sau z pentru a evidenția legătura dintre elemente.';
  ...
  @override
  String get demoSharedXAxisCoursePageSubtitle => 'Categoriile apar ca grupuri în feed. Puteți modifica oricând această opțiune.';
  ...
  @override
  String get demoSharedXAxisSignInTextFieldLabel => 'Adresa de e-mail sau numărul de telefon';

  @override
  String get demoSharedXAxisForgotEmailButtonText => 'AȚI UITAT ADRESA DE E-MAIL?';
  ...
  @override
  String get demoSharedZAxisBeefSandwichRecipeDescription => 'Rețetă de sandviș cu vită';
  ...
  @override
  String get demoFadeThroughDescription => 'Modelul de înlocuire gradată este folosit pentru tranziții între elemente IU între care nu există o legătură strânsă.';
  ...
  @override
  String get demoFadeScaleDescription => 'Modelul de afișare gradată/estompare este folosit pentru elemente IU care se afișează sau dispar în limitele ecranului, de exemplu, o casetă de dialog care dispare treptat în centrul ecranului.';
  ...
  @override
  String get demoColorsDescription => 'Constante pentru culori și mostre de culori care reprezintă paleta de culori pentru Design material.';
  ...
  @override
  String get demoTypographyDescription => 'Definiții pentru stilurile tipografice diferite, care se găsesc în ghidul Design material.';

  @override
  String get demo2dTransformationsTitle => 'Transformări 2D';

  @override
  String get demo2dTransformationsSubtitle => 'Deplasați, măriți/micșorați, rotiți';

  @override
  String get demo2dTransformationsDescription => 'Atingeți pentru a edita filele și folosiți gesturi pentru a deplasa cadrul. Trageți pentru a deplasa, ciupiți pentru a mări sau micșora, rotiți cu două degete. Apăsați butonul de resetare pentru a reveni la orientarea inițială.';
  ...
  @override
  String get demoBottomSheetSubtitle => 'Foile persistente și modale din partea de jos';

  @override
  String get demoBottomSheetPersistentTitle => 'Foaia persistentă din partea de jos';

  @override
  String get demoBottomSheetPersistentDescription => 'Foaia persistentă din partea de jos afișează informații care completează conținutul principal al aplicației. Foaia persistentă din partea de jos rămâne vizibilă chiar dacă utilizatorul interacționează cu alte părți alte aplicației.';

  @override
  String get demoBottomSheetModalTitle => 'Foaia modală din partea de jos';

  @override
  String get demoBottomSheetModalDescription => 'Foaia modală din partea de jos este o alternativă la un meniu sau la o casetă de dialog și împiedică interacțiunea utilizatorului cu restul aplicației.';
  ...
  @override
  String get demoListsDescription => 'Un singur rând cu înălțime fixă, care conține de obicei text și o pictogramă la început sau la sfârșit.';
  ...
  @override
  String get demoCircularProgressIndicatorTitle => 'Indicator de progres circular';

  @override
  String get demoCircularProgressIndicatorDescription => 'Indicator de progres circular pentru design material, care se rotește pentru a indica faptul că aplicația este ocupată.';

  @override
  String get demoLinearProgressIndicatorTitle => 'Indicator de progres liniar';

  @override
  String get demoLinearProgressIndicatorDescription => 'Indicator de progres liniar pentru design material, numit și bară de progres.';
  ...
  @override
  String get demoDatePickerDescription => 'Afișează o casetă de dialog cu un selector de dată pentru design material.';

  @override
  String get demoTimePickerTitle => 'Selector de oră';

  @override
  String get demoTimePickerDescription => 'Afișează o casetă de dialog cu un selector de oră pentru design material.';

  @override
  String get demoDateRangePickerTitle => 'Selector pentru intervalul de date';

  @override
  String get demoDateRangePickerDescription => 'Afișează o casetă de dialog cu un selector al intervalului de date pentru Design material.';
  ...
  @override
  String get demoTabsSubtitle => 'File cu vizualizări care se derulează independent';

  @override
  String get demoTabsDescription => 'Filele organizează conținutul pe ecrane, în seturi de date diferite și în alte interacțiuni.';

  @override
  String get demoSnackbarsTitle => 'Bare de notificare';

  @override
  String get demoSnackbarsSubtitle => 'Barele de notificare afișează mesaje în partea de jos a ecranului';

  @override
  String get demoSnackbarsDescription => 'Barele de notificare informează utilizatorii cu privire la un proces care a fost sau va fi executat de o aplicație. Acestea se afișează temporar în partea de jos a ecranului. Ele nu ar trebui să întrerupă experiența utilizatorului și nu necesită date introduse de utilizator pentru a dispărea.';
  ...
  @override
  String get demoSnackbarsAction => 'Ați apăsat pe acțiunea din bara de notificare.';

  @override
  String get demoSelectionControlsTitle => 'Comenzi de selectare';

  @override
  String get demoSelectionControlsSubtitle => 'Casete de selectare, butoane radio și comutatoare';

  @override
  String get demoSelectionControlsCheckboxTitle => 'Casetă de selectare';

  @override
  String get demoSelectionControlsCheckboxDescription => 'Cu ajutorul casetelor de selectare, utilizatorii pot să aleagă mai multe opțiuni dintr-un set. Valoarea normală a unei casete este true sau false. O casetă cu trei stări poate avea și valoarea null.';

  @override
  String get demoSelectionControlsRadioTitle => 'Radio';

  @override
  String get demoSelectionControlsRadioDescription => 'Cu ajutorul butoanelor radio, utilizatorul poate să selecteze o singură opțiune dintr-un set. Folosiți-le pentru selectări exclusive dacă credeți că utilizatorul trebuie să vadă toate opțiunile disponibile alăturate.';

  @override
  String get demoSelectionControlsSwitchTitle => 'Comutatoare';

  @override
  String get demoSelectionControlsSwitchDescription => 'Comutatoarele activat / dezactivat schimbă starea unei opțiuni pentru setări. Opțiunea controlată de comutator și starea acesteia trebuie să fie indicate clar de eticheta inline corespunzătoare.';
  ...
  @override
  String get demoTextFieldSubtitle => 'Un singur rând de text și cifre editabile';

  @override
  String get demoTextFieldDescription => 'Câmpurile de text le dau utilizatorilor posibilitatea de a introduce text pe o interfață de utilizare. Acestea apar de obicei în forme și casete de dialog.';
  ...
  @override
  String get demoTextFieldFormErrors => 'Remediați erorile evidențiate cu roșu înainte de trimitere.';

  @override
  String get demoTextFieldNameRequired => 'Numele este obligatoriu.';

  @override
  String get demoTextFieldOnlyAlphabeticalChars => 'Introduceți numai caractere alfabetice.';

  @override
  String get demoTextFieldEnterUSPhoneNumber => '(###) ###–#### – introduceți un număr de telefon din S.U.A.';
  ...
  @override
  String get demoTextFieldWhereCanWeReachYou => 'La ce număr de telefon vă putem contacta?';
  ...
  @override
  String get demoTextFieldTellUsAboutYourself => 'Povestiți-ne despre dvs. (de exemplu, scrieți cu ce vă ocupați sau ce pasiuni aveți)';

  @override
  String get demoTextFieldKeepItShort => 'Folosiți un text scurt, aceasta este o demonstrație.';
  ...
  @override
  String get demoTooltipSubtitle => 'Scurt mesaj afișat la apăsarea lungă sau la plasarea cursorului';

  @override
  String get demoTooltipDescription => 'Baloanele explicative afișează etichete cu text care explică funcția unui buton sau altă acțiune din interfața de utilizare. Baloanele explicative afișează text informativ atunci când utilizatorii plasează cursorul pe, selectează sau apasă lung un element.';

  @override
  String get demoTooltipInstructions => 'Apăsați lung sau plasați cursorul pentru a afișa balonul explicativ.';
  ...
  @override
  String get dialogLocationDescription => 'Acceptați ajutor de la Google pentru ca aplicațiile să vă detecteze locația. Aceasta înseamnă că veți trimite la Google date anonime privind locațiile, chiar și când nu rulează nicio aplicație.';
  ...
  @override
  String get dialogFullscreenDescription => 'Exemplu de casetă de dialog pe ecran complet';
  ...
  @override
  String get cupertinoAlertLocationTitle => 'Permiteți ca Maps să vă acceseze locația când folosiți aplicația?';

  @override
  String get cupertinoAlertLocationDescription => 'Locația dvs. actuală va fi afișată pe hartă și folosită pentru indicații de orientare, rezultate ale căutării din apropiere și duratele de călătorie estimate.';
  ...
  @override
  String get cupertinoAlertDessertDescription => 'Alegeți desertul preferat din lista de mai jos. Opțiunea va fi folosită pentru a personaliza lista de restaurante sugerate din zona dvs.';
  ...
  @override
  String get shrineProductSucculentPlanters => 'Ghivece pentru plante suculente';
  ...
  @override
  String get shrineScreenReaderProductAddToCart => 'Adăugați în coșul de cumpărături';
  ...
  @override
  String get craneFly0SemanticLabel => 'Castel într-un peisaj de iarnă, cu conifere';

  @override
  String get craneFly1SemanticLabel => 'Cort pe un câmp';

  @override
  String get craneFly2SemanticLabel => 'Steaguri de rugăciune în fața unui munte înzăpezit';
  ...
  @override
  String get craneFly5SemanticLabel => 'Hotel pe malul unui lac, în fața munților';

  @override
  String get craneFly6SemanticLabel => 'Imagine aeriană cu Palacio de Bellas Artes';
  ...
  @override
  String get craneFly9SemanticLabel => 'Bărbat care se sprijină de o mașină albastră veche';
  ...
  @override
  String get craneSleep1SemanticLabel => 'Castel într-un peisaj de iarnă, cu conifere';

  @override
  String get craneSleep2SemanticLabel => 'Cetatea Machu Picchu';

  @override
  String get craneSleep3SemanticLabel => 'Bărbat care se sprijină de o mașină albastră veche';

  @override
  String get craneSleep4SemanticLabel => 'Hotel pe malul unui lac, în fața munților';
  ...
  @override
  String get craneSleep7SemanticLabel => 'Apartamente colorate în Riberia Square';

  @override
  String get craneSleep8SemanticLabel => 'Ruine mayașe pe o stâncă, deasupra unei plaje';
  ...
  @override
  String get craneEat10SemanticLabel => 'Femeie care ține un sandviș imens cu pastramă';
  ...
  @override
  String get fortnightlyHeadlineHealthcare => 'Revoluția silențioasă, dar remarcabilă, din domeniul sănătății';

  @override
  String get fortnightlyHeadlineWar => 'Poporul american divizat în timpul războiului';

  @override
  String get fortnightlyHeadlineGasoline => 'Viitorul benzinei';

  @override
  String get fortnightlyHeadlineArmy => 'Reformarea armatei de mediu din interior';

  @override
  String get fortnightlyHeadlineStocks => 'Întrucât cotațiile bursiere stagnează, mulți se orientează spre cursul valutar';

  @override
  String get fortnightlyHeadlineFabrics => 'Designerii creează materiale futuriste cu ajutorul tehnologiei';
  ...
  @override
  String get replyInboxLabel => 'Mesaje primite';

  @override
  String get replyStarredLabel => 'Cu stea';

  @override
  String get replySentLabel => 'Trimise';

  @override
  String get replyTrashLabel => 'Coș de gunoi';

  @override
  String get replySpamLabel => 'Spam';

  @override
  String get replyDraftsLabel => 'Mesaje nefinalizate';

  @override
  String get demoTwoPaneFoldableLabel => 'Dispozitiv pliabil';

  @override
  String get demoTwoPaneFoldableDescription => 'Acesta este comportamentul TwoPane pe un dispozitiv pliabil.';

  @override
  String get demoTwoPaneSmallScreenLabel => 'Ecran mic';

  @override
  String get demoTwoPaneSmallScreenDescription => 'Acesta este comportamentul TwoPane pe un dispozitiv cu ecran mic.';

  @override
  String get demoTwoPaneTabletLabel => 'Tabletă / computer';

  @override
  String get demoTwoPaneTabletDescription => 'Acesta este comportamentul TwoPane pe un ecran mai mare, cum ar fi cel de tabletă sau de computer.';

  @override
  String get demoTwoPaneTitle => 'TwoPane';

  @override
  String get demoTwoPaneSubtitle => 'Aspecte adaptabile pe ecrane pliabile, mari și mici';

  @override
  String get splashSelectDemo => 'Selectați o demonstrație';

  @override
  String get demoTwoPaneList => 'Listă';

  @override
  String get demoTwoPaneDetails => 'Detalii';

  @override
  String get demoTwoPaneSelectItem => 'Selectați un articol';
