...
class GalleryLocalizationsEl extends GalleryLocalizations {
  ...
  @override
  String get demoAppBarTitle => 'Γραμμή εφαρμογής';

  @override
  String get demoAppBarSubtitle => 'Εμφανίζει πληροφορίες και ενέργειες που σχετίζονται με την τρέχουσα οθόνη';

  @override
  String get demoAppBarDescription => 'Η γραμμή εφαρμογής παρέχει περιεχόμενο και ενέργειες που σχετίζονται με την τρέχουσα οθόνη. Χρησιμοποιείται στο πλαίσιο της καθιέρωσης επωνυμίας, των τίτλων οθόνης, της πλοήγησης και των ενεργειών';
  ...
  @override
  String get demoButtonSubtitle => 'Κειμένου, ανυψωμένα, με περίγραμμα κ.α.';
  ...
  @override
  String get demoDividerTitle => 'Διαχωριστικό';

  @override
  String get demoDividerSubtitle => 'Ένα διαχωριστικό είναι μια λεπτή γραμμή που ομαδοποιεί το περιεχόμενο σε λίστες και διατάξεις.';

  @override
  String get demoDividerDescription => 'Τα διαχωριστικά μπορούν να χρησιμοποιηθούν για τον διαχωρισμό του περιεχομένου σε λίστες, συρτάρια και σε άλλα σημεία.';

  @override
  String get demoVerticalDividerTitle => 'Κάθετο διαχωριστικό';
  ...
  @override
  String get demoNavigationDrawerToPageOne => 'Στοιχείο ένα';
  ...
  @override
  String get demoNavigationRailSecond => 'Δεύτερη';

  @override
  String get demoNavigationRailThird => 'Τρίτη';
  ...
  @override
  String get demoCupertinoContextMenuTitle => 'Μενού περιβάλλοντος';

  @override
  String get demoCupertinoContextMenuSubtitle => 'Μενού περιβάλλοντος με στιλ iOS';

  @override
  String get demoCupertinoContextMenuDescription => 'Ένα μενού περιβάλλοντος πλήρους οθόνης με στιλ iOS, το οποίο εμφανίζεται με το παρατεταμένο πάτημα ενός στοιχείου.';

  @override
  String get demoCupertinoContextMenuActionOne => 'Πρώτη ενέργεια';

  @override
  String get demoCupertinoContextMenuActionTwo => 'Δεύτερη ενέργεια';

  @override
  String get demoCupertinoContextMenuActionText => 'Πατήστε παρατεταμένα το λογότυπο Flutter για να δείτε το μενού περιβάλλοντος.';
  ...
  @override
  String get demoContainerTransformDemoInstructions => 'Κάρτες, λίστες και FAB';
  ...
  @override
  String get demoFadeThroughDemoInstructions => 'Πλοήγηση κάτω μέρους';

  @override
  String get demoFadeScaleDemoInstructions => 'Αποκλειστικό παράθυρο και FAB';
  ...
  @override
  String get demoDateRangePickerTitle => 'Εργαλείο επιλογής εύρους ημερομηνιών';

  @override
  String get demoDateRangePickerDescription => 'Εμφανίζει ένα παράθυρο διαλόγου που περιέχει ένα εργαλείο επιλογής ημερομηνιών Material design.';
  ...
  @override
  String get demoSelectionControlsSwitchDescription => 'Οι διακόπτες ενεργοποίησης/απενεργοποίησης εναλλάσσουν την κατάσταση μιας μεμονωμένης ρύθμισης. Η επιλογή που ελέγχει ο διακόπτης, καθώς και η κατάσταση στην οποία βρίσκεται, θα πρέπει να αποσαφηνίζεται από την αντίστοιχη ενσωματωμένη ετικέτα.';
  ...
  @override
  String get replyInboxLabel => 'Εισερχόμενα';

  @override
  String get replyStarredLabel => 'Με αστέρι';

  @override
  String get replySentLabel => 'Απεσταλμένα';

  @override
  String get replyTrashLabel => 'Κάδος';

  @override
  String get replySpamLabel => 'Ανεπιθύμητο περιεχόμενο';

  @override
  String get replyDraftsLabel => 'Πρόχειρα';

  @override
  String get demoTwoPaneFoldableLabel => 'Αναδιπλούμενη';

  @override
  String get demoTwoPaneFoldableDescription => 'Αυτός είναι ο τρόπος με τον οποίο συμπεριφέρεται το TwoPane σε μια αναδιπλούμενη συσκευή.';

  @override
  String get demoTwoPaneSmallScreenLabel => 'Μικρή οθόνη';

  @override
  String get demoTwoPaneSmallScreenDescription => 'Αυτός είναι ο τρόπος με τον οποίο συμπεριφέρεται το TwoPane σε μια συσκευή με μικρή οθόνη.';

  @override
  String get demoTwoPaneTabletLabel => 'Tablet/Υπολογιστής';

  @override
  String get demoTwoPaneTabletDescription => 'Αυτός είναι ο τρόπος με τον οποίο συμπεριφέρεται το TwoPane σε μια συσκευή με μεγαλύτερη οθόνη όπως tablet ή υπολογιστή.';

  @override
  String get demoTwoPaneTitle => 'TwoPane';

  @override
  String get demoTwoPaneSubtitle => 'Αποκριτικές διατάξεις σε αναδιπλούμενες συσκευές, συσκευές με μεγάλη και μικρή οθόνη';

  @override
  String get splashSelectDemo => 'Επιλογή επίδειξης';

  @override
  String get demoTwoPaneList => 'Λίστα';

  @override
  String get demoTwoPaneDetails => 'Λεπτομέρειες';

  @override
  String get demoTwoPaneSelectItem => 'Επιλέξτε ένα στοιχείο';
