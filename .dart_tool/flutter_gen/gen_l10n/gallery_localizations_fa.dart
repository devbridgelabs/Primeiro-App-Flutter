...
class GalleryLocalizationsFa extends GalleryLocalizations {
  ...
  @override
  String get replyDescription => 'برنامه ایمیلی کارآمد و تخصصی';
  ...
  @override
  String get rallySettingsPaperlessSettings => 'تنظیمات دیجیتال';
  ...
  @override
  String get demoOptionsFeatureTitle => 'گزینه‌های نما';
  ...
  @override
  String get settingsTextScaling => 'مقیاس‌گذاری نوشتار';
  ...
  @override
  String get demoAppBarTitle => 'نوار برنامه';

  @override
  String get demoAppBarSubtitle => 'اطلاعات و کنش‌های مربوط به صفحه فعلی را نمایش می‌دهد';

  @override
  String get demoAppBarDescription => '«نوار برنامه» محتوا و کنش‌های مربوط به صفحه فعلی را ارائه می‌دهد. از این نوار برای نمانام‌سازی، عنوان‌های صفحه، پیمایش، و کنش‌ها استفاده می‌شود';
  ...
  @override
  String get demoButtonSubtitle => 'نوشتار، برجسته، برون‌نما، و موارد دیگر';

  @override
  String get demoTextButtonTitle => 'دکمه نوشتاری';

  @override
  String get demoTextButtonDescription => 'دکمه‌ای نوشتاری که با فشار دادن، پاشیدن جوهر را نمایش می‌دهد، اما بالا نمی‌رود. از دکمه‌های نوشتاری در نوارابزار، کادر گفتگو، و به‌صورت به‌خط در کنار فاصله‌گذاری استفاده کنید';
  ...
  @override
  String get demoActionChipDescription => 'تراشه‌های کنش مجموعه‌ای از گزینه‌ها هستند که کنشی مرتبط با محتوای اصلی را راه‌اندازی می‌کنند. تراشه‌های کنش باید به‌صورت پویا و مرتبط با محتوا در واسط کاربر نشان داده شوند.';
  ...
  @override
  String get demoDataTableDescription => 'جدول داده اطلاعات را در قالبی شبکه‌مانند نمایش می‌دهد و از ردیف و ستون تشکیل شده است. این جدول اطلاعات را به روشی آسان برای خواندن اجمالی سازمان‌دهی می‌کند تا کاربران بتوانند الگوها و اطلاعات آماری را پیدا کنند.';
  ...
  @override
  String get demoDividerTitle => 'تقسیم‌کننده';

  @override
  String get demoDividerSubtitle => 'تقسیم‌کننده خط باریکی است که محتوا را در فهرست‌ها و طرح‌بندی‌ها گروه‌بندی می‌کند.';

  @override
  String get demoDividerDescription => 'از تقسیم‌کننده‌ها می‌توان در فهرست‌ها، کشوها، و جاهای دیگر برای جدا کردن محتوا استفاده کرد.';

  @override
  String get demoVerticalDividerTitle => 'تقسیم‌کننده عمودی';
  ...
  @override
  String get demoCustomSlidersDescription => 'لغزنده‌ها گستره‌ای از مقادیر را در امتداد نواری نشان می‌دهند که کاربران می‌توانند یک مقدار یا گستره‌ای از مقادیر را از آن انتخاب کنند. لغزنده‌ها می‌توانند زمینه داشته باشند یا سفارشی شوند.';
  ...
  @override
  String get demoSlidersDiscreteSliderWithCustomTheme => 'لغزنده گسسته با زمینه سفارشی';

  @override
  String get demoSlidersContinuousRangeSliderWithCustomTheme => 'لغزنده گستره‌ای پیوسته با زمینه سفارشی';
  ...
  @override
  String get demoNavigationDrawerToPageOne => 'مورد یک';
  ...
  @override
  String get demoNavigationRailSecond => 'دومین';

  @override
  String get demoNavigationRailThird => 'سومین';
  ...
  @override
  String get demoCupertinoContextMenuTitle => 'منوی بافت';

  @override
  String get demoCupertinoContextMenuSubtitle => 'منوی بافت به‌سبک iOS';

  @override
  String get demoCupertinoContextMenuDescription => 'منوی بافت تمام‌صفحه به‌سبک iOS که با فشار طولانی عناصر ظاهر می‌شود.';

  @override
  String get demoCupertinoContextMenuActionOne => 'کنش یک';

  @override
  String get demoCupertinoContextMenuActionTwo => 'کنش دو';

  @override
  String get demoCupertinoContextMenuActionText => 'برای دیدن منوی بافت، روی نشان‌واره Flutter ضربه بزنید و آن را نگه دارید.';
  ...
  @override
  String get demoCupertinoPullToRefreshTitle => 'کشیدن برای بازآوری';

  @override
  String get demoCupertinoPullToRefreshSubtitle => 'کنترل «کشیدن برای بازآوری» به سبک iOS';

  @override
  String get demoCupertinoPullToRefreshDescription => 'ابزارکی که از کنترل محتوای «کشیدن برای بازآوری» به سبک iOS استفاده می‌کند';
  ...
  @override
  String get demoFadeThroughDemoInstructions => 'پیمایش پایین صفحه';

  @override
  String get demoFadeScaleDemoInstructions => 'مودال و دکمه کنش شناور';

  @override
  String get demoContainerTransformTitle => 'تبدیل محتوی';

  @override
  String get demoContainerTransformDescription => 'الگوی تبدیل محتوی برای انتقال بین عناصر واسط کاربر طراحی شده است که حاوی محتوی است. این الگو اتصالی نمایان بین دو عنصر واسط کاربر ایجاد می‌کند';
  ...
  @override
  String get demoDateRangePickerTitle => 'گزینشگر محدوده تاریخ';

  @override
  String get demoDateRangePickerDescription => 'کادر گفتگویی حاوی گزینشگر محدوده تاریخ «طراحی مواد» را نمایش می‌دهد.';
  ...
  @override
  String get demoSnackbarsDescription => 'نوار توضیحات فرایندی را که برنامه انجام داده است یا انجام خواهد داد به کاربران اعلام می‌کند. این نوار به‌طور موقت در پایین صفحه نمایش داده می‌شود. نوار نباید تجربه کاربر را مختل کند و برای بسته شدن نیازی به ورودی کاربر ندارد.';
  ...
  @override
  String get demoSelectionControlsCheckboxTitle => 'چارگوش انتخاب';

  @override
  String get demoSelectionControlsCheckboxDescription => 'چارگوش انتخاب به کاربر اجازه می‌دهد چندین گزینه را از یک مجموعه انتخاب کند. ارزش عادی چارگوش انتخاب درست یا نادرست است و ممکن است چارگوش انتخاب سه‌حالته فاقد ارزش باشد.';
  ...
  @override
  String get demoSelectionControlsSwitchDescription => 'کلید روشن/ خاموش وضعیت یک گزینه تنظیمات را تغییر می‌دهد. گزینه‌ای که این کلید کنترل می‌کند و وضعیتی که در آن است باید ازطریق برچسب به‌خط مربوطه معلوم شود.';
  ...
  @override
  String get demoTextFieldDescription => 'فیلدهای نوشتاری به کاربران امکان می‌دهد نوشتار را در واسط کاربر وارد کنند. معمولاً به‌صورت فرم‌ها و کادرهای گفتگو ظاهر می‌شوند.';
  ...
  @override
  String get demoTooltipDescription => 'نکته‌ابزارها برچسبی نوشتاری نشان می‌دهد که عملکرد دکمه‌ها یا کنش‌های دیگر واسط کاربر را توضیح می‌دهد. وقتی کاربران نشانگر را روی عنصری نگه می‌دارند، روی آن تمرکز می‌کنند، یا فشار طولانی می‌دهند، نکته‌ابزار نوشتار مفیدی نمایش می‌دهد.';
  ...
  @override
  String get bottomNavigationAlarmTab => 'زنگ';
  ...
  @override
  String get replyStarredLabel => 'ستاره‌دار';

  @override
  String get replySentLabel => 'ارسال‌شده';

  @override
  String get replyTrashLabel => 'حذف‌شده‌ها';

  @override
  String get replySpamLabel => 'هرزنامه';

  @override
  String get replyDraftsLabel => 'پیش‌نویس‌ها';

  @override
  String get demoTwoPaneFoldableLabel => 'تاشو';

  @override
  String get demoTwoPaneFoldableDescription => 'نحوه عملکرد ویژگی «دوصفحه‌ای» در دستگاه تاشو.';

  @override
  String get demoTwoPaneSmallScreenLabel => 'صفحه‌نمایش کوچک';

  @override
  String get demoTwoPaneSmallScreenDescription => 'نحوه عملکرد ویژگی «دوصفحه‌ای» در دستگاه دارای صفحه‌نمایش کوچک.';

  @override
  String get demoTwoPaneTabletLabel => 'رایانه لوحی / رایانه رومیزی';

  @override
  String get demoTwoPaneTabletDescription => 'نحوه عملکرد ویژگی «دوصفحه‌ای» در صفحه‌نمایشی بزرگ مثل رایانه لوحی یا رایانه رومیزی.';

  @override
  String get demoTwoPaneTitle => 'دوصفحه‌ای';

  @override
  String get demoTwoPaneSubtitle => 'طرح‌بندی‌های کاربردی در صفحه‌نمایش‌های تاشو، بزرگ، و کوچک';

  @override
  String get splashSelectDemo => 'نمونه‌ای را انتخاب کنید';

  @override
  String get demoTwoPaneList => 'فهرست';

  @override
  String get demoTwoPaneDetails => 'جزئیات';

  @override
  String get demoTwoPaneSelectItem => 'موردی را انتخاب کنید';
