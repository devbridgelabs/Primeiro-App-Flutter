...
class GalleryLocalizationsUr extends GalleryLocalizations {
  ...
  @override
  String get bannerDemoText => 'آپ کا پاس ورڈ آپ کے دوسرے آلہ پر اپ ڈیٹ کیا گیا تھا۔ براہ کرم دوبارہ سائن ان کریں۔';
  ...
  @override
  String get cardsDemoTravelDestinationTitle1 => 'تمل ناڈو میں گھومنے کے لیے سرفہرست 10 شہر';
  ...
  @override
  String get replyDescription => 'ایک موثر، مرتکز ای میل ایپ';
  ...
  @override
  String get rallyAccountDetailDataAnnualPercentageYield => 'سالانہ فی صد منافع';
  ...
  @override
  String get rallyAccountDetailDataInterestPaidLastYear => 'پچھلے سال ادا کیا گیا سود';
  ...
  @override
  String get rallySettingsPaperlessSettings => 'کاغذ کا استعمال ترک کرنے کی ترتیبات';
  ...
  String rallyAlertsMessageUnassignedTransactions(num count) {
    return intl.Intl.pluralLogic(
      count,
      locale: localeName,
      one: 'اپنے امکانی ٹیکس کٹوتی کو بڑھائیں! زمرے کو 1 غیر تفویض کردہ ٹرانزیکشن میں تفویض کریں۔',
      other: 'اپنے امکانی ٹیکس کٹوتی کو بڑھائیں! زمرے کو $count غیر تفویض کردہ ٹرانزیکشنز میں تفویض کریں۔',
    );
  }
  ...
  @override
  String get demoCodeViewerCopiedToClipboardMessage => 'کلپ بورڈ پر کاپی ہو گیا۔';
  ...
  @override
  String get demoOptionsFeatureDescription => 'اس ڈیمو کے ليے دستیاب اختیارات دیکھنے کے ليے یہاں تھپتھپائیں۔';
  ...
  @override
  String get settingsTextScaling => 'ٹیکسٹ اسکیلنگ';
  ...
  @override
  String get demoAppBarTitle => 'ایپ بار';

  @override
  String get demoAppBarSubtitle => 'موجودہ اسکرین سے متعلق معلومات اور کارروائیاں ڈسپلے کرتا ہے';

  @override
  String get demoAppBarDescription => 'ایپ بار موجودہ اسکرین سے متعلق مواد اور کارروائیاں فراہم کرتا ہے۔ یہ برانڈنگ، اسکرین کے عنوانات، نیویگیشن اور کارروائیوں کے لیے استعمال ہوتا ہے';

  @override
  String get demoBottomAppBarTitle => 'نیچے کا ایپ بار';

  @override
  String get demoBottomAppBarSubtitle => 'سب سے نیچے نیویگیشن اور کارروائیاں ڈسپلے کرتا ہے';

  @override
  String get demoBottomAppBarDescription => 'نیچے کی ایپ بارز نیچے کے نیویگیشن دراز اور چار کارروائیوں تک رسائی فراہم کرتی ہیں، اس میں فلوٹنگ کارروائی کا بٹن شامل ہے۔';
  ...
  @override
  String get demoBannerDescription => 'بینر ایک اہم، جامع پیغام ڈسپلے کرتا ہے اور صارفین کو خطاب کرنے (یا بینر کو برخاست کرنے کے لیے کارروائیاں فراہم کرتا ہے)۔ اس کو مسترد کرنے کے لئے صارف کی کارروائی ضروری ہے۔';

  @override
  String get demoBottomNavigationTitle => 'نیچے نیویگیشن';

  @override
  String get demoBottomNavigationSubtitle => 'کراس فیڈنگ ملاحظات کے ساتھ نیچے میں نیویگیشن';
  ...
  @override
  String get demoBottomNavigationDescription => 'باٹم نیویگیشن بارز ایک اسکرین کے نیچے تین سے پانچ منازل کو ڈسپلے کرتا ہے۔ ہر منزل کی نمائندگی ایک آئیکن اور ایک اختیاری ٹیکسٹ لیبل کے ذریعے کی جاتی ہے۔ جب نیچے میں نیویگیشن آئیکن ٹیپ ہوجاتا ہے، تو صارف کو اس آئیکن سے وابستہ اعلی سطحی نیویگیشن منزل تک لے جایا جاتا ہے۔';

  @override
  String get demoButtonTitle => 'بٹنز';

  @override
  String get demoButtonSubtitle => 'ٹیکسٹ، ابھرا ہوا، آؤٹ لائن کردہ اور بہت کچھ';

  @override
  String get demoTextButtonTitle => 'ٹیکسٹ بٹن';

  @override
  String get demoTextButtonDescription => 'ٹیکسٹ بٹن، جب دبایا جاتا ہے تو سیاہی کی چھلکیاں دکھاتا ہے، لیکن اوپر نہیں جاتا ہے۔ پیڈنگ کے ساتھ ان لائن اور ڈائیلاگز میں ٹیکسٹ بٹنز، ٹول بارز پر استعمال کریں';

  @override
  String get demoElevatedButtonTitle => 'ابھرا ہوا بٹن';

  @override
  String get demoElevatedButtonDescription => 'ابھرے ہوئے بٹنز زیادہ تر ہموار لے آؤٹس میں ڈائمینشن شامل کرتے ہیں۔ یہ مصروف یا وسیع جگہوں والے فنکشنز پر زور دیتے ہیں۔';

  @override
  String get demoOutlinedButtonTitle => 'آؤٹ لائن والا بٹن';

  @override
  String get demoOutlinedButtonDescription => 'آؤٹ لائن والے بٹنز کے دبائے جانے پر وہ دھندلے اور بلند ہو جاتے ہیں۔ یہ متبادل، ثانوی کاروائی کی نشاندہی کرنے کے لیے اکثر ابھرے ہوئے بٹنز کے ساتھ جوڑے جاتے ہیں۔';

  @override
  String get demoToggleButtonTitle => 'ٹوگل بٹنز';

  @override
  String get demoToggleButtonDescription => 'گروپ سے متعلق اختیارات کے لیے ٹوگل بٹنز استعمال کئے جا سکتے ہیں۔ متعلقہ ٹوگل بٹنز کے گروپوں پر زور دینے کے لئے، ایک گروپ کو مشترکہ کنٹینر کا اشتراک کرنا ہوگا';

  @override
  String get demoFloatingButtonTitle => 'فلوٹنگ کارروائی بٹن';

  @override
  String get demoFloatingButtonDescription => 'فلوٹنگ کارروائی کا بٹن ایک گردشی آئیکن بٹن ہوتا ہے جو ایپلیکیشن میں کسی بنیادی کارروائی کو فروغ دینے کے لیے مواد پر گھومتا ہے۔';
  ...
  @override
  String get demoCardDescription => 'کارڈ کچھ متعلقہ معلومات کی نمائندگی کے لئے استعمال ہونے والے مواد کی ایک شیٹ ہے، مثال کے طور پر ایک البم، جغرافیائی مقام، کھانے، رابطے کی تفصیلات وغیرہ۔';

  @override
  String get demoChipSubtitle => 'مختصر عناصر وہ ہیں جو ان پٹ، انتساب، یا ایکشن کی نمائندگی کر تے ہیں';

  @override
  String get demoActionChipTitle => 'ایکشن چپ';

  @override
  String get demoActionChipDescription => 'ایکشن چپس اختیارات کا ایک سیٹ ہے جو بنیادی مواد سے متعلقہ کارروائی کو متحرک کرتا ہے۔ ایکشن چپس کو متحرک اور سیاق و سباق کے لحاظ سے کسی UI میں ظاہر ہونی چاہیے۔';

  @override
  String get demoChoiceChipTitle => 'چوائس چپس';

  @override
  String get demoChoiceChipDescription => 'چوائس چپس ایک ہی سیٹ کے واحد چوائس کی نمائندگی کرتا ہے۔ چوائس چپس میں متعلقہ وضاحتی ٹیکسٹ یا زمرے ہوتے ہیں۔';

  @override
  String get demoFilterChipTitle => 'فلٹر چِپ';

  @override
  String get demoFilterChipDescription => 'فلٹر چپس مواد فلٹر کرنے کے طریقے سے ٹیگز یا وضاحتی الفاظ کا استعمال کرتے ہیں۔';

  @override
  String get demoInputChipTitle => 'ان پٹ چپ';

  @override
  String get demoInputChipDescription => 'ان پٹ چپس مختصر شکل میں ہستی (شخص، جگہ، یا چیز) یا گفتگو والے ٹیکسٹ جیسی معلومات کے ایک اہم حصے کی نمائندگی کرتے ہیں۔';
  ...
  @override
  String get demoDataTableDescription => 'ڈیٹا ٹیبلز قطاروں اور کالمز کے گرڈ جیسے فارمیٹ میں معلومات دکھاتے ہیں۔ وہ معلومات کو اس طرح منظم کرتے ہیں کہ جس سے اسکین کرنا آسان ہو، تاکہ صارفین پیٹرنز اور بصیرتوں کو تلاش کر سکیں۔';
  ...
  @override
  String get demoAlertDialogDescription => 'الرٹ ڈائیلاگ صارف کو ایسی صورتحال سے آگاہ کرتا ہے جہاں اقرار درکار ہوتا ہے۔ الرٹ ڈائیلاگ میں اختیاری عنوان اور کارروائیوں کی اختیاری فہرست ہوتی ہے۔';
  ...
  @override
  String get demoSimpleDialogDescription => 'ایک سادہ ڈائیلاگ صارف کو کئی اختیارات کے درمیان انتخاب پیش کرتا ہے ایک سادہ ڈائیلاگ کا اختیاری عنوان ہوتا ہے جو انتخابات کے اوپر دکھایا جاتا ہے۔';

  @override
  String get demoDividerTitle => 'تقسیم کار';

  @override
  String get demoDividerSubtitle => 'تقسیم کار ایک پتلی لکیر ہے جو مواد کو فہرستوں اور لے آؤٹس میں گروپ بند کرتی ہے۔';

  @override
  String get demoDividerDescription => 'تقسیم کاران فہرستوں، درازوں اور کسی اور جگہ میں مواد کو الگ کرنے کے لیے استعمال کیے جا سکتے ہیں۔';

  @override
  String get demoVerticalDividerTitle => 'عمودی تقسیم کار';
  ...
  @override
  String get demoGridListsDescription => 'ایک جیسا ڈیٹا، عموماً تصاویر پیش کرنے کے لیے گرڈ لسٹ سب سے زیادہ مناسب ہیں۔ گرڈ کی فہرست میں موجود ہر آئٹم کو ٹائل کہا جاتا ہے۔';
  ...
  @override
  String get demoSlidersDescription => 'سلائیڈرز بار کے ساتھ اقدار کے رینج کی عکاسی کرتے ہیں، جہاں سے صارفین ایک ہی قدر منتخب کر سکتے ہیں۔ یہ والیوم، چمک، یا تصویر کے فلٹرز کا اطلاق کرنے جیسی ترتیبات کو ایڈجسٹ کرنے کے لیے مثالی ہیں۔';

  @override
  String get demoRangeSlidersTitle => 'رینج سلائیڈرز';

  @override
  String get demoRangeSlidersDescription => 'سلائیڈرز بار کے ساتھ اقدار کے رینج کی عکاسی کرتے ہیں۔ ان میں بار کے دونوں کناروں پر آئیکنز ہو سکتے ہیں جو اقدار کے رینج کی عکاسی کرتے ہیں۔ یہ والیوم، چمک، یا تصویر کے فلٹرز کا اطلاق کرنے جیسی ترتیبات کو ایڈجسٹ کرنے کے لیے مثالی ہیں۔';

  @override
  String get demoCustomSlidersTitle => 'حسب ضرورت سلائیڈرز';

  @override
  String get demoCustomSlidersDescription => 'سلائیڈرز بار کے ساتھ اقدار کے رینج کی عکاسی کرتے ہیں، جہاں سے صارفین ایک ہی قدر یا اقدار کے رینج کو منتخب کر سکتے ہیں۔ ان سلائیڈرز کو تھیم شدہ اور حسب ضرورت بنایا جا سکتا ہے۔';

  @override
  String get demoSlidersContinuousWithEditableNumericalValue => 'قابل ترمیم عددی قدر کے ساتھ جاری رکھیں';

  @override
  String get demoSlidersDiscrete => 'علیحدہ';

  @override
  String get demoSlidersDiscreteSliderWithCustomTheme => 'حسب ضرورت تھیم کے ساتھ علیحدہ سلائیڈر';

  @override
  String get demoSlidersContinuousRangeSliderWithCustomTheme => 'حسب ضرورت تھیم کے ساتھ مسلسل رینج سلائیڈر';
  ...
  @override
  String get demoMenuDescription => 'مینو عارضی سطح پر انتخابات کی ایک فہرست ڈسپلے کرتا ہے۔ یہ اس وقت ظاہر ہوتے ہیں جب صارفین بٹن، ایکشن یا دیگر کنٹرول کے ساتھ تعامل کرتے ہیں۔';
  ...
  @override
  String get demoMenuAnItemWithAContextMenuButton => 'سیاق و سباق کے مینو والا ایک آئٹم';
  ...
  @override
  String get demoMenuContextMenuItemThree => 'سیاق و سباق کے مینو والا تیسرا آئٹم';

  @override
  String get demoMenuAnItemWithASectionedMenu => 'سیکشن کردہ مینو والا ایک آئٹم';
  ...
  @override
  String get demoNavigationDrawerTitle => 'نیویگیشن دراز';

  @override
  String get demoNavigationDrawerSubtitle => 'ایپ بار کے اندر موجود دراز کو ڈسپلے کیا جا رہا ہے';

  @override
  String get demoNavigationDrawerDescription => 'مٹیریل ڈیزائن پینل جو ایپلیکیشن میں نیوی گیشن لنکس دکھانے کے لیے اسکرین کے کونے سے افقی طور پر سلائیڈ ہوتا ہے۔';

  @override
  String get demoNavigationDrawerUserName => 'صارف کا نام';

  @override
  String get demoNavigationDrawerUserEmail => 'user.name@example.com';

  @override
  String get demoNavigationDrawerToPageOne => 'پہلا آئٹم';

  @override
  String get demoNavigationDrawerToPageTwo => 'دوسرا آئٹم';

  @override
  String get demoNavigationDrawerText => 'دراز دیکھنے کے لئے کونے سے سوائپ کریں یا اوپری بائیں آئیکن پر تھپتھپائیں';

  @override
  String get demoNavigationRailTitle => 'نیوی گیشن ریل';

  @override
  String get demoNavigationRailSubtitle => 'ایپ کے اندر موجود نیوی گیشن ریل کو ڈسپلے کیا جا رہا ہے';

  @override
  String get demoNavigationRailDescription => 'ملاحظات کی کم تعداد کے درمیان جو کہ عام طور پر تین اور پانچ کے بیچ ہوتے ہیں پر نیوی گیٹ کرنے کیلئے ایپ کے دائیں یا بائیں جانب قابل ڈسپلے مٹیریل ویجیٹ۔';

  @override
  String get demoNavigationRailFirst => 'پہلا';

  @override
  String get demoNavigationRailSecond => 'دوسرا';

  @override
  String get demoNavigationRailThird => 'تیسرا';
  ...
  @override
  String get demoFullscreenDialogDescription => 'fullscreenDialog کی پراپرٹی اس بات کی وضاحت کرتی ہے کہ آنے والا صفحہ ایک پوری اسکرین کا ماڈل ڈائیلاگ ہے۔';

  @override
  String get demoCupertinoActivityIndicatorTitle => 'سرگرمی انڈیکیٹر';

  @override
  String get demoCupertinoActivityIndicatorSubtitle => 'iOS طرز کے سرگرمی انڈیکیٹرز';

  @override
  String get demoCupertinoActivityIndicatorDescription => 'ایک iOS طرز کے سرگرمی انڈیکیٹرز جو گھڑی وار گھومتے ہیں۔';
  ...
  @override
  String get demoCupertinoButtonsDescription => 'ایک iOS طرز کا بٹن۔ یہ بٹن ٹچ کرنے پر فیڈ آؤٹ اور فیڈ ان کرنے والے متن اور/یا آئیکن میں شامل ہو جاتا ہے۔ اختیاری طور پر اس کا پس منظر ہو سکتا ہے';

  @override
  String get demoCupertinoContextMenuTitle => 'سیاق و سباق کا مینو';

  @override
  String get demoCupertinoContextMenuSubtitle => 'iOS طرز کے سیاق و سباق کا مینو';

  @override
  String get demoCupertinoContextMenuDescription => 'ایک iOS طرز کا فُل اسکرین سیاق و سباق کا مینو جو اس وقت ظاہر ہوتا ہے جب کسی عنصر کو لانگ پریس کیا جاتا ہے۔';

  @override
  String get demoCupertinoContextMenuActionOne => 'کارروائی ایک';

  @override
  String get demoCupertinoContextMenuActionTwo => 'کارروائی دو';

  @override
  String get demoCupertinoContextMenuActionText => 'سیاق و سباق کا مینو دیکھنے کے لیے فلوٹر لوگو کو تھپتھپائیں اور دبائے رکھیں۔';
  ...
  @override
  String get demoCupertinoAlertDescription => 'الرٹ ڈائیلاگ صارف کو ایسی صورتحال سے آگاہ کرتا ہے جہاں اقرار درکار ہوتا ہے۔ الرٹ ڈائیلاگ میں اختیاری عنوان، اختیاری مواد، اور کارروائیوں کی ایک اختیاری فہرست ہوتی ہے۔ عنوان کو مندرجات کے اوپر دکھایا جاتا ہے اور کارروائیوں کو مندرجات کے نیچے دکھایا جاتا ہے۔';
  ...
  @override
  String get demoCupertinoActionSheetDescription => 'کارروائی شیٹ الرٹ کا ایک مخصوص طرز ہے جو صارف کو موجودہ سیاق و سباق سے متعلق دو یا اس سے زائد انتخابات کا ایک مجموعہ پیش کرتا ہے۔ کارروائی شیٹ میں ایک عنوان، ایک اضافی پیغام اور کارروائیوں کی فہرست ہو سکتی ہے۔';
  ...
  @override
  String get demoCupertinoNavigationBarDescription => 'ایک iOS طرز کا نیویگیشن بار۔ نیویگیشن بار ایک ٹول بار ہے جو ٹول بار کے وسط میں کم سے کم ایک صفحہ کے عنوان پر مشتمل ہوتا ہے۔';

  @override
  String get demoCupertinoPickerTitle => 'تاریخ اور وقت منتخب کرنے والے ٹولز';

  @override
  String get demoCupertinoPickerSubtitle => 'iOS کی طرز پر تاریخ اور وقت منتخب کرنے والے ٹولز';

  @override
  String get demoCupertinoPickerDescription => 'iOS کی طرز پر منتخب کرنے والا ویجیٹ جسے تواریخ، اوقات یا تاریخ اور وقت دونوں کو منتخب کرنے کے لیے استعمال کیا جا سکتا ہے۔';
  ...
  @override
  String get demoCupertinoPullToRefreshSubtitle => 'iOS طرز والا کنٹرول کو ریفریش کرنے کے لیے کھینچیں';

  @override
  String get demoCupertinoPullToRefreshDescription => 'مواد کے کنٹرول کو ریفریش کرنے کے لیے ویجیٹ iOS طرز کو نافذ کر رہا ہے۔';

  @override
  String get demoCupertinoSegmentedControlTitle => 'سیگمینٹ کردہ کنٹرول';

  @override
  String get demoCupertinoSegmentedControlSubtitle => 'iOS طرز کا سیگمنٹ کردہ کنٹرول';

  @override
  String get demoCupertinoSegmentedControlDescription => 'باہمی خصوصی اختیارات کی ایک بڑی تعداد کے مابین منتخب کرنے کے لئے استعمال کیا جاتا ہے۔ جب سیگمینٹ کردہ کنٹرول کا کوئی آپشن منتخب کیا جاتا ہے، تو سیگمینٹ کردہ کنٹرول کے دیگر اختیارات کو منتخب کرنا بند کردیا جاتا ہے۔';
  ...
  @override
  String get demoCupertinoSliderDescription => 'ایک سلائیڈر مسلسل یا علیحدہ اقدار کے سیٹ سے منتخب کرنے کے ليے استعمال کیا جا سکتا ہے۔';
  ...
  @override
  String get demoCupertinoSwitchDescription => 'ایک سوئچ کا استعمال ایک واحد ترتیب میں آن / آف ٹوگل کرنے کے ليے کیا جاتا ہے۔';
  ...
  @override
  String get demoCupertinoTabBarDescription => 'ایک iOS طرز کے نیچے والی نیویگیشن ٹیب بار۔ ایک ٹیب کے فعال ہونے کے ساتھ پہلا ٹیب بطور ڈیفالٹ متعدد ٹیبز ڈسپلے کرتا ہے۔';
  ...
  @override
  String get demoCupertinoTextFieldDescription => 'ٹیکسٹ کا فیلڈ صارف کو ہارڈویئر کی بورڈ کے ساتھ یا اسکرین کی بورڈ کے ساتھ ٹیکسٹ داخل کرنے دیتا ہے۔';
  ...
  @override
  String get demoContainerTransformDemoInstructions => 'کارڈز، فہرستیں اور FAB';

  @override
  String get demoSharedXAxisDemoInstructions => 'آگے اور پیچھے جانے کے بٹنز';

  @override
  String get demoSharedYAxisDemoInstructions => '\"حال ہی میں چلائے گئے\" کے لحاظ سے ترتیب دیں';

  @override
  String get demoSharedZAxisDemoInstructions => 'ترتیبات کے آئیکن کا بٹن';

  @override
  String get demoFadeThroughDemoInstructions => 'نیچے نیویگیشن';

  @override
  String get demoFadeScaleDemoInstructions => 'ماڈل اور FAB';

  @override
  String get demoContainerTransformTitle => 'کنٹینر ٹرانسفارم';

  @override
  String get demoContainerTransformDescription => 'کنٹینر ٹرانسفارم پیٹرن UI عناصر کے درمیان ٹرانزٹزیشن کے لیے ڈیزائن کیا گیا ہے جس میں کنٹینر شامل ہے۔ یہ پیٹرن دو UI عناصر کے درمیان نظر آنے والا کنکشن تخلیق کرتا ہے';
  ...
  @override
  String get demoSharedAxisDescription => 'مشترکہ محور کے پیٹرن کا استعمال UI عناصر کے درمیان ٹرانزیشن کے لیے کیا جاتا ہے جس میں مکانی یا نیویگیشنل رشتہ ہوتا ہے۔ یہ پیٹرن عناصر کے درمیان تعلق کو دوبارہ تقویت دینے کے لیے x، ‫y یا z کے محور پر مشترکہ ٹرانسفارمیشن کا استعمال کرتا ہے۔';
  ...
  @override
  String get demoSharedXAxisCoursePageSubtitle => 'بنڈل شدہ زمرے آپ کی فیڈ میں گروپس کے بطور ظاہر ہوتے ہیں۔ آپ بعد میں کبھی بھی اسے تبدیل کر سکتے ہیں۔';
  ...
  @override
  String get demoSharedXAxisIndividualCourseSubtitle => 'انفرادی طور پر دکھائے گئے';

  @override
  String get demoSharedXAxisSignInWelcomeText => 'آداب David Park';

  @override
  String get demoSharedXAxisSignInSubtitleText => 'اپنے اکاؤنٹ کے ساتھ سائن ان کریں';
  ...
  @override
  String get demoSharedZAxisShrimpPlateRecipeDescription => 'جھینگا بنانے کا نسخہ';
  ...
  @override
  String get demoSharedZAxisBeefSandwichRecipeDescription => 'بیف سینڈوچ کا نسخہ';
  ...
  @override
  String get demoFadeThroughDescription => 'فیڈ تھرو پیٹرن کا استعمال UI عناصر کے درمیان ٹرانزیشن کے لیے کیا جاتا ہے جس کا ایک دوسرے کے ساتھ مضبوط تعلق نہیں ہوتا ہے۔';
  ...
  @override
  String get demoFadeScaleDescription => 'فیڈ پیٹرن کا استعمال UI عناصر کے لیے کیا جاتا ہے جو اسکرین کی حدود کے اندر داخل یا خارج ہوتا ہے جیسے کہ ایک ڈائیلاگ جو اسکرین کے بیچ میں فیڈ ہو جاتا ہے۔';
  ...
  @override
  String get demoColorsDescription => 'رنگ اور رنگ کے نمونے مستقل رہتے ہیں جو مٹیریل ڈیزائن کے رنگ کے پیلیٹ کی نمائندگی کرتے ہیں۔';
  ...
  @override
  String get demoTypographyDescription => 'مٹیریل ڈیزائن میں پائے جانے والے مختلف ٹائپوگرافیکل اسٹائل کی تعریفات۔';
  ...
  @override
  String get demo2dTransformationsDescription => 'ٹائلز میں ترمیم کرنے کے ليے تھپتھپائیں اور منظر کے ارد گرد گھومنے کے ليے اشاروں کا استعمال کریں۔ پین کرنے کے ليے گھسیٹیں، زوم کرنے کے ليے پِنچ کریں، دو انگلیوں سے گھمائیں۔ شروعاتی سمت بندی پر واپس جانے کے لیے ری سیٹ بٹن دبائیں۔';
  ...
  @override
  String get demoBottomSheetPersistentDescription => 'نیچے کی مستقل شیٹ ایپ کے بنیادی مواد کی اضافی معلومات دکھاتی ہے۔ جب تک صارف ایپ کے دوسرے حصوں سے تعامل کرتا ہے تب بھی نیچے کی مستقل شیٹ نظر آتی ہے۔';

  @override
  String get demoBottomSheetModalTitle => 'نیچے کی ماڈل شیٹ';

  @override
  String get demoBottomSheetModalDescription => 'نیچے کی موڈل شیٹ مینو یا ڈائیلاگ کا متبادل ہے اور صارف کو باقی ایپ کے ساتھ تعامل کرنے سے روکتی ہے۔';
  ...
  @override
  String get demoListsDescription => 'ایک واحد مقررہ اونچائی والی قطار جس میں عام طور پر کچھ متن کے ساتھ ساتھ آگے یا پیچھے کرنے والا ایک آئیکن ہوتا ہے۔';
  ...
  @override
  String get demoCircularProgressIndicatorDescription => 'مٹیریل ڈیزائن سرکلر پیش رفت کا انڈیکیٹر، جو ایپلیکیشن کو مصروف بتانے کے لیے گھومتا ہے۔';

  @override
  String get demoLinearProgressIndicatorTitle => 'لینئیر پیش رفت کا انڈیکیٹر';

  @override
  String get demoLinearProgressIndicatorDescription => 'مٹیریل ڈیزائن لینئیر پیش رفت کا انڈیکیٹر، جسے پیش رفت بار کے نام سے بھی جانا جاتا ہے۔';
  ...
  @override
  String get demoDatePickerDescription => 'مٹیریل ڈیزائن کی تاریخ منتخب کنندہ پر مشتمل ڈائیلاگ دکھاتا ہے۔';

  @override
  String get demoTimePickerTitle => 'وقت منتخب کنندہ';

  @override
  String get demoTimePickerDescription => 'مٹیریل ڈیزائن کا وقت منتخب کنندہ پر مشتمل ڈائیلاگ دکھاتا ہے۔';

  @override
  String get demoDateRangePickerTitle => 'تاریخ کی حد منتخب کنندہ';

  @override
  String get demoDateRangePickerDescription => 'مٹیریل ڈیزائن کی تاریخ کی حد منتخب کنندہ پر مشتمل ڈائیلاگ دکھاتا ہے۔';
  ...
  @override
  String get demoTabsDescription => 'ٹیبز مختلف اسکرینز، ڈیٹا سیٹس اور دیگر تعاملات پر مواد منظم کرتا ہے۔';

  @override
  String get demoSnackbarsTitle => 'اسنیک بارز';

  @override
  String get demoSnackbarsSubtitle => 'اسنیک بارز اسکرین کے نچلے حصے میں پیغامات دکھاتے ہیں';

  @override
  String get demoSnackbarsDescription => 'اسنیک بارز صارفین کو اس کارروائی سے متعلق بتاتے ہیں جو ایک ایپ نے انجام دیا ہے یا انجام دے گا۔ وہ اسکرین کے نچلے حصے کی طرف عارضی طور پر ظاہر ہوتے ہیں۔ انہیں صارف کے تجربے میں مداخلت نہیں کرنی چاہیے، اور انہیں غیر ظاہر کرنے کے ليے صارف کے ان پٹ کی ضرورت نہیں ہے۔';
  ...
  @override
  String get demoSelectionControlsCheckboxDescription => 'چیک باکسز صارف کو سیٹ سے متعدد اختیارات کو منتخب کرنے کی اجازت دیتا ہے۔ عام چیک باکس کی قدر صحیح یا غلط ہوتی ہے اور تین حالتوں والے چیک باکس کو خالی بھی چھوڑا جا سکتا ہے۔';

  @override
  String get demoSelectionControlsRadioTitle => 'ریڈیو';

  @override
  String get demoSelectionControlsRadioDescription => 'ریڈیو بٹنز صارف کو سیٹ سے ایک اختیار منتخب کرنے کی اجازت دیتے ہیں۔ اگر آپ کو لگتا ہے کہ صارف کو سبھی دستیاب اختیارات کو پہلو بہ پہلو دیکھنے کی ضرورت ہے تو خاص انتخاب کے لیے ریڈیو بٹنز استعمال کریں۔';

  @override
  String get demoSelectionControlsSwitchTitle => 'سوئچ کریں';

  @override
  String get demoSelectionControlsSwitchDescription => 'آن/آف سوئچز ترتیبات کے واحد اختیار کو ٹوگل کرتے ہیں۔ اختیار جسے سوئچ کنٹرول کرتا ہے اور ساتھ ہی اس میں موجود حالت متعلقہ ان لائن لیبل سے واضح کیا جانا چاہیے۔';
  ...
  @override
  String get demoTextFieldSubtitle => 'قابل ترمیم متن اور نمبرز کے لیے واحد لائن';

  @override
  String get demoTextFieldDescription => 'متں کی فیلڈز صارفین کو متن کو UI میں درج کرنے کی اجازت دیتی ہیں۔ وہ عام طور پر فارمز اور ڈائیلاگز میں ظاہر ہوتے ہیں۔';
  ...
  @override
  String get demoTextFieldFormErrors => 'براہ کرم جمع کرانے سے پہلے سرخ رنگ کی خرابیوں کو درست کریں۔';

  @override
  String get demoTextFieldNameRequired => 'نام درکار ہے۔';

  @override
  String get demoTextFieldOnlyAlphabeticalChars => 'براہ کرم صرف حروف تہجی کے اعتبار سے حروف درک کریں۔';

  @override
  String get demoTextFieldEnterUSPhoneNumber => '(###) ###-#### - ریاستہائے متحدہ امریکہ کا فون نمبر درج کریں۔';
  ...
  @override
  String get demoTextFieldWhereCanWeReachYou => 'ہم آپ سے کیسے رابطہ کر سکتے ہیں؟';
  ...
  @override
  String get demoTextFieldTellUsAboutYourself => 'اپنے بارے میں بتائیں (مثلاً، لکھیں کہ آپ کیا کرتے ہیں اور آپ کے مشغلے کیا ہیں)';

  @override
  String get demoTextFieldKeepItShort => 'اسے مختصر رکھیں ، یہ صرف ایک ڈیمو ہے۔';
  ...
  @override
  String get demoTooltipSubtitle => 'لانگ پریس یا کرسر گھمانے پر مختصر پیغام ڈسپلے کر دیا گیا';

  @override
  String get demoTooltipDescription => 'ٹول ٹپس ٹیکسٹ لیبلز فراہم کرتے ہیں جو بٹن کے فنکشن یا دوسرے صارف انٹرفیس کارروائی کی وضاحت کرنے میں مدد کرتے ہیں۔ جب صارف کسی عنصر کے اوپر کرسر گھماتے ہیں، اس پر فوکس کرتے ہیں یا لانگ پریس کرتے ہیں تب ٹول ٹپس معلوماتی متن کو ڈسپلے کرتی ہیں۔';

  @override
  String get demoTooltipInstructions => 'ٹول ٹپ کو ڈسپلے کرنے کے لیے لانگ پریس کریں یا اس پر کرسر گھمائیں۔';
  ...
  @override
  String get dialogLocationDescription => 'Google کو مقام کا تعین کرنے میں ایپس کی مدد کرنے دیں۔ اس کا مطلب یہ ہے کہ Google کو گمنام مقام کا ڈیٹا تب بھی بھیجا جائے گا، جب کوئی بھی ایپ نہیں چل رہی ہیں۔';
  ...
  @override
  String get cupertinoAlertLocationTitle => 'جب آپ ایپ استعمال کر رہے ہوں تو \"Maps\" کو اپنے مقام تک رسائی حاصل کرنے دیں؟';

  @override
  String get cupertinoAlertLocationDescription => 'آپ کا موجودہ مقام نقشے پر دکھایا جائے گا اور اس کا استعمال ڈائریکشنز، تلاش کے قریبی نتائج، اور سفر کے تخمینی اوقات کے لیے کیا جائے گا۔';
  ...
  @override
  String get cupertinoAlertDessertDescription => 'براہ کرم ذیل کی فہرست میں سے اپنی پسندیدہ میٹھی ڈش منتخب کریں۔ آپ کے انتخاب کا استعمال آپ کے علاقے میں آپ کی تجویز کردہ طعام خانوں کی فہرست کو حسب ضرورت بنانے کے لئے کیا جائے گا۔';
  ...
  @override
  String get craneFly0SemanticLabel => 'سدا بہار پہاڑوں کے بیچ برفیلے لینڈ اسکیپ میں چالیٹ';
  ...
  @override
  String get craneFly6SemanticLabel => 'پلاسیو دا بلاس آرٹس کے محل کا فضائی نظارہ';
  ...
  @override
  String get craneFly9SemanticLabel => 'نیلے رنگ کی کار سے ٹیک لگار کر کھڑا آدمی';

  @override
  String get craneFly10SemanticLabel => 'غروب آفتاب کے دوران ازہر مسجد کے ٹاورز';
  ...
  @override
  String get craneFly13SemanticLabel => 'سمندر کنارے کھجور کے درختوں کے ساتھ پول';

  @override
  String get craneSleep0SemanticLabel => 'پانی کے اوپر بنگلے';

  @override
  String get craneSleep1SemanticLabel => 'سدا بہار پہاڑوں کے بیچ برفیلے لینڈ اسکیپ میں چالیٹ';

  @override
  String get craneSleep2SemanticLabel => 'ماچو پیچو کا قلعہ';

  @override
  String get craneSleep3SemanticLabel => 'نیلے رنگ کی کار سے ٹیک لگار کر کھڑا آدمی';
  ...
  @override
  String get craneSleep8SemanticLabel => 'بیچ کے اوپر پہاڑ پر مایا تہذیب کے کھنڈرات';

  @override
  String get craneSleep9SemanticLabel => 'سمندر کے کنارے برک لائٹ ہاؤس';

  @override
  String get craneSleep10SemanticLabel => 'غروب آفتاب کے دوران ازہر مسجد کے ٹاورز';
  ...
  @override
  String get fortnightlyHeadlineHealthcare => 'صحت کی دیکھ ریکھ میں پرسکون لیکن طاقتور انقلاب';
  ...
  @override
  String get fortnightlyHeadlineStocks => 'اسٹاکس کے ساکن ہونے پر، بہت سے لوگوں کا رحجان کرنسی کی طرف';

  @override
  String get fortnightlyHeadlineFabrics => 'مستقبل کے کپڑے تیار کرنے کے لیے ڈیزائنرز ٹیکنالوجی کا استعمال کرتے ہے';
  ...
  @override
  String get replyInboxLabel => 'ان باکس';

  @override
  String get replyStarredLabel => 'ستارہ لگا ہوا';

  @override
  String get replySentLabel => 'بھیج دیا گیا';

  @override
  String get replyTrashLabel => 'کوڑے دان';

  @override
  String get replySpamLabel => 'اسپام';

  @override
  String get replyDraftsLabel => 'مسودے';

  @override
  String get demoTwoPaneFoldableLabel => 'فولڈ ہونے والے';

  @override
  String get demoTwoPaneFoldableDescription => 'فولڈ ہونے والے آلے پر TwoPane اس طرح برتاؤ کرتا ہے۔';

  @override
  String get demoTwoPaneSmallScreenLabel => 'چھوٹی اسکرین';

  @override
  String get demoTwoPaneSmallScreenDescription => 'چھوٹی اسکرین والے آلے پر TwoPane اس طرح برتاؤ کرتا ہے۔';

  @override
  String get demoTwoPaneTabletLabel => 'ٹیبلیٹ / ڈیسک ٹاپ';

  @override
  String get demoTwoPaneTabletDescription => 'ٹیبلیٹ یا ڈیسک ٹاپ کی طرح بڑی اسکرین پر TwoPane اس طرح برتاؤ کرتا ہے۔';

  @override
  String get demoTwoPaneTitle => 'TwoPane';

  @override
  String get demoTwoPaneSubtitle => 'فولڈ ہونے والی، بڑی اور چھوٹی اسکرینز پر ریسپانسیو لے آؤٹس';

  @override
  String get splashSelectDemo => 'ڈیمو منتخب کریں';

  @override
  String get demoTwoPaneList => 'فہرست';

  @override
  String get demoTwoPaneDetails => 'تفصیلات';

  @override
  String get demoTwoPaneSelectItem => 'ایک آئٹم منتخب کریں';
