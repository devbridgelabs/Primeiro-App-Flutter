...
class GalleryLocalizationsKa extends GalleryLocalizations {
  ...
  @override
  String get replyDescription => 'ელფოსტის ეფექტური, ფოკუსირებული აპი';
  ...
  @override
  String get demoAppBarTitle => 'აპების ზოლი';

  @override
  String get demoAppBarSubtitle => 'აჩვენებს მიმდინარე ეკრანთან დაკავშირებულ ინფორმაციასა და მოქმედებებს';

  @override
  String get demoAppBarDescription => 'აპების ზოლი უზრუნველყოფს მიმდინარე ეკრანთან დაკავშირებულ კონტენტსა და მოქმედებებს. ის გამოიყენება ბრენდირების, ეკრანის სათაურების, ნავიგაციისა და მოქმედებებისთვის';
  ...
  @override
  String get demoButtonSubtitle => 'ტექსტის, ამოწეული, კონტურიანი და სხვა';
  ...
  @override
  String get demoDataTableDescription => 'მონაცემთა ცხრილები აჩვენებს ინფორმაციას ბადისებურ ფორმატში, მწკრივებით და სვეტებით. მათში ინფორმაცია ისეა ორგანიზებული, რომ მარტივია სკანირებისთვის და მომხმარებლებს შეუძლიათ ნიმუშებისა და ანალიზების ნახვა.';
  ...
  @override
  String get demoDividerTitle => 'გამყოფი';

  @override
  String get demoDividerSubtitle => 'გამყოფი თხელი ხაზია, რომელიც აჯგუფებს კონტენტს სიების და განლაგებების სახით.';

  @override
  String get demoDividerDescription => 'გამყოფების გამოყენება შიგთავსის გასაყოფად შესაძლებელია სიებში, უჯრებში და სურვილისამებრ ყველგან.';

  @override
  String get demoVerticalDividerTitle => 'ვერტიკალური გამყოფი';
  ...
  @override
  String get demoNavigationDrawerTitle => 'ნავიგაციის უჯრა';
  ...
  @override
  String get demoNavigationDrawerToPageOne => 'ერთეული ერთი';
  ...
  @override
  String get demoNavigationRailSecond => 'მეორე';

  @override
  String get demoNavigationRailThird => 'მესამე';
  ...
  @override
  String get demoCupertinoContextMenuTitle => 'კონტექსტური მენიუ';

  @override
  String get demoCupertinoContextMenuSubtitle => 'iOS სტილის კონტექსტური მენიუ';

  @override
  String get demoCupertinoContextMenuDescription => 'iOS სტილის კონტექსტური მენიუ სრულ ეკრანზე გამოჩნდება მაშინ, როცა ელემენტს ხანგრძლივად დააჭერენ.';

  @override
  String get demoCupertinoContextMenuActionOne => 'მოქმედება პირველი';

  @override
  String get demoCupertinoContextMenuActionTwo => 'მოქმედება მეორე';

  @override
  String get demoCupertinoContextMenuActionText => 'კონტექსტური მენიუს სანახავად ხანგრძლივად შეეხეთ Flutter-ის ლოგოს.';
  ...
  @override
  String get demoDateRangePickerTitle => 'თარიღების დიაპაზონის ამომრჩევი';

  @override
  String get demoDateRangePickerDescription => 'აჩვენებს დიალოგს, რომელიც შეიცავს Material Design-ის თარიღის ამომრჩევს.';
  ...
  @override
  String get demoSnackbarsDescription => 'სნეკ-ზოლები მომხმარებლებს აწვდის ინფორმაციას იმ პროცესის შესახებ, რომელიც აპმა შეასრულა ან რომელსაც შეასრულებს. ისინი ჩნდება დროებით, ეკრანის ქვედა ნაწილში. ისინი არ უნდა უშლიდეს ხელს მომხმარებელს და მათ გასაქრობად მომხმარებელს არაფრის გაკეთება სჭირდება.';
  ...
  @override
  String get replyInboxLabel => 'შემოსულები';

  @override
  String get replyStarredLabel => 'ვარსკვლავით მონიშნულები';

  @override
  String get replySentLabel => 'გაგზავნილები';

  @override
  String get replyTrashLabel => 'წაშლილები';

  @override
  String get replySpamLabel => 'სპამი';

  @override
  String get replyDraftsLabel => 'მონახაზები';

  @override
  String get demoTwoPaneFoldableLabel => 'დასაკეცი';

  @override
  String get demoTwoPaneFoldableDescription => 'აი, როგორ მოიქცევა TwoPane დასაკეც მოწყობილობაზე.';

  @override
  String get demoTwoPaneSmallScreenLabel => 'პატარა ეკრანი';

  @override
  String get demoTwoPaneSmallScreenDescription => 'აი, როგორ მოიქცევა TwoPane პატარა მოწყობილობაზე.';

  @override
  String get demoTwoPaneTabletLabel => 'ტაბლეტი / დესკტოპი';

  @override
  String get demoTwoPaneTabletDescription => 'აი, როგორ მოიქცევა TwoPane უფრო დიდეკრანიან მოწყობილობაზე, მაგალითად, ტაბლეტზე ან დესკტოპზე.';

  @override
  String get demoTwoPaneTitle => 'TwoPane';

  @override
  String get demoTwoPaneSubtitle => 'ადაპტური განლაგებები დასაკეც, დიდ და პატარაეკრანიან მოწყობილობებზე';

  @override
  String get splashSelectDemo => 'აირჩიეთ დემო';

  @override
  String get demoTwoPaneList => 'სია';

  @override
  String get demoTwoPaneDetails => 'დეტალები';

  @override
  String get demoTwoPaneSelectItem => 'აირჩიეთ ერთეული';
