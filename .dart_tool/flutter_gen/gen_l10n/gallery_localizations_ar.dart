...
class GalleryLocalizationsAr extends GalleryLocalizations {
  ...
  @override
  String get demoAppBarSubtitle => 'يعرض الشريط معلومات وإجراءات متعلقة بالشاشة الحالية.';

  @override
  String get demoAppBarDescription => 'يعرض شريط التطبيق المحتوى والإجراءات المتعلّقة بالشاشة الحالية، ويُستخدَم لعرض العلامات التجارية وعناوين الشاشة والإجراءات والتنقّل بين الأقسام.';
  ...
  @override
  String get demoDataTableDescription => 'تعرض جداول البيانات معلومات على هيئة شبكة من الصفوف والأعمدة، حيث يتم تنظيم المعلومات بطريقة يَسهُل فحصها كي يتمكّن المستخدمون من البحث عن الأنماط والإحصاءات.';
  ...
  @override
  String get demoDividerSubtitle => 'أداة تقسيم الشاشة هي خط رفيع يُجمِّع المحتوى في قوائم وتنسيقات.';

  @override
  String get demoDividerDescription => 'يمكن استخدام أدوات تقسيم الشاشة في القوائم والأدراج وغيرها لوضع فواصل بين المحتوى.';
  ...
  @override
  String get demoCupertinoContextMenuDescription => 'قائمة سياقات بنمط iOS تظهر بوضع ملء الشاشة عند الضغط مع الاستمرار على أحد العناصر';
  ...
  @override
  String get demoCupertinoContextMenuActionText => 'اضغط مع الاستمرار على شعار Flutter لعرض قائمة السياقات.';
  ...
  @override
  String get demoDateRangePickerDescription => 'تعرض هذه الأداة مربّع حوار يحتوي على أداة بتصميم متعدد الأبعاد لاختيار المرحلة الزمنية.';
  ...
  @override
  String get demoSnackbarsDescription => 'تُعلِم \"أشرطة الإعلام المنبثقة\" المستخدمين بعملية نفّذها أو سينفّذها التطبيق. وتظهر مؤقتًا في أسفل الشاشة. ويُفترَض ألا تشوش هذه الأشرطة على تجربة المستخدم ولا تتطلّب تدخل المستخدم كي تختفي.';
  ...
  @override
  String get demoSelectionControlsSwitchDescription => 'تؤدي مفاتيح التشغيل/الإيقاف إلى تبديل حالة خيار واحد في الإعدادات. ويجب توضيح الخيار الذي يتحكّم فيه المفتاح وكذلك حالته، وذلك من خلال التسمية المضمَّنة المتاحة.';
  ...
  @override
  String get demoTwoPaneFoldableDescription => 'هذه هي الطريقة التي يتصرف بها TwoPane على جهاز قابل للطي.';

  @override
  String get demoTwoPaneSmallScreenLabel => 'الشاشة الصغيرة';

  @override
  String get demoTwoPaneSmallScreenDescription => 'هذه هي الطريقة التي يتصرف بها TwoPane على جهاز مزوَّد بشاشة صغيرة.';

  @override
  String get demoTwoPaneTabletLabel => 'الأجهزة اللوحية / أجهزة الكمبيوتر المكتبية';

  @override
  String get demoTwoPaneTabletDescription => 'هذه هي الطريقة التي يتصرف بها TwoPane على جهاز مزوَّد بشاشة كبيرة، مثل الجهاز اللوحي أو جهاز الكمبيوتر المكتبي.';

  @override
  String get demoTwoPaneTitle => 'TwoPane';

  @override
  String get demoTwoPaneSubtitle => 'التصميمات المتجاوبة مع مختلف الأجهزة على الشاشات القابلة للطي والكبيرة والصغيرة';
