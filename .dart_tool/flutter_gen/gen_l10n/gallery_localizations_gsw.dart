...
class GalleryLocalizationsGsw extends GalleryLocalizations {
  GalleryLocalizationsGsw([String locale = 'gsw']) : super(locale);
  ...
  @override
  String get bannerDemoText => 'Dein Passwort wurde auf einem anderen Gerät aktualisiert. Melde dich noch einmal an.';
  ...
  @override
  String get cardsDemoTravelDestinationTitle1 => 'Die zehn schönsten Städte in Tamil Nadu, die man sich ansehen sollte';
  ...
  @override
  String get cardsDemoTravelDestinationTitle2 => 'Kunsthandwerker aus Südindien';
  ...
  @override
  String get fortnightlyDescription => 'Eine News-App mit hoher inhaltlicher Qualität';

  @override
  String get rallyDescription => 'Persönliche Finanz-App';

  @override
  String get replyDescription => 'Eine effiziente, funktionale E-Mail-App';
  ...
  @override
  String get rallyAccountDetailDataAnnualPercentageYield => 'Jährlicher Ertrag in Prozent';
  ...
  @override
  String get rallyAccountDetailDataInterestPaidLastYear => 'Letztes Jahr gezahlte Zinsen';
  ...
  String rallyAlertsMessageHeadsUpShopping(Object percent) {
    return 'Achtung: Du hast $percent deines Einkaufsbudgets für diesen Monat verbraucht.';
  }
  ...
  String rallyAlertsMessageUnassignedTransactions(num count) {
    return intl.Intl.pluralLogic(
      count,
      locale: localeName,
      one: 'Erhöhe deine potenziellen Steuervergünstigungen! Du kannst 1 nicht zugewiesenen Transaktion Kategorien zuordnen.',
      other: 'Erhöhe deine potenziellen Steuervergünstigungen! Du kannst $count nicht zugewiesenen Transaktionen Kategorien zuordnen.',
    );
  }
  ...
  @override
  String get demoCodeViewerCopiedToClipboardMessage => 'In die Zwischenablage kopiert.';
  ...
  @override
  String get demoOptionsFeatureDescription => 'Tippe hier, um die verfügbaren Optionen für diese Demo anzuzeigen.';
  ...
  @override
  String get demoAppBarTitle => 'App-Leiste';

  @override
  String get demoAppBarSubtitle => 'Zeigt Informationen und Aktionen zum aktuellen Bildschirm an';

  @override
  String get demoAppBarDescription => 'Die App-Leiste zeigt Inhalte und Aktionen für den aktuellen Bildschirm an. Sie kann für Branding, Bildschirmtitel, die Navigation und Aktionen verwendet werden.';

  @override
  String get demoBottomAppBarTitle => 'Untere App-Leiste';

  @override
  String get demoBottomAppBarSubtitle => 'Navigationselemente und Aktionen werden unten angezeigt';

  @override
  String get demoBottomAppBarDescription => 'App-Leisten am unteren Rand bieten Zugriff auf eine Navigationsleiste und bis zu vier Aktionen, einschließlich der unverankerten Aktionsschaltfläche.';

  @override
  String get bottomAppBarNotch => 'Notch';

  @override
  String get bottomAppBarPosition => 'Position der unverankerten Aktionsschaltfläche';
  ...
  @override
  String get demoBannerSubtitle => 'Banner wird innerhalb einer Liste angezeigt';

  @override
  String get demoBannerDescription => 'Ein Banner enthält eine kurze wichtige Botschaft sowie Handlungsanweisungen für den Nutzer – auch zum Ausblenden des Banners. Das Banner wird nicht ohne eine Aktion des Nutzers ausgeblendet.';

  @override
  String get demoBottomNavigationTitle => 'Navigation am unteren Rand';

  @override
  String get demoBottomNavigationSubtitle => 'Navigation am unteren Rand mit sich überblendenden Ansichten';
  ...
  @override
  String get demoBottomNavigationDescription => 'Auf Navigationsleisten am unteren Bildschirmrand werden zwischen drei und fünf Zielseiten angezeigt. Jede Zielseite wird durch ein Symbol und eine optionale Beschriftung dargestellt. Wenn ein Navigationssymbol am unteren Rand angetippt wird, wird der Nutzer zur Zielseite auf der obersten Ebene der Navigation weitergeleitet, die diesem Symbol zugeordnet ist.';

  @override
  String get demoButtonTitle => 'Schaltflächen';

  @override
  String get demoButtonSubtitle => 'Mit Text, Erhöhung, Umriss und mehr';

  @override
  String get demoTextButtonTitle => 'Textschaltfläche';

  @override
  String get demoTextButtonDescription => 'Eine Textschaltfläche, die beim Drücken eine Farbreaktion zeigt, aber nicht erhöht dargestellt wird. Du kannst Textschaltflächen auf Symbolleisten, in Dialogfeldern und inline mit Abständen verwenden.';

  @override
  String get demoElevatedButtonTitle => 'Erhöhte Schaltfläche';

  @override
  String get demoElevatedButtonDescription => 'Erhöhte Schaltflächen verleihen flachen Layouts mehr Dimension. Sie können verwendet werden, um Funktionen auf überladenen oder leeren Flächen hervorzuheben.';

  @override
  String get demoOutlinedButtonTitle => 'Schaltflächen mit Umriss';

  @override
  String get demoOutlinedButtonDescription => 'Schaltflächen mit Umriss werden undurchsichtig und erhöht dargestellt, wenn sie gedrückt werden. Sie werden häufig mit erhöhten Schaltflächen kombiniert, um eine alternative oder sekundäre Aktion zu kennzeichnen.';

  @override
  String get demoToggleButtonTitle => 'Ein-/Aus-Schaltflächen';

  @override
  String get demoToggleButtonDescription => 'Ein-/Aus-Schaltflächen können verwendet werden, um ähnliche Optionen zu gruppieren. Die Gruppe sollte einen gemeinsamen Container haben, um hervorzuheben, dass die Ein-/Aus-Schaltflächen eine ähnliche Funktion erfüllen.';

  @override
  String get demoFloatingButtonTitle => 'Unverankerte Aktionsschaltfläche';

  @override
  String get demoFloatingButtonDescription => 'Eine unverankerte Aktionsschaltfläche ist eine runde Symbolschaltfläche, die über dem Inhalt schwebt und Zugriff auf eine primäre Aktion der App bietet.';
  ...
  @override
  String get demoCardDescription => 'Eine Karte enthält zusätzliche Informationen wie ein Album, einen geografischen Standort, ein Gericht, Kontaktdaten usw.';

  @override
  String get demoChipSubtitle => 'Kompakte Elemente, die für eine Eingabe, ein Attribut oder eine Aktion stehen';

  @override
  String get demoActionChipTitle => 'Aktions-Chip';

  @override
  String get demoActionChipDescription => 'Aktions-Chips sind eine Gruppe von Optionen, die eine Aktion im Zusammenhang mit wichtigen Inhalten auslösen. Aktions-Chips sollten in der Benutzeroberfläche dynamisch und kontextorientiert erscheinen.';

  @override
  String get demoChoiceChipTitle => 'Auswahl-Chip';

  @override
  String get demoChoiceChipDescription => 'Auswahl-Chips stehen für eine einzelne Auswahl aus einer Gruppe von Optionen. Auswahl-Chips enthalten zugehörigen beschreibenden Text oder zugehörige Kategorien.';

  @override
  String get demoFilterChipTitle => 'Filter Chip';

  @override
  String get demoFilterChipDescription => 'Filter-Chips dienen zum Filtern von Inhalten anhand von Tags oder beschreibenden Wörtern.';

  @override
  String get demoInputChipTitle => 'Eingabe-Chip';

  @override
  String get demoInputChipDescription => 'Eingabe-Chips stehen für eine komplexe Information, wie eine Entität (Person, Ort oder Gegenstand) oder für Gesprächstext in kompakter Form.';
  ...
  @override
  String get demoDataTableDescription => 'In Datentabellen werden Informationen in einem rasterähnlichen Format aus Zeilen und Spalten angezeigt. Dabei werden sie so angeordnet, dass sie leicht zu erfassen sind und Nutzer nach Mustern und anderen Auffälligkeiten suchen können.';
  ...
  @override
  String get demoAlertDialogDescription => 'Ein Benachrichtigungsdialog informiert Nutzer über Situationen, die ihre Aufmerksamkeit erfordern. Er kann einen Titel und eine Liste mit Aktionen enthalten. Beides ist optional.';
  ...
  @override
  String get demoSimpleDialogDescription => 'Ein einfaches Dialogfeld bietet Nutzern mehrere Auswahlmöglichkeiten. Optional kann über den Auswahlmöglichkeiten ein Titel angezeigt werden.';

  @override
  String get demoDividerTitle => 'Trennlinie';

  @override
  String get demoDividerSubtitle => 'Eine dünne Linie, die Gruppen von Inhalten in Listen und Layouts voneinander trennt.';

  @override
  String get demoDividerDescription => 'Trennlinien können in Listen, Leisten und an anderen Stellen verwendet werden, um Inhalte zu trennen.';

  @override
  String get demoVerticalDividerTitle => 'Vertikale Trennlinie';
  ...
  @override
  String get demoGridListsDescription => 'Rasterlisten eignen sich bestens zur Darstellung von homogenen Daten. Sie werden oft für Bilder verwendet. Die einzelnen Elemente in einer Rasterliste werden Kacheln genannt.';
  ...
  @override
  String get demoSlidersSubtitle => 'Widgets zur Auswahl eines Werts durch Ziehen';

  @override
  String get demoSlidersDescription => 'Mit Schiebereglern auf einer Leiste wird ein Wertebereich dargestellt, aus dem Nutzer einen einzelnen Wert auswählen können. Sie eignen sich ideal zum Anpassen von Einstellungen wie Lautstärke und Helligkeit oder zum Anwenden von Bildfiltern.';

  @override
  String get demoRangeSlidersTitle => 'Bereichsschieberegler';

  @override
  String get demoRangeSlidersDescription => 'Mit Schiebereglern auf einer Leiste wird ein Wertebereich dargestellt. An beiden Enden der Leiste kann zur Definition des Wertebereichs ein Symbol stehen. Schieberegler eignen sich ideal zum Anpassen von Einstellungen wie Lautstärke und Helligkeit oder zum Anwenden von Bildfiltern.';

  @override
  String get demoCustomSlidersTitle => 'Benutzerdefinierte Schieberegler';

  @override
  String get demoCustomSlidersDescription => 'Mit Schiebereglern auf einer Leiste wird ein Wertebereich dargestellt, aus dem Nutzer einen einzelnen Wert oder einen Wertebereich auswählen können. Die Schieberegler können individuell gestaltet und angepasst werden.';

  @override
  String get demoSlidersContinuousWithEditableNumericalValue => 'Fortlaufend mit bearbeitbarem Zahlenwert';

  @override
  String get demoSlidersDiscrete => 'Diskret';

  @override
  String get demoSlidersDiscreteSliderWithCustomTheme => 'Schieberegler für diskrete Daten mit benutzerdefiniertem Design';

  @override
  String get demoSlidersContinuousRangeSliderWithCustomTheme => 'Bereichsschieberegler für fortlaufende Daten mit benutzerdefiniertem Design';
  ...
  @override
  String get demoMenuDescription => 'Ein Menü wird vorübergehend eingeblendet und enthält eine Liste mit Auswahlmöglichkeiten. Menüs erscheinen, wenn Nutzer mit Steuerelementen wie Schaltflächen interagieren.';
  ...
  @override
  String get demoMenuAnItemWithAContextMenuButton => 'Ein Element mit einem Kontextmenü';
  ...
  @override
  String get demoMenuAnItemWithASectionedMenu => 'Ein Element mit einem Menü mit Abschnitten';
  ...
  @override
  String get demoNavigationDrawerTitle => 'Navigationsleiste';

  @override
  String get demoNavigationDrawerSubtitle => 'Leiste auf einer App-Leiste anzeigen';

  @override
  String get demoNavigationDrawerDescription => 'Ein Steuerfeld im Material Design, das sich quer vom Rand des Bildschirms nach innen bewegt und Navigationslinks in einer App anzeigt.';

  @override
  String get demoNavigationDrawerUserName => 'Nutzername';

  @override
  String get demoNavigationDrawerUserEmail => 'nutzername@beispiel.com';

  @override
  String get demoNavigationDrawerToPageOne => 'Erstes Element';

  @override
  String get demoNavigationDrawerToPageTwo => 'Zweites Element';

  @override
  String get demoNavigationDrawerText => 'Wische zum Einblenden der Leiste vom Rand nach innen oder tippe auf das Symbol links oben';

  @override
  String get demoNavigationRailTitle => 'Navigationsstreifen';

  @override
  String get demoNavigationRailSubtitle => 'Navigationsstreifen in einer App anzeigen';

  @override
  String get demoNavigationRailDescription => 'Ein Widget im Material Design, das links oder rechts in einer App angezeigt werden soll und dem Nutzer ermöglicht, zwischen einer überschaubaren Zahl an Ansichten, in der Regel 3 bis 5, zu wechseln.';

  @override
  String get demoNavigationRailFirst => 'Erste Seite';

  @override
  String get demoNavigationRailSecond => 'Zweite Seite';

  @override
  String get demoNavigationRailThird => 'Dritte Seite';

  @override
  String get demoMenuAnItemWithASimpleMenu => 'Ein Element mit einem einfachen Menü';

  @override
  String get demoMenuAnItemWithAChecklistMenu => 'Ein Element mit einem Checklistenmenü';

  @override
  String get demoFullscreenDialogTitle => 'Vollbild';

  @override
  String get demoFullscreenDialogDescription => 'Das Attribut \"fullscreenDialog\" gibt an, ob eine eingehende Seite ein modales Vollbild-Dialogfeld ist';

  @override
  String get demoCupertinoActivityIndicatorTitle => 'Aktivitätsanzeige';

  @override
  String get demoCupertinoActivityIndicatorSubtitle => 'Aktivitätsanzeigen im Stil von iOS';

  @override
  String get demoCupertinoActivityIndicatorDescription => 'Eine Aktivitätsanzeige im Stil von iOS, die sich im Uhrzeigersinn dreht.';
  ...
  @override
  String get demoCupertinoButtonsDescription => 'Eine Schaltfläche im Stil von iOS. Sie kann Text und/oder ein Symbol enthalten, die bei Berührung aus- und eingeblendet werden. Optional ist auch ein Hintergrund möglich.';

  @override
  String get demoCupertinoContextMenuTitle => 'Kontextmenü';

  @override
  String get demoCupertinoContextMenuSubtitle => 'Kontextmenü im Stil von iOS';

  @override
  String get demoCupertinoContextMenuDescription => 'Ein Vollbild-Kontextmenü im Stil von iOS, das erscheint, wenn ein Element lange gedrückt wird.';

  @override
  String get demoCupertinoContextMenuActionOne => 'Erste Aktion';

  @override
  String get demoCupertinoContextMenuActionTwo => 'Zweite Aktion';

  @override
  String get demoCupertinoContextMenuActionText => 'Halte das Flutter-Logo gedrückt, um das Kontextmenü aufzurufen.';

  @override
  String get demoCupertinoAlertsTitle => 'Benachrichtigungen';

  @override
  String get demoCupertinoAlertsSubtitle => 'Dialogfelder für Benachrichtigungen im Stil von iOS';

  @override
  String get demoCupertinoAlertTitle => 'Benachrichtigung';

  @override
  String get demoCupertinoAlertDescription => 'Ein Benachrichtigungsdialog informiert den Nutzer über Situationen, die seine Aufmerksamkeit erfordern. Optional kann er einen Titel, Inhalt und eine Liste mit Aktionen enthalten. Der Titel wird über dem Inhalt angezeigt, die Aktionen darunter.';

  @override
  String get demoCupertinoAlertWithTitleTitle => 'Benachrichtigung mit Titel';

  @override
  String get demoCupertinoAlertButtonsTitle => 'Benachrichtigung mit Schaltflächen';

  @override
  String get demoCupertinoAlertButtonsOnlyTitle => 'Nur Schaltflächen für Benachrichtigungen';

  @override
  String get demoCupertinoActionSheetTitle => 'Aktionstabelle';

  @override
  String get demoCupertinoActionSheetDescription => 'Eine Aktionstabelle ist eine Art von Benachrichtigung, bei der Nutzern zwei oder mehr Auswahlmöglichkeiten zum aktuellen Kontext angezeigt werden. Sie kann einen Titel, eine zusätzliche Nachricht und eine Liste von Aktionen enthalten.';

  @override
  String get demoCupertinoNavigationBarTitle => 'Navigationsleiste';

  @override
  String get demoCupertinoNavigationBarSubtitle => 'Navigationsleiste im Stil von iOS';

  @override
  String get demoCupertinoNavigationBarDescription => 'Eine Navigationsleiste im Stil von iOS. Die Navigationsleiste ist eine Symbolleiste, die mindestens aus einem Seitentitel in der Mitte der Leiste besteht.';

  @override
  String get demoCupertinoPickerTitle => 'Auswahlelemente';

  @override
  String get demoCupertinoPickerSubtitle => 'Auswahlelemente für Datum und Uhrzeit im Stil von iOS';

  @override
  String get demoCupertinoPickerDescription => 'Ein Auswahlelement-Widget im iOS-Stil, das zum Auswählen von Daten, Uhrzeiten oder beidem verwendet werden kann.';
  ...
  @override
  String get demoCupertinoPullToRefreshTitle => 'Zum Aktualisieren nach unten wischen';

  @override
  String get demoCupertinoPullToRefreshSubtitle => 'Steuerelement \"Zum Aktualisieren nach unten ziehen\" im Stil von iOS';

  @override
  String get demoCupertinoPullToRefreshDescription => 'Ein Widget, das das Inhaltssteuerelement \"Zum Aktualisieren nach unten ziehen\" im Stil von iOS implementiert.';

  @override
  String get demoCupertinoSegmentedControlTitle => 'Segmentierte Steuerung';

  @override
  String get demoCupertinoSegmentedControlSubtitle => 'Segmentierte Steuerung im Stil von iOS';

  @override
  String get demoCupertinoSegmentedControlDescription => 'Wird verwendet, um aus einer Reihe von Optionen zu wählen, die sich gegenseitig ausschließen. Wenn eine Option in der segmentierten Steuerung ausgewählt ist, wird dadurch die Auswahl für die anderen Optionen aufgehoben.';
  ...
  @override
  String get demoCupertinoSliderDescription => 'Ein Schieberegler kann dazu verwendet werden, Werte stufenlos oder aus einer festgelegten Gruppe auszuwählen.';
  ...
  @override
  String get demoCupertinoSwitchDescription => 'Mit einem Schalter wird für eine einzelne Einstellung der Wert \"An\" oder \"Aus\" festgelegt.';
  ...
  @override
  String get demoCupertinoTabBarDescription => 'Eine untere Tab-Leiste zur Navigation im Stil von iOS. Darauf werden mehrere Tabs angezeigt, wobei jeweils ein Tab aktiv ist – standardmäßig der erste.';
  ...
  @override
  String get demoCupertinoTextFieldDescription => 'In einem Textfeld kann der Nutzer entweder mithilfe einer Hardware- oder einer Bildschirmtastatur etwas eingeben.';
  ...
  @override
  String get demoContainerTransformDemoInstructions => 'Karten, Listen & UAS';

  @override
  String get demoSharedXAxisDemoInstructions => 'Schaltflächen „Weiter“ und „Zurück“';

  @override
  String get demoSharedYAxisDemoInstructions => 'Sortieren nach „Vor Kurzem angehört“';

  @override
  String get demoSharedZAxisDemoInstructions => 'Symbolschaltfläche „Einstellungen“';

  @override
  String get demoFadeThroughDemoInstructions => 'Navigation am unteren Rand';

  @override
  String get demoFadeScaleDemoInstructions => 'Modal und UAS';

  @override
  String get demoContainerTransformTitle => 'Container-Übergangsmuster';

  @override
  String get demoContainerTransformDescription => 'Das Container-Übergangsmuster wurde für Übergänge zwischen UI-Elementen konzipiert, die einen Container enthalten. Dieses Muster erzeugt eine sichtbare Verbindung zwischen zwei UI-Elementen.';
  ...
  @override
  String get demoSharedAxisDescription => 'Das Muster \"Gemeinsame Achse\" wird für Übergänge zwischen UI-Elementen verwendet, die räumlich oder navigatorisch zueinander in einer Beziehung stehen. Dieses Muster verwendet gemeinsame Übergänge auf der X-, Y- oder Z-Achse, um den Zusammenhang der Elemente zu verstärken.';
  ...
  @override
  String get demoSharedXAxisCoursePageSubtitle => 'Gruppierte Kategorien werden in deinem Feed zusammen angezeigt. Diese Einstellung kannst du später jederzeit ändern.';
  ...
  @override
  String get demoSharedXAxisSignInSubtitleText => 'melde dich mit deinem Konto an';

  @override
  String get demoSharedXAxisSignInTextFieldLabel => 'E-Mail-Adresse oder Telefonnummer';

  @override
  String get demoSharedXAxisForgotEmailButtonText => 'E-MAIL-ADRESSE VERGESSEN?';
  ...
  @override
  String get demoSharedZAxisSandwichRecipeDescription => 'Rezept für Sandwiches';
  ...
  @override
  String get demoSharedZAxisShrimpPlateRecipeDescription => 'Rezept für Garnelengerichte';

  @override
  String get demoSharedZAxisCrabPlateRecipeTitle => 'Krebs';

  @override
  String get demoSharedZAxisCrabPlateRecipeDescription => 'Rezept für Krebsgerichte';

  @override
  String get demoSharedZAxisBeefSandwichRecipeTitle => 'Rindfleisch-Sandwich';

  @override
  String get demoSharedZAxisBeefSandwichRecipeDescription => 'Rezept für Rindfleisch-Sandwiches';
  ...
  @override
  String get demoFadeThroughDescription => 'Das Muster \"Durchblenden\" wird für Übergänge zwischen UI-Elementen verwendet, zwischen denen keine starke Verbindung besteht.';
  ...
  @override
  String get demoFadeScaleDescription => 'Das Muster \"Überblenden\" wird für UI-Elemente verwendet, die innerhalb der Bildschirmgrenzen ein- oder ausgeblendet werden, z. B. ein Dialogfeld, das in der Bildschirmmitte ausgeblendet wird.';
  ...
  @override
  String get demoFadeScaleAlertDialogHeader => 'Dialogfeld einer Benachrichtigung';
  ...
  @override
  String get demoColorsDescription => 'Farben und Farbmuster, die die Farbpalette von Material Design widerspiegeln.';
  ...
  @override
  String get demoTypographyDescription => 'Definitionen für die verschiedenen Typografiestile im Material Design.';
  ...
  @override
  String get demo2dTransformationsDescription => 'Tippe, um Kacheln zu bearbeiten, und nutze Touch-Gesten, um dich in der Szene zu bewegen: zum Schwenken ziehen, zum Zoomen auseinander- und zusammenziehen, und zum Drehen eine entsprechende Bewegung mit zwei Fingern machen. Drück auf die Taste zum Zurücksetzen, um zur anfänglichen Ausrichtung zurückzukehren.';

  @override
  String get demo2dTransformationsResetTooltip => 'Transformationen zurücksetzen';
  ...
  @override
  String get demoBottomSheetSubtitle => 'Persistente und modale Blätter am unteren Rand';

  @override
  String get demoBottomSheetPersistentTitle => 'Persistentes Blatt am unteren Rand';

  @override
  String get demoBottomSheetPersistentDescription => 'Auf einem persistenten Blatt am unteren Rand werden Informationen angezeigt, die den Hauptinhalt der App ergänzen. Ein solches Blatt bleibt immer sichtbar, auch dann, wenn der Nutzer mit anderen Teilen der App interagiert.';

  @override
  String get demoBottomSheetModalTitle => 'Modales Blatt am unteren Rand';

  @override
  String get demoBottomSheetModalDescription => 'Ein modales Blatt am unteren Rand ist eine Alternative zu einem Menü oder einem Dialogfeld und verhindert, dass Nutzer mit dem Rest der App interagieren.';
  ...
  @override
  String get demoListsDescription => 'Eine Zeile in der Liste hat eine feste Höhe und enthält normalerweise Text und ein anführendes bzw. abschließendes Symbol.';
  ...
  @override
  String get demoCircularProgressIndicatorTitle => 'Kreisförmige Fortschrittsanzeige';

  @override
  String get demoCircularProgressIndicatorDescription => 'Eine kreisförmige Material Design-Fortschrittsanzeige, die sich dreht, wenn die App ausgelastet ist.';

  @override
  String get demoLinearProgressIndicatorTitle => 'Lineare Fortschrittsanzeige';

  @override
  String get demoLinearProgressIndicatorDescription => 'Eine lineare Material Design-Fortschrittsanzeige.';
  ...
  @override
  String get demoDatePickerDescription => 'Zeigt ein Dialogfeld mit einem Material Design-Element zur Datumsauswahl an.';

  @override
  String get demoTimePickerTitle => 'Element zur Uhrzeitauswahl';

  @override
  String get demoTimePickerDescription => 'Zeigt ein Dialogfeld mit einem Material Design-Element zur Uhrzeitauswahl an.';

  @override
  String get demoDateRangePickerTitle => 'Zeitraumauswahl';

  @override
  String get demoDateRangePickerDescription => 'Zeigt ein Dialogfeld mit einem Material Design-Element zur Zeitraumauswahl an.';
  ...
  @override
  String get demoTabsDescription => 'Mit Tabs lassen sich Inhalte über Bildschirme, Datensätze und andere Interaktionen hinweg organisieren.';

  @override
  String get demoSnackbarsTitle => 'Snackbars';

  @override
  String get demoSnackbarsSubtitle => 'Snackbars zeigen Meldungen unten auf dem Bildschirm an';

  @override
  String get demoSnackbarsDescription => 'Snackbars informieren Nutzer über einen Vorgang, den eine App durchgeführt hat oder durchführen wird. Sie erscheinen vorübergehend auf dem unteren Teil des Bildschirms. Snackbars sollten Nutzer nicht unterbrechen und werden automatisch wieder ausgeblendet.';
  ...
  @override
  String get demoSelectionControlsSubtitle => 'Kästchen, Optionsfelder und Schieberegler';

  @override
  String get demoSelectionControlsCheckboxTitle => 'Kästchen';

  @override
  String get demoSelectionControlsCheckboxDescription => 'Über Kästchen können Nutzer mehrere Optionen gleichzeitig auswählen. Üblicherweise ist der Wert eines Kästchens entweder \"true\" (ausgewählt) oder \"false\" (nicht ausgewählt) – Kästchen mit drei Auswahlmöglichkeiten können jedoch auch den Wert \"null\" haben.';

  @override
  String get demoSelectionControlsRadioTitle => 'Optionsfeld';

  @override
  String get demoSelectionControlsRadioDescription => 'Über Optionsfelder können Nutzer eine Option auswählen. Optionsfelder sind ideal, wenn nur eine einzige Option ausgewählt werden kann, aber alle verfügbaren Auswahlmöglichkeiten auf einen Blick erkennbar sein sollen.';

  @override
  String get demoSelectionControlsSwitchTitle => 'Schalter';

  @override
  String get demoSelectionControlsSwitchDescription => 'Mit Schiebereglern können Nutzer den Status einzelner Einstellungen ändern. Dabei sollte mit einem passenden Inline-Label deutlich gemacht werden, um welche Einstellung es sich handelt und wie ihr aktueller Status ist.';
  ...
  @override
  String get demoTextFieldSubtitle => 'Einzelne Linie mit Text und Zahlen, die bearbeitet werden können';

  @override
  String get demoTextFieldDescription => 'Über Textfelder können Nutzer Text auf einer Benutzeroberfläche eingeben. Sie sind in der Regel in Formularen und Dialogfeldern zu finden.';
  ...
  @override
  String get demoTextFieldFormErrors => 'Bitte behebe vor dem Senden die rot markierten Probleme.';

  @override
  String get demoTextFieldNameRequired => 'Name ist erforderlich.';

  @override
  String get demoTextFieldOnlyAlphabeticalChars => 'Bitte gib nur Zeichen aus dem Alphabet ein.';

  @override
  String get demoTextFieldEnterUSPhoneNumber => '(###) ###-#### – Gib eine US-amerikanische Telefonnummer ein.';

  @override
  String get demoTextFieldEnterPassword => 'Gib ein Passwort ein.';

  @override
  String get demoTextFieldPasswordsDoNotMatch => 'Die Passwörter stimmen nicht überein';
  ...
  @override
  String get demoTextFieldWhereCanWeReachYou => 'Unter welcher Nummer können wir dich erreichen?';
  ...
  @override
  String get demoTextFieldTellUsAboutYourself => 'Erzähl uns etwas über dich (z. B., welcher Tätigkeit du nachgehst oder welche Hobbys du hast)';

  @override
  String get demoTextFieldKeepItShort => 'Schreib nicht zu viel, das hier ist nur eine Demonstration.';
  ...
  @override
  String get demoTooltipSubtitle => 'Kurze Meldung, die erscheint, wenn ein Element lange gedrückt oder der Mauszeiger daraufbewegt wird';

  @override
  String get demoTooltipDescription => 'Kurzinfos sind Beschriftungen, die die Funktion von Schaltflächen oder anderen Aktionen auf der Benutzeroberfläche beschreiben. Der Informationstext darin wird angezeigt, wenn Nutzer den Mauszeiger auf ein Element bewegen, den Fokus darauf legen oder es lange drücken.';

  @override
  String get demoTooltipInstructions => 'Drücke ein Element lange oder bewege den Mauszeiger darauf, um dir die Kurzinfo anzeigen zu lassen.';
  ...
  @override
  String get dialogLocationDescription => 'Die Standortdienste von Google erleichtern die Standortbestimmung durch Apps. Dabei werden anonyme Standortdaten an Google gesendet, auch wenn gerade keine Apps ausgeführt werden.';
  ...
  @override
  String get cupertinoAlertLocationTitle => 'Maps erlauben, während der Nutzung der App auf deinen Standort zuzugreifen?';

  @override
  String get cupertinoAlertLocationDescription => 'Dein aktueller Standort wird auf der Karte angezeigt und für Wegbeschreibungen, Suchergebnisse für Dinge in der Nähe und zur Einschätzung von Fahrtzeiten verwendet.';
  ...
  @override
  String get cupertinoAlertDessertDescription => 'Bitte wähle in der Liste unten dein Lieblingsdessert aus. Mithilfe deiner Auswahl wird die Liste der Restaurantvorschläge in deiner Nähe personalisiert.';
  ...
  @override
  String get craneFly0SemanticLabel => 'Chalet in einer Schneelandschaft mit immergrünen Bäumen';

  @override
  String get craneFly1SemanticLabel => 'Zelt auf einem Feld';

  @override
  String get craneFly2SemanticLabel => 'Gebetsfahnen vor einem schneebedeckten Berg';
  ...
  @override
  String get craneFly5SemanticLabel => 'Hotel an einem See mit Bergen im Hintergrund';
  ...
  @override
  String get craneFly9SemanticLabel => 'Mann, der sich gegen einen blauen Oldtimer lehnt';

  @override
  String get craneFly10SemanticLabel => 'Minarette der al-Azhar-Moschee bei Sonnenuntergang';

  @override
  String get craneFly11SemanticLabel => 'Aus Ziegelsteinen gemauerter Leuchtturm am Meer';
  ...
  @override
  String get craneSleep1SemanticLabel => 'Chalet in einer Schneelandschaft mit immergrünen Bäumen';

  @override
  String get craneSleep2SemanticLabel => 'Zitadelle von Machu Picchu';

  @override
  String get craneSleep3SemanticLabel => 'Mann, der sich gegen einen blauen Oldtimer lehnt';

  @override
  String get craneSleep4SemanticLabel => 'Hotel an einem See mit Bergen im Hintergrund';
  ...
  @override
  String get craneSleep8SemanticLabel => 'Maya-Ruinen auf einer Klippe oberhalb eines Strandes';

  @override
  String get craneSleep9SemanticLabel => 'Aus Ziegelsteinen gemauerter Leuchtturm am Meer';

  @override
  String get craneSleep10SemanticLabel => 'Minarette der al-Azhar-Moschee bei Sonnenuntergang';
  ...
  @override
  String get craneEat5SemanticLabel => 'Sitzbereich eines künstlerisch eingerichteten Restaurants';
  ...
  @override
  String get fortnightlyTrendingHealthcareRevolution => 'Revolution_im_Gesundheitswesen';
  ...
  @override
  String get fortnightlyHeadlineHealthcare => 'Die stille, aber wirkungsvolle Revolution im Gesundheitswesen';

  @override
  String get fortnightlyHeadlineWar => 'Amerikanische Trennungsschicksale während des Krieges';

  @override
  String get fortnightlyHeadlineGasoline => 'Die Zukunft des Benzins';

  @override
  String get fortnightlyHeadlineArmy => 'Die Grüne Armee und ihre Reformierung von innen';

  @override
  String get fortnightlyHeadlineStocks => 'Wenn Aktienkurse stagnieren, richtet sich der Blick auf die Währung';

  @override
  String get fortnightlyHeadlineFabrics => 'Designer nutzen Technologie zur Entwicklung futuristischer Stoffe';

  @override
  String get fortnightlyHeadlineFeminists => 'Feministinnen bekämpfen Vetternwirtschaft';

  @override
  String get fortnightlyHeadlineBees => 'Bienen auf dem Land in Gefahr';

  @override
  String get replyInboxLabel => 'Posteingang';

  @override
  String get replyStarredLabel => 'Markiert';

  @override
  String get replySentLabel => 'Gesendet';

  @override
  String get replyTrashLabel => 'Papierkorb';

  @override
  String get replySpamLabel => 'Spam';

  @override
  String get replyDraftsLabel => 'Entwürfe';

  @override
  String get demoTwoPaneFoldableLabel => 'Faltbares Smartphone/Tablet';

  @override
  String get demoTwoPaneFoldableDescription => 'So verhält sich TwoPane auf faltbaren Geräten.';

  @override
  String get demoTwoPaneSmallScreenLabel => 'Kleiner Bildschirm';

  @override
  String get demoTwoPaneSmallScreenDescription => 'So verhält sich TwoPane auf Geräten mit kleinem Bildschirm.';

  @override
  String get demoTwoPaneTabletLabel => 'Tablet/Desktop';

  @override
  String get demoTwoPaneTabletDescription => 'So verhält sich TwoPane auf Geräten mit größerem Bildschirm, zum Beispiel Tablets oder Computern.';

  @override
  String get demoTwoPaneTitle => 'TwoPane';

  @override
  String get demoTwoPaneSubtitle => 'Responsive Layouts auf faltbaren, großen und kleinen Bildschirmen';

  @override
  String get splashSelectDemo => 'Demo auswählen';
  ...
  @override
  String get demoTwoPaneSelectItem => 'Element auswählen';
  ...
  String demoTwoPaneItemDetails(Object value) {
    return 'Details zum Element $value';
  }
}
