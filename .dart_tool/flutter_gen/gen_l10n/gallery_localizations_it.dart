...
class GalleryLocalizationsIt extends GalleryLocalizations {
  ...
  @override
  String get bannerDemoText => 'La tua password è stata aggiornata sull\'altro dispositivo. Accedi nuovamente.';
  ...
  @override
  String get cardsDemoTravelDestinationTitle1 => 'Le 10 città principali da visitare nel Tamil Nadu';
  ...
  @override
  String get cardsDemoTravelDestinationTitle2 => 'Artigiani dell\'India meridionale';
  ...
  @override
  String get fortnightlyDescription => 'Un\'app di notizie incentrata sui contenuti';

  @override
  String get rallyDescription => 'Un\'app per le finanze personali';

  @override
  String get replyDescription => 'Un\'app email efficiente e mirata';
  ...
  @override
  String get rallyAccountDetailDataAnnualPercentageYield => 'Rendimento annuale percentuale';

  @override
  String get rallyAccountDetailDataInterestRate => 'Tasso di interesse';

  @override
  String get rallyAccountDetailDataInterestYtd => 'Interesse dall\'inizio dell\'anno';

  @override
  String get rallyAccountDetailDataInterestPaidLastYear => 'Interesse pagato l\'anno scorso';
  ...
  String rallyAlertsMessageUnassignedTransactions(num count) {
    return intl.Intl.pluralLogic(
      count,
      locale: localeName,
      one: 'Aumenta la tua potenziale detrazione fiscale. Assegna categorie a 1 transazione non assegnata.',
      other: 'Aumenta la tua potenziale detrazione fiscale. Assegna categorie a $count transazioni non assegnate.',
    );
  }
  ...
  @override
  String get demoOptionsFeatureDescription => 'Tocca qui per visualizzare le opzioni disponibili per questa demo.';
  ...
  @override
  String get demoAppBarTitle => 'Barra dell\'app';

  @override
  String get demoAppBarSubtitle => 'Mostra azioni e informazioni relative alla schermata corrente';

  @override
  String get demoAppBarDescription => 'La barra dell\'app fornisce contenuti e azioni relativi alla schermata corrente. Viene utilizzata per branding, titoli delle schermate, navigazione e azioni';

  @override
  String get demoBottomAppBarTitle => 'Barra dell\'app in basso';

  @override
  String get demoBottomAppBarSubtitle => 'Consente di visualizzare la navigazione e le azioni in basso';

  @override
  String get demoBottomAppBarDescription => 'Le barre dell\'app in basso consentono di accedere a un riquadro di navigazione a scomparsa inferiore e a massimo quattro azioni, incluso il pulsante di azione mobile.';
  ...
  @override
  String get demoBannerDescription => 'Un banner mostra un messaggio importante e conciso e offre agli utenti azioni da compiere (o per ignorare il banner). È necessaria un\'azione dell\'utente per ignorare il banner.';

  @override
  String get demoBottomNavigationTitle => 'Navigazione in basso';

  @override
  String get demoBottomNavigationSubtitle => 'Navigazione inferiore con visualizzazioni a dissolvenza incrociata';
  ...
  @override
  String get demoBottomNavigationDescription => 'Le barre di navigazione in basso mostrano da tre a cinque destinazioni nella parte inferiore dello schermo. Ogni destinazione è rappresentata da un\'icona e da un\'etichetta di testo facoltativa. Quando viene toccata un\'icona di navigazione in basso, l\'utente viene indirizzato alla destinazione di navigazione principale associata all\'icona.';

  @override
  String get demoButtonTitle => 'Pulsanti';

  @override
  String get demoButtonSubtitle => 'Di testo, sollevati, con contorni e molto altro';

  @override
  String get demoTextButtonTitle => 'Pulsante di testo';

  @override
  String get demoTextButtonDescription => 'Un pulsante di testo mostra una macchia di inchiostro quando viene premuto, ma non si solleva. Usa pulsanti di testo nelle barre degli strumenti, nelle finestre di dialogo e in linea con la spaziatura interna.';

  @override
  String get demoElevatedButtonTitle => 'Pulsante sollevato';

  @override
  String get demoElevatedButtonDescription => 'I pulsanti sollevati aggiungono dimensione a layout prevalentemente piatti. Mettono in risalto le funzioni in spazi ampi o densi di contenuti.';

  @override
  String get demoOutlinedButtonTitle => 'Pulsante con contorni';

  @override
  String get demoOutlinedButtonDescription => 'I pulsanti con contorni diventano opachi e sollevati quando vengono premuti. Sono spesso associati a pulsanti in rilievo per indicare azioni secondarie alternative.';

  @override
  String get demoToggleButtonTitle => 'Pulsanti di attivazione/disattivazione';

  @override
  String get demoToggleButtonDescription => 'I pulsanti di attivazione/disattivazione possono essere usati per raggruppare le opzioni correlate. Per mettere in risalto un gruppo di pulsanti di attivazione/disattivazione correlati, il gruppo deve condividere un container comune.';

  @override
  String get demoFloatingButtonTitle => 'Pulsante di azione sovrapposto (FAB, Floating Action Button)';

  @override
  String get demoFloatingButtonDescription => 'Un pulsante di azione sovrapposto è un\'icona circolare che viene mostrata sui contenuti per promuovere un\'azione principale dell\'applicazione.';
  ...
  @override
  String get demoCardDescription => 'Una scheda è un foglio di Material usato per rappresentare alcune informazioni correlate, ad esempio un album, una posizione geografica, un pasto, dettagli di contatto e così via.';

  @override
  String get demoChipSubtitle => 'Elementi compatti che rappresentano un valore, un attributo o un\'azione';

  @override
  String get demoActionChipTitle => 'Chip di azione';

  @override
  String get demoActionChipDescription => 'I chip di azione sono un insieme di opzioni che attivano un\'azione relativa ai contenuti principali. I chip di azione dovrebbero essere visualizzati in modo dinamico e in base al contesto in un\'interfaccia utente.';

  @override
  String get demoChoiceChipTitle => 'Chip di scelta';

  @override
  String get demoChoiceChipDescription => 'I chip di scelta rappresentano una singola scelta di un insieme di scelte. I chip di scelta contengono categorie o testi descrittivi correlati.';

  @override
  String get demoFilterChipTitle => 'Chip di filtro';

  @override
  String get demoFilterChipDescription => 'I chip di filtro consentono di filtrare i contenuti in base a tag o parole descrittive.';

  @override
  String get demoInputChipTitle => 'Chip di input';

  @override
  String get demoInputChipDescription => 'I chip di input rappresentano un\'informazione complessa, ad esempio un\'entità (persona, luogo o cosa) o un testo discorsivo, in un formato compatto.';
  ...
  @override
  String get demoDataTableDescription => 'Le tabelle di dati mostrano le informazioni in un formato a griglia di righe e colonne. Le informazioni sono organizzate in modo da facilitare l\'analisi e consentire agli utenti di cercare sequenze dati.';
  ...
  @override
  String get demoAlertDialogDescription => 'Una finestra di dialogo di avviso segnala all\'utente situazioni che richiedono l\'accettazione. Una finestra di dialogo include un titolo facoltativo e un elenco di azioni tra cui scegliere.';
  ...
  @override
  String get demoSimpleDialogDescription => 'Una finestra di dialogo semplice offre all\'utente una scelta tra molte opzioni. Una finestra di dialogo semplice include un titolo facoltativo che viene mostrato sopra le scelte.';

  @override
  String get demoDividerTitle => 'Divisore';

  @override
  String get demoDividerSubtitle => 'Un divisore è una linea sottile che raggruppa contenuti in elenchi e layout.';

  @override
  String get demoDividerDescription => 'I divisori possono essere utilizzati in elenchi, riquadri a scomparsa e altrove per separare i contenuti.';

  @override
  String get demoVerticalDividerTitle => 'Divisore verticale';
  ...
  @override
  String get demoGridListsDescription => 'Gli elenchi in formato griglia sono più adatti per presentare dati omogenei, generalmente le immagini. Ogni elemento in un elenco in formato griglia è chiamato riquadro.';
  ...
  @override
  String get demoSlidersSubtitle => 'Widget per la selezione di un valore tramite scorrimento';

  @override
  String get demoSlidersDescription => 'I dispositivi di scorrimento rappresentano un intervallo di valori lungo una barra, da cui gli utenti possono selezionare un singolo valore. Sono la soluzione ideale per regolare impostazioni quali volume e luminosità oppure per applicare filtri delle immagini.';

  @override
  String get demoRangeSlidersTitle => 'Dispositivi di scorrimento intervalli';

  @override
  String get demoRangeSlidersDescription => 'I dispositivi di scorrimento rappresentano un intervallo di valori lungo una barra, che può avere icone su entrambe le estremità per indicare un intervallo di valori. Sono la soluzione ideale per regolare impostazioni quali volume e luminosità oppure per applicare filtri delle immagini.';

  @override
  String get demoCustomSlidersTitle => 'Dispositivi di scorrimento personalizzati';

  @override
  String get demoCustomSlidersDescription => 'I dispositivi di scorrimento rappresentano un intervallo di valori lungo una barra, da cui gli utenti possono selezionare un singolo valore o un intervallo di valori. È possibile personalizzare e applicare un tema ai dispositivi di scorrimento.';

  @override
  String get demoSlidersContinuousWithEditableNumericalValue => 'Continuo con valore numerico modificabile';

  @override
  String get demoSlidersDiscrete => 'Discreto';

  @override
  String get demoSlidersDiscreteSliderWithCustomTheme => 'Dispositivo di scorrimento discreto con tema personalizzato';

  @override
  String get demoSlidersContinuousRangeSliderWithCustomTheme => 'Dispositivo di scorrimento intervallo continuo con tema personalizzato';

  @override
  String get demoSlidersContinuous => 'Continuo';

  @override
  String get demoSlidersEditableNumericalValue => 'Valore numerico modificabile';
  ...
  @override
  String get demoMenuDescription => 'Un menu visualizza un elenco di opzioni su una superficie temporanea, che vengono mostrate quando gli utenti interagiscono con un pulsante, un\'azione o un altro controllo.';
  ...
  @override
  String get demoMenuAnItemWithAContextMenuButton => 'Un elemento con un menu contestuale';
  ...
  @override
  String get demoMenuAnItemWithASectionedMenu => 'Un elemento con un menu a sezioni';
  ...
  @override
  String get demoNavigationDrawerTitle => 'Riquadro di navigazione a scomparsa';

  @override
  String get demoNavigationDrawerSubtitle => 'Visualizzare un riquadro a scomparsa all\'interno della barra delle applicazioni';

  @override
  String get demoNavigationDrawerDescription => 'Un riquadro di Material Design che scorre in orizzontale dal bordo dello schermo per mostrare link di navigazione in un\'applicazione.';

  @override
  String get demoNavigationDrawerUserName => 'Nome utente';

  @override
  String get demoNavigationDrawerUserEmail => 'user.name@example.com';

  @override
  String get demoNavigationDrawerToPageOne => 'Elemento uno';

  @override
  String get demoNavigationDrawerToPageTwo => 'Elemento due';

  @override
  String get demoNavigationDrawerText => 'Per visualizzare il riquadro a scomparsa, scorri dal bordo o tocca l\'icona in alto a sinistra';

  @override
  String get demoNavigationRailTitle => 'Barra di spostamento';

  @override
  String get demoNavigationRailSubtitle => 'Visualizzare una barra di spostamento all\'interno di un\'app';

  @override
  String get demoNavigationRailDescription => 'Un widget material che dovrebbe essere visualizzato nella parte a sinistra o destra di un\'app per spostarsi tra un numero limitato di visualizzazioni, generalmente da tre a cinque.';

  @override
  String get demoNavigationRailFirst => 'Prima etichetta';

  @override
  String get demoNavigationRailSecond => 'Seconda etichetta';

  @override
  String get demoNavigationRailThird => 'Terza etichetta';

  @override
  String get demoMenuAnItemWithASimpleMenu => 'Un elemento con un menu semplice';

  @override
  String get demoMenuAnItemWithAChecklistMenu => 'Un elemento con un menu con elenco di controllo';

  @override
  String get demoFullscreenDialogTitle => 'Schermo intero';

  @override
  String get demoFullscreenDialogDescription => 'La proprietà fullscreenDialog specifica se la pagina che sta per essere visualizzata è una finestra di dialogo modale a schermo intero';

  @override
  String get demoCupertinoActivityIndicatorTitle => 'Indicatore di attività';

  @override
  String get demoCupertinoActivityIndicatorSubtitle => 'Indicatori di attività in stile iOS';

  @override
  String get demoCupertinoActivityIndicatorDescription => 'Un indicatore di attività in stile iOS che ruota in senso orario.';
  ...
  @override
  String get demoCupertinoButtonsDescription => 'Un pulsante in stile iOS. È costituito da testo e/o da un\'icona con effetto di dissolvenza quando viene mostrata e quando scompare se viene toccata. A discrezione, può avere uno sfondo.';

  @override
  String get demoCupertinoContextMenuTitle => 'Menu contestuale';

  @override
  String get demoCupertinoContextMenuSubtitle => 'Menu contestuale in stile iOS';

  @override
  String get demoCupertinoContextMenuDescription => 'Un menu contestuale a schermo intero in stile iOS che viene visualizzato quando si esercita una pressione prolungata su un elemento.';

  @override
  String get demoCupertinoContextMenuActionOne => 'Azione uno';

  @override
  String get demoCupertinoContextMenuActionTwo => 'Azione due';

  @override
  String get demoCupertinoContextMenuActionText => 'Tocca e tieni premuto il logo di Flutter per vedere il menu contestuale.';
  ...
  @override
  String get demoCupertinoAlertDescription => 'Una finestra di dialogo di avviso segnala all\'utente situazioni che richiedono l\'accettazione. Una finestra di dialogo di avviso include un titolo facoltativo e un elenco di azioni tra cui scegliere. Il titolo viene mostrato sopra i contenuti e le azioni sono mostrate sotto i contenuti.';
  ...
  @override
  String get demoCupertinoActionSheetDescription => 'Un foglio azioni è un avviso con uno stile specifico che presenta all\'utente un insieme di due o più scelte relative al contesto corrente. Un foglio azioni può avere un titolo, un messaggio aggiuntivo e un elenco di azioni.';

  @override
  String get demoCupertinoNavigationBarTitle => 'Barra di navigazione';

  @override
  String get demoCupertinoNavigationBarSubtitle => 'Barra di navigazione in stile iOS';

  @override
  String get demoCupertinoNavigationBarDescription => 'Una barra di navigazione in stile iOS. La barra di navigazione è una barra degli strumenti che consiste almeno nel titolo di una pagina, al centro della barra degli strumenti.';

  @override
  String get demoCupertinoPickerTitle => 'Selettori';

  @override
  String get demoCupertinoPickerSubtitle => 'Selettori di data e ora in stile iOS';

  @override
  String get demoCupertinoPickerDescription => 'Un widget selettore in stile iOS che può essere usato per selezionare date, orari o entrambi.';
  ...
  @override
  String get demoCupertinoPullToRefreshSubtitle => 'Controllo Trascina per aggiornare in stile iOS';

  @override
  String get demoCupertinoPullToRefreshDescription => 'Un widget che implementa il controllo dei contenuti Trascina per aggiornare in stile iOS.';

  @override
  String get demoCupertinoSegmentedControlTitle => 'Controllo segmentato';

  @override
  String get demoCupertinoSegmentedControlSubtitle => 'Controllo segmentato in stile iOS';

  @override
  String get demoCupertinoSegmentedControlDescription => 'Consente di effettuare una selezione tra una serie di opzioni che si escludono a vicenda. Se viene selezionata un\'opzione nel controllo segmentato, le altre opzioni nello stesso controllo non sono più selezionate.';

  @override
  String get demoCupertinoSliderTitle => 'Dispositivo di scorrimento';

  @override
  String get demoCupertinoSliderSubtitle => 'Dispositivo di scorrimento in stile iOS';

  @override
  String get demoCupertinoSliderDescription => 'Un dispositivo di scorrimento può essere utilizzato per selezionare valori da un insieme continuo o discreto.';
  ...
  @override
  String get demoCupertinoSwitchDescription => 'Un interruttore viene utilizzato per attivare o disattivare lo stato di una singola impostazione.';
  ...
  @override
  String get demoCupertinoTabBarDescription => 'Una barra delle schede di navigazione in stile iOS. Mostra più schede, di cui una sola (per impostazione predefinita, la prima) è attiva.';
  ...
  @override
  String get demoCupertinoTextFieldDescription => 'Un campo di testo consente all\'utente di inserire testo, con una tastiera hardware o una tastiera sullo schermo.';
  ...
  @override
  String get demoContainerTransformDemoInstructions => 'Schede, elenchi e FAB';

  @override
  String get demoSharedXAxisDemoInstructions => 'Pulsanti Avanti e Indietro';

  @override
  String get demoSharedYAxisDemoInstructions => 'Ordina per \"Riproduzioni recenti\"';

  @override
  String get demoSharedZAxisDemoInstructions => 'Pulsante dell\'icona Impostazioni';

  @override
  String get demoFadeThroughDemoInstructions => 'Navigazione in basso';

  @override
  String get demoFadeScaleDemoInstructions => 'Modale e FAB';

  @override
  String get demoContainerTransformTitle => 'Trasformazione del contenitore';

  @override
  String get demoContainerTransformDescription => 'Il pattern di trasformazione del contenitore è progettato per le transizioni tra elementi UI che includono un contenitore. Questo pattern crea un collegamento visibile tra due elementi UI';

  @override
  String get demoContainerTransformModalBottomSheetTitle => 'Modalità Dissolvenza';
  ...
  @override
  String get demoSharedAxisDescription => 'Il pattern di assi condivisi per le transizioni tra gli elementi UI che hanno una relazione di spazio o di navigazione. Questo pattern utilizza una trasformazione condivisa sugli assi x, y o z per rafforzare la relazione tra gli elementi.';
  ...
  @override
  String get demoSharedXAxisCoursePageSubtitle => 'Le categorie raggruppate vengono visualizzate come gruppi nel tuo feed. Potrai sempre modificare questa scelta in un secondo momento.';
  ...
  @override
  String get demoSharedXAxisIndividualCourseSubtitle => 'Mostrato singolarmente';
  ...
  @override
  String get demoSharedXAxisSignInTextFieldLabel => 'Indirizzo email o numero di telefono';

  @override
  String get demoSharedXAxisForgotEmailButtonText => 'NON RICORDI L\'INDIRIZZO EMAIL?';
  ...
  @override
  String get demoSharedZAxisShrimpPlateRecipeDescription => 'Ricetta a base di gamberi';

  @override
  String get demoSharedZAxisCrabPlateRecipeTitle => 'Granchio';

  @override
  String get demoSharedZAxisCrabPlateRecipeDescription => 'Ricetta a base di granchio';

  @override
  String get demoSharedZAxisBeefSandwichRecipeTitle => 'Panino con la carne';

  @override
  String get demoSharedZAxisBeefSandwichRecipeDescription => 'Ricetta panino con la carne';
  ...
  @override
  String get demoFadeThroughDescription => 'Il pattern di dissolvenza tramite viene utilizzato per le transizioni tra elementi UI che non hanno una forte correlazione.';
  ...
  @override
  String get demoFadeScaleDescription => 'Il pattern di dissolvenza viene utilizzato per gli elementi UI che entrano o escono dalle estremità della schermata, ad esempio una finestra di dialogo che si dissolve nel centro dello schermo.';
  ...
  @override
  String get demoColorsDescription => 'Costanti di colore e di campioni di colore che rappresentano la tavolozza dei colori di material design.';
  ...
  @override
  String get demoTypographyDescription => 'Definizioni dei vari stili tipografici trovati in material design.';
  ...
  @override
  String get demo2dTransformationsDescription => 'Tocca per modificare i riquadri e usa i gesti per spostarti nella scena. Trascina per la panoramica, pizzica per lo zoom e ruota con due dita. Premi il pulsante di ripristino per tornare all\'orientamento iniziale.';
  ...
  @override
  String get demoBottomSheetPersistentDescription => 'Un foglio inferiore permanente mostra informazioni che integrano i contenuti principali dell\'app. Un foglio inferiore permanente rimane visibile anche quando l\'utente interagisce con altre parti dell\'app.';

  @override
  String get demoBottomSheetModalTitle => 'Foglio inferiore modale';

  @override
  String get demoBottomSheetModalDescription => 'Un foglio inferiore modale è un\'alternativa a un menu o a una finestra di dialogo e impedisce all\'utente di interagire con il resto dell\'app.';
  ...
  @override
  String get demoListsDescription => 'Una singola riga con altezza fissa che generalmente contiene del testo e un\'icona iniziale o finale.';
  ...
  @override
  String get demoProgressIndicatorSubtitle => 'Lineari, circolari e indeterminati';

  @override
  String get demoCircularProgressIndicatorTitle => 'Indicatore di avanzamento circolare';

  @override
  String get demoCircularProgressIndicatorDescription => 'Un indicatore di avanzamento circolare Material Design che ruota per indicare che l\'applicazione è occupata.';

  @override
  String get demoLinearProgressIndicatorTitle => 'Indicatore di avanzamento lineare';

  @override
  String get demoLinearProgressIndicatorDescription => 'Un indicatore di avanzamento lineare Material Design, anche noto come barra di avanzamento.';
  ...
  @override
  String get demoDatePickerDescription => 'Viene mostrata una finestra di dialogo contenente un selettore della data di Material Design.';

  @override
  String get demoTimePickerTitle => 'Selettore ora';

  @override
  String get demoTimePickerDescription => 'Viene mostrata una finestra di dialogo contenente un selettore dell\'ora di Material Design.';

  @override
  String get demoDateRangePickerTitle => 'Selettore intervallo di date';

  @override
  String get demoDateRangePickerDescription => 'Viene mostrata una finestra di dialogo contenente un selettore di intervallo di date di Material Design.';
  ...
  @override
  String get demoTabsSubtitle => 'Schede con visualizzazioni scorrevoli in modo indipendente';

  @override
  String get demoTabsDescription => 'Le schede consentono di organizzare i contenuti in diversi set di dati, schermate e altre interazioni.';

  @override
  String get demoSnackbarsTitle => 'Snackbar';

  @override
  String get demoSnackbarsSubtitle => 'Gli snackbar mostrano i messaggi in fondo allo schermo';

  @override
  String get demoSnackbarsDescription => 'Gli snackbar informano gli utenti di un processo che un\'app ha eseguito o sta per eseguire. Vengono visualizzati temporaneamente in fondo allo schermo. Non dovrebbero interrompere l\'esperienza utente e non richiedono interazioni per essere rimossi dallo schermo.';
  ...
  @override
  String get demoSelectionControlsSubtitle => 'Caselle di controllo, pulsanti di opzione e opzioni';

  @override
  String get demoSelectionControlsCheckboxTitle => 'Casella di controllo';

  @override
  String get demoSelectionControlsCheckboxDescription => 'Le caselle di controllo consentono all\'utente di selezionare diverse opzioni da un gruppo di opzioni. Il valore di una casella di controllo standard è true o false, mentre il valore di una casella di controllo a tre stati può essere anche null.';

  @override
  String get demoSelectionControlsRadioTitle => 'Pulsante di opzione';

  @override
  String get demoSelectionControlsRadioDescription => 'I pulsanti di opzione consentono all\'utente di selezionare un\'opzione da un gruppo di opzioni. Usa i pulsanti di opzione per la selezione esclusiva se ritieni che l\'utente debba vedere tutte le opzioni disponibili affiancate.';

  @override
  String get demoSelectionControlsSwitchTitle => 'Opzione';

  @override
  String get demoSelectionControlsSwitchDescription => 'Le opzioni on/off consentono di attivare/disattivare lo stato di una singola opzione di impostazioni. La funzione e lo stato corrente dell\'opzione devono essere chiariti dall\'etichetta incorporata corrispondente.';
  ...
  @override
  String get demoTextFieldSubtitle => 'Singola riga di testo modificabile e numeri';

  @override
  String get demoTextFieldDescription => 'I campi di testo consentono agli utenti di inserire testo in un\'interfaccia utente e sono generalmente presenti in moduli e finestre di dialogo.';
  ...
  @override
  String get demoTextFieldFormErrors => 'Correggi gli errori in rosso prima di inviare il modulo.';

  @override
  String get demoTextFieldNameRequired => 'Il nome è obbligatorio.';

  @override
  String get demoTextFieldOnlyAlphabeticalChars => 'Inserisci soltanto caratteri alfabetici.';

  @override
  String get demoTextFieldEnterUSPhoneNumber => '(###) ###-####. Inserisci un numero di telefono degli Stati Uniti.';

  @override
  String get demoTextFieldEnterPassword => 'Inserisci una password.';

  @override
  String get demoTextFieldPasswordsDoNotMatch => 'Le password non corrispondono';
  ...
  @override
  String get demoTextFieldTellUsAboutYourself => 'Parlaci di te (ad esempio, scrivi cosa fai o quali sono i tuoi hobby)';

  @override
  String get demoTextFieldKeepItShort => 'Usa un testo breve perché è soltanto dimostrativo.';
  ...
  @override
  String get demoTextFieldRequiredField => 'L\'asterisco (*) indica un campo obbligatorio';

  @override
  String get demoTooltipTitle => 'Descrizioni comandi';

  @override
  String get demoTooltipSubtitle => 'Breve messaggio visualizzato in caso di pressione prolungata o di posizionamento del puntatore del mouse sopra un elemento';

  @override
  String get demoTooltipDescription => 'Le descrizioni comandi forniscono etichette di testo che aiutano a spiegare la funzione di un pulsante o di un\'altra azione dell\'interfaccia utente. Le descrizioni comandi mostrano testo informativo quando gli utenti posizionano il puntatore sopra un elemento, impostano lo stato attivo su un elemento o premono a lungo un elemento.';

  @override
  String get demoTooltipInstructions => 'Premi a lungo un elemento o posiziona sopra il puntatore per visualizzare la descrizione comando.';
  ...
  @override
  String get dialogLocationTitle => 'Utilizzare il servizio di geolocalizzazione di Google?';

  @override
  String get dialogLocationDescription => 'Consenti a Google di aiutare le app a individuare la posizione. Questa operazione comporta l\'invio a Google di dati anonimi sulla posizione, anche quando non ci sono app in esecuzione.';
  ...
  @override
  String get dialogFullscreenDescription => 'Finestra di dialogo demo a schermo intero';
  ...
  @override
  String get cupertinoAlertLocationTitle => 'Consentire a \"Maps\" di accedere alla tua posizione mentre usi l\'app?';

  @override
  String get cupertinoAlertLocationDescription => 'La tua posizione corrente verrà mostrata sulla mappa e usata per le indicazioni stradali, i risultati di ricerca nelle vicinanze e i tempi di percorrenza stimati.';
  ...
  @override
  String get cupertinoAlertFavoriteDessert => 'Seleziona il dolce che preferisci';

  @override
  String get cupertinoAlertDessertDescription => 'Seleziona il tuo dolce preferito nell\'elenco indicato di seguito. La tua selezione verrà usata per personalizzare l\'elenco di locali gastronomici suggeriti nella tua zona.';
  ...
  @override
  String get shrineProductCeriseScallopTee => 'Maglietta scallop tee color ciliegia';
  ...
  @override
  String get craneFly0SemanticLabel => 'Chalet in un paesaggio innevato con alberi sempreverdi';

  @override
  String get craneFly1SemanticLabel => 'Tenda in un campo';

  @override
  String get craneFly2SemanticLabel => 'Bandiere di preghiera di fronte a una montagna innevata';
  ...
  @override
  String get craneFly6SemanticLabel => 'Veduta aerea del Palacio de Bellas Artes';
  ...
  @override
  String get craneFly10SemanticLabel => 'Torri della moschea di Al-Azhar al tramonto';
  ...
  @override
  String get craneSleep1SemanticLabel => 'Chalet in un paesaggio innevato con alberi sempreverdi';

  @override
  String get craneSleep2SemanticLabel => 'Cittadella di Machu Picchu';

  @override
  String get craneSleep3SemanticLabel => 'Uomo appoggiato a un\'auto blu antica';

  @override
  String get craneSleep4SemanticLabel => 'Hotel sul lago di fronte alle montagne';
  ...
  @override
  String get craneSleep7SemanticLabel => 'Appartamenti colorati a piazza Ribeira';

  @override
  String get craneSleep8SemanticLabel => 'Rovine maya su una scogliera sopra una spiaggia';

  @override
  String get craneSleep9SemanticLabel => 'Faro di mattoni sul mare';

  @override
  String get craneSleep10SemanticLabel => 'Torri della moschea di Al-Azhar al tramonto';
  ...
  @override
  String get craneEat1SemanticLabel => 'Locale vuoto con sgabelli in stile diner';
  ...
  @override
  String get craneEat10SemanticLabel => 'Donna con un enorme pastrami sandwich in mano';
  ...
  @override
  String get fortnightlyHeadlineHealthcare => 'La pacata ma potente rivoluzione sanitaria';

  @override
  String get fortnightlyHeadlineWar => 'Vite di americani divise durante la guerra';
  ...
  @override
  String get fortnightlyHeadlineStocks => 'Con il ristagno delle azioni, tanti guardano alla valuta';

  @override
  String get fortnightlyHeadlineFabrics => 'I designer usano la tecnologia per realizzare tessuti futuristici';

  @override
  String get fortnightlyHeadlineFeminists => 'Punto di vista delle femministe sulla partigianeria';

  @override
  String get fortnightlyHeadlineBees => 'Le api scarseggiano';

  @override
  String get replyInboxLabel => 'Posta in arrivo';

  @override
  String get replyStarredLabel => 'Speciali';

  @override
  String get replySentLabel => 'Inviati';

  @override
  String get replyTrashLabel => 'Cestino';

  @override
  String get replySpamLabel => 'Spam';

  @override
  String get replyDraftsLabel => 'Bozze';

  @override
  String get demoTwoPaneFoldableLabel => 'Pieghevoli';

  @override
  String get demoTwoPaneFoldableDescription => 'TwoPane si comporta in questo modo su un dispositivo pieghevole.';

  @override
  String get demoTwoPaneSmallScreenLabel => 'Schermo piccolo';

  @override
  String get demoTwoPaneSmallScreenDescription => 'TwoPane si comporta in questo modo su un dispositivo con uno schermo piccolo.';

  @override
  String get demoTwoPaneTabletLabel => 'Tablet/Desktop';

  @override
  String get demoTwoPaneTabletDescription => 'TwoPane si comporta in questo modo su un dispositivo con uno schermo più grande, come un tablet o un computer.';

  @override
  String get demoTwoPaneTitle => 'TwoPane';

  @override
  String get demoTwoPaneSubtitle => 'Layout adattabili su dispositivi con schermi pieghevoli, grandi e piccoli';

  @override
  String get splashSelectDemo => 'Seleziona una demo';

  @override
  String get demoTwoPaneList => 'Elenco';

  @override
  String get demoTwoPaneDetails => 'Dettagli';

  @override
  String get demoTwoPaneSelectItem => 'Seleziona un elemento';
