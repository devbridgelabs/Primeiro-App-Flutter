...
class GalleryLocalizationsSk extends GalleryLocalizations {
  ...
  @override
  String get bannerDemoText => 'Vaše heslo bolo aktualizované v druhom zariadení. Prihláste sa znova.';
  ...
  @override
  String get cardsDemoTravelDestinationTitle1 => '10 naj miest v štáte Tamil Nadu, ktoré by ste mali navštíviť';
  ...
  @override
  String get fortnightlyDescription => 'Spravodajská aplikácia zameraná na obsah';

  @override
  String get rallyDescription => 'Osobná finančná aplikácia';

  @override
  String get replyDescription => 'Efektívna vyhradená e‑mailová aplikácia';
  ...
  @override
  String get rallyAccountDetailDataAnnualPercentageYield => 'Ročný percentuálny výnos';

  @override
  String get rallyAccountDetailDataInterestRate => 'Úroková sadzba';

  @override
  String get rallyAccountDetailDataInterestYtd => 'Úrok od začiatku roka dodnes';

  @override
  String get rallyAccountDetailDataInterestPaidLastYear => 'Úroky zaplatené minulý rok';
  ...
  String rallyAlertsMessageUnassignedTransactions(num count) {
    return intl.Intl.pluralLogic(
      count,
      locale: localeName,
      one: 'Zvýšte svoj potenciálny odpočet dane. Prideľte kategórie 1 nepridelenej transakcii.',
      few: 'Zvýšte svoj potenciálny odpočet dane. Prideľte kategórie $count neprideleným transakciám.',
      many: 'Zvýšte svoj potenciálny odpočet dane. Assign categories to $count unassigned transactions.',
  ...
  @override
  String get demoCodeViewerCopiedToClipboardMessage => 'Skopírované do schránky.';
  ...
  @override
  String get demoOptionsFeatureDescription => 'Klepnutím sem zobrazíte dostupné možnosti pre túto ukážku.';
  ...
  @override
  String get settingsTextDirectionLocaleBased => 'Na základe miestneho nastavenia';
  ...
  @override
  String get demoAppBarTitle => 'Panel aplikácie';

  @override
  String get demoAppBarSubtitle => 'Zobrazuje informácie a akcie súvisiace s aktuálnou obrazovkou';

  @override
  String get demoAppBarDescription => 'Panel aplikácie zobrazuje kontext a akcie súvisiace s aktuálnou obrazovkou. Môžete ho využiť pri budovaní značky, pomenúvaní obrazoviek, navigácii a rôznych akciách.';

  @override
  String get demoBottomAppBarTitle => 'Dolný panel aplikácií';

  @override
  String get demoBottomAppBarSubtitle => 'Zobrazuje v dolnej časti navigáciu a akcie';

  @override
  String get demoBottomAppBarDescription => 'Dolné panely aplikácií poskytujú prístup k dolnému navigačnému vysúvaciemu panelu a až štyrom akciám (vrátane plávajúceho tlačidla akcie).';
  ...
  @override
  String get demoBannerDescription => 'Banner zobrazuje dôležitú nadväzujúcu správu a poskytuje akcie, pomocou ktorých môžu používatelia vybrať možnosti v ňom (alebo ho zavrieť). Na jeho zavretie sa vyžaduje akcia používateľa.';

  @override
  String get demoBottomNavigationTitle => 'Dolná navigácia';

  @override
  String get demoBottomNavigationSubtitle => 'Dolná navigácia s prelínajúcimi sa zobrazeniami';
  ...
  @override
  String get demoBottomNavigationDescription => 'Dolné navigačné panely zobrazujú v dolnej časti obrazovky tri až päť cieľov. Každý cieľ prestavuje ikona a nepovinný textový štítok. Používateľ, ktorý klepne na ikonu dolnej navigácie, prejde do cieľa navigácie najvyššej úrovne, ktorá je s touto ikonou spojená.';

  @override
  String get demoButtonTitle => 'Tlačidlá';

  @override
  String get demoButtonSubtitle => 'Textové, zvýšené, s obrysom a ďalšie';

  @override
  String get demoTextButtonTitle => 'Textové tlačidlo';

  @override
  String get demoTextButtonDescription => 'Textové tlačidlo po stlačení zobrazí atramentovú škvrnu, ale nezvýši sa. Textové tlačidlá používajte v paneloch s nástrojmi, dialógových oknách a texte s odsadením';

  @override
  String get demoElevatedButtonTitle => 'Zvýšené tlačidlo';

  @override
  String get demoElevatedButtonDescription => 'Zvýšené tlačidlá pridávajú rozmery do prevažne plochých rozložení. Zvýrazňujú funkcie v neprehľadných alebo širokých priestoroch.';

  @override
  String get demoOutlinedButtonTitle => 'Tlačidlo s obrysom';

  @override
  String get demoOutlinedButtonDescription => 'Tlačidlá s obrysom sa po stlačení zmenia na nepriehľadné a zvýšia sa. Často sú spárované so zvýšenými tlačidlami na označenie alternatívnej sekundárnej akcie.';

  @override
  String get demoToggleButtonTitle => 'Prepínače';

  @override
  String get demoToggleButtonDescription => 'Pomocou prepínačov môžete zoskupiť súvisiace možnosti. Skupina by mala zdieľať spoločný kontajner na zvýraznenie skupín súvisiacich prepínačov';

  @override
  String get demoFloatingButtonTitle => 'Plávajúce tlačidlo akcie';

  @override
  String get demoFloatingButtonDescription => 'Plávajúce tlačidlo akcie je okrúhla ikona vznášajúca sa nad obsahom propagujúca primárnu akciu v aplikácii.';
  ...
  @override
  String get demoCardDescription => 'Karta je hárok vzhľadu Material, ktorá predstavuje niektoré súvisiace informácie, napríklad album, zemepisnú polohu, jedlo, kontaktné údaje a podobne.';

  @override
  String get demoChipSubtitle => 'Kompaktné prvky predstavujúce vstup, atribút alebo akciu';

  @override
  String get demoActionChipTitle => 'Prvok akcie';

  @override
  String get demoActionChipDescription => 'Prvky akcie sú skupina možností spúšťajúcich akcie súvisiace s hlavným obsahom. V používateľskom rozhraní by sa mali zobrazovať dynamicky a v kontexte.';

  @override
  String get demoChoiceChipTitle => 'Prvok výberu';

  @override
  String get demoChoiceChipDescription => 'Prvky výberu predstavujú jednotlivé možnosti z určitej skupiny. Obsahujú súvisiaci popisný text alebo kategórie.';

  @override
  String get demoFilterChipTitle => 'Prvok filtra';

  @override
  String get demoFilterChipDescription => 'Prvky filtra odfiltrujú obsah pomocou značiek alebo popisných slov.';

  @override
  String get demoInputChipTitle => 'Prvok vstupu';

  @override
  String get demoInputChipDescription => 'Prvky vstupu sú komplexné informácie, napríklad subjekt (osoba, miesto, vec) alebo text konverzácie, uvedené v kompaktnej podobe.';
  ...
  @override
  String get demoDataTableDescription => 'Tabuľky údajov zobrazujú informácie vo formáte pripomínajúcom mriežku riadkov a stĺpcov. Usporiadavajú informácie tak, že sa dajú ľahko vyhľadať, takže používatelia môžu hľadať vzory a štatistiky.';
  ...
  @override
  String get demoAlertDialogDescription => 'Dialógové okno upozornenia informuje používateľa o situáciách, ktoré vyžadujú potvrdenie. Má voliteľný názov a voliteľný zoznam akcií.';
  ...
  @override
  String get demoSimpleDialogDescription => 'Jednoduché dialógové okno poskytuje používateľovi výber medzi viacerými možnosťami. Má voliteľný názov, ktorý sa zobrazuje nad možnosťami.';

  @override
  String get demoDividerTitle => 'Rozdeľovač';

  @override
  String get demoDividerSubtitle => 'Rozdeľovač je tenká čiara umožňujúca zoskupiť obsah v zoznamoch a rozloženiach.';

  @override
  String get demoDividerDescription => 'Pomocou rozdeľovačov môžete oddeliť obsah v zoznamoch, vysúvacích paneloch a inde.';

  @override
  String get demoVerticalDividerTitle => 'Vertikálny rozdeľovač';
  ...
  @override
  String get demoGridListsDescription => 'Mriežkové zoznamy sú najvhodnejšie na prezentáciu homogénnych dát, zvyčajne obrázkov. Jednotlivé položky v mriežkovom zozname sa nazývajú dlaždice.';
  ...
  @override
  String get demoSlidersSubtitle => 'Miniaplikácie na výber hodnoty potiahnutím';

  @override
  String get demoSlidersDescription => 'Posúvače predstavujú rozsah hodnôt na pruhu, z ktorých si môžu používatelia jednu vybrať. Sú ideálne na úpravu nastavení, ako je napríklad hlasitosť, jas alebo použitie filtrov obrázkov.';

  @override
  String get demoRangeSlidersTitle => 'Posúvače s rozsahom';

  @override
  String get demoRangeSlidersDescription => 'Posúvače predstavujú rozsah hodnôt na pruhu. Môžu mať na oboch koncoch pruhu ikony označujúce rozsah hodnôt. Sú ideálne na úpravu nastavení, ako je napríklad hlasitosť, jas alebo použitie filtrov obrázkov.';

  @override
  String get demoCustomSlidersTitle => 'Vlastné posúvače';

  @override
  String get demoCustomSlidersDescription => 'Posúvače predstavujú rozsah hodnôt na pruhu, z ktorých si môžu používatelia vybrať jednu hodnotu alebo určitý rozsah. Môžete im pridať motív alebo si ich prispôsobiť.';

  @override
  String get demoSlidersContinuousWithEditableNumericalValue => 'Neobmedzený s upraviteľnou číselnou hodnotou';

  @override
  String get demoSlidersDiscrete => 'Diskrétny';

  @override
  String get demoSlidersDiscreteSliderWithCustomTheme => 'Diskrétny posúvač s vlastným motívom';

  @override
  String get demoSlidersContinuousRangeSliderWithCustomTheme => 'Neobmedzený posúvač rozsahu a vlastným motívom';
  ...
  @override
  String get demoMenuDescription => 'Ponuka zobrazuje zoznam možností v dočasnom okne. Spustí sa pri interakcii používateľov s tlačidlom, akciou alebo iným ovládacím prvkom.';
  ...
  @override
  String get demoMenuAnItemWithAContextMenuButton => 'Položka s kontextovou ponukou';
  ...
  @override
  String get demoMenuContextMenuItemThree => 'Tretia položka kontextovej ponuky';
  ...
  @override
  String get demoNavigationDrawerTitle => 'Navigačný vysúvací panel';

  @override
  String get demoNavigationDrawerSubtitle => 'Zobrazuje sa vysúvací panel v rámci panela aplikácií';

  @override
  String get demoNavigationDrawerDescription => 'Panel so vzhľadom Material Design, ktorý sa vysúva vodorovne smerom od okraja obrazovky a zobrazuje odkazy na navigáciu v aplikácii.';

  @override
  String get demoNavigationDrawerUserName => 'Meno používateľa';

  @override
  String get demoNavigationDrawerUserEmail => 'user.name@example.com';

  @override
  String get demoNavigationDrawerToPageOne => 'Prvá položka';

  @override
  String get demoNavigationDrawerToPageTwo => 'Druhá položka';

  @override
  String get demoNavigationDrawerText => 'Vysúvací panel zobrazíte potiahnutím smerom od okraja alebo klepnutím na hornú ľavú ikonu.';

  @override
  String get demoNavigationRailTitle => 'Navigačný pruh';

  @override
  String get demoNavigationRailSubtitle => 'Zobrazenie navigačného pruhu v aplikácii';

  @override
  String get demoNavigationRailDescription => 'Miniaplikácia so vzhľadom Material Design, ktorá sa má zobrazovať na ľavej alebo pravej strane aplikácie a umožňovať navigáciu medzi menším počtom zobrazení (zvyčajne troma až piatimi).';

  @override
  String get demoNavigationRailFirst => 'Prvý';

  @override
  String get demoNavigationRailSecond => 'Druhý';

  @override
  String get demoNavigationRailThird => 'Tretí';

  @override
  String get demoMenuAnItemWithASimpleMenu => 'Položka s jednoduchou ponukou';

  @override
  String get demoMenuAnItemWithAChecklistMenu => 'Položka s ponukou kontrolného zoznamu';

  @override
  String get demoFullscreenDialogTitle => 'Celá obrazovka';

  @override
  String get demoFullscreenDialogDescription => 'Hodnota fullscreenDialog určuje, či je prichádzajúca stránka modálne dialógové okno na celú obrazovku';

  @override
  String get demoCupertinoActivityIndicatorTitle => 'Indikátor aktivity';

  @override
  String get demoCupertinoActivityIndicatorSubtitle => 'Indikátory aktivity v štýle systému iOS';

  @override
  String get demoCupertinoActivityIndicatorDescription => 'Indikátor aktivity v štýle systému iOS, ktorý sa otáča v smere hodinových ručičiek.';
  ...
  @override
  String get demoCupertinoButtonsDescription => 'Tlačidlo v štýle systému iOS. Zahŕňa text a ikonu, ktorá sa po dotyku stmaví alebo vybledne. Voliteľne môže mať aj pozadie.';

  @override
  String get demoCupertinoContextMenuTitle => 'Kontextová ponuka';

  @override
  String get demoCupertinoContextMenuSubtitle => 'Kontextová ponuka typu iOS';

  @override
  String get demoCupertinoContextMenuDescription => 'Kontextová ponuka typu iOS sa zobrazí na celej obrazovke, keď dlho stlačíte určitý prvok.';

  @override
  String get demoCupertinoContextMenuActionOne => 'Prvá akcia';

  @override
  String get demoCupertinoContextMenuActionTwo => 'Druhá akcia';

  @override
  String get demoCupertinoContextMenuActionText => 'Kontextovú ponuku zobrazíte pridržaním loga Flutter.';

  @override
  String get demoCupertinoAlertsTitle => 'Upozornenia';

  @override
  String get demoCupertinoAlertsSubtitle => 'Dialógové okná upozornení v štýle systému iOS';

  @override
  String get demoCupertinoAlertTitle => 'Upozornenie';

  @override
  String get demoCupertinoAlertDescription => 'Dialógové okno upozornenia informuje používateľa o situáciách, ktoré vyžadujú potvrdenie. Dialógové okno upozornenia má voliteľný názov, obsah aj zoznam akcií. Názov sa zobrazuje nad obsahom a akcie pod obsahom.';
  ...
  @override
  String get demoCupertinoActionSheetDescription => 'Hárok s akciami je špecifický štýl upozornenia ponúkajúceho používateľovi dve alebo viac možností, ktoré sa týkajú aktuálneho kontextu. Má názov, dodatočnú správu a zoznam akcií.';

  @override
  String get demoCupertinoNavigationBarTitle => 'Navigačný panel';

  @override
  String get demoCupertinoNavigationBarSubtitle => 'Navigačný panel v štýle systému iOS';

  @override
  String get demoCupertinoNavigationBarDescription => 'Ide o navigačný panel v štýle systému iOS. Navigačný panel je panel s nástrojmi, ktorý vo svojom strede minimálne obsahuje názov stránky.';

  @override
  String get demoCupertinoPickerTitle => 'Výbery';

  @override
  String get demoCupertinoPickerSubtitle => 'Výbery dátumu a času v štýle systému iOS';

  @override
  String get demoCupertinoPickerDescription => 'Pomocou miniaplikácie výberu v štýle systému iOS môžete vybrať dátumy, časy, alebo oboje.';
  ...
  @override
  String get demoCupertinoPullToRefreshSubtitle => 'Potiahnutie v štýle systému iOS na obnovenie riadenia';

  @override
  String get demoCupertinoPullToRefreshDescription => 'Miniaplikácia s implementovaným potiahnutím v štýle systému iOS, ktoré umožňuje obnoviť riadenie obsahu.';

  @override
  String get demoCupertinoSegmentedControlTitle => 'Segmentované ovládanie';

  @override
  String get demoCupertinoSegmentedControlSubtitle => 'Segmentované ovládanie v štýle systému iOS';

  @override
  String get demoCupertinoSegmentedControlDescription => 'Pomocou tejto funkcie môžete vyberať medzi viacerými navzájom sa vylučujúcimi možnosťami. Po vybraní jednej možnosti v segmentovanom ovládaní sa výber ostatných zruší.';
  ...
  @override
  String get demoCupertinoSliderDescription => 'Posúvačom je možné vyberať hodnoty zo súvislej aj nesúvislej skupiny.';
  ...
  @override
  String get demoCupertinoSwitchDescription => 'Prepínačom je možné prepínať stav zapnuté alebo vypnuté pre jedno nastavenie.';

  @override
  String get demoCupertinoTabBarTitle => 'Panel kariet';

  @override
  String get demoCupertinoTabBarSubtitle => 'Spodný panel kariet v štýle systému iOS';

  @override
  String get demoCupertinoTabBarDescription => 'Spodný navigačný panel kariet v štýle systému iOS. Zobrazuje viacero kariet, z ktorých je jedna aktívna. Predvolene je to prvá karta.';
  ...
  @override
  String get demoCupertinoTextFieldSubtitle => 'Textové polia v štýle systému iOS';

  @override
  String get demoCupertinoTextFieldDescription => 'Textové pole umožňuje používateľovi zadávať text, či už pomocou hardvérovej klávesnice, alebo tej na obrazovke.';
  ...
  @override
  String get demoContainerTransformDemoInstructions => 'Karty, zoznamy a plávajúce tlačidlo akcie';

  @override
  String get demoSharedXAxisDemoInstructions => 'Tlačidlá Ďalej a Späť';

  @override
  String get demoSharedYAxisDemoInstructions => 'Zoradiť podľa nedávno počúvaných';

  @override
  String get demoSharedZAxisDemoInstructions => 'Tlačidlo ikony nastavení';

  @override
  String get demoFadeThroughDemoInstructions => 'Dolná navigácia';

  @override
  String get demoFadeScaleDemoInstructions => 'Modálne a plávajúce tlačidlo akcie';

  @override
  String get demoContainerTransformTitle => 'Transformácia kontajnera';

  @override
  String get demoContainerTransformDescription => 'Vzor transformácie kontajnera je určený pre prechody medzi prvkami používateľského rozhrania, ktoré obsahujú kontajner. Tento vzor vytvára viditeľné spojenie medzi dvoma prvkami používateľského rozhrania';
  ...
  @override
  String get demoSharedAxisDescription => 'Vzor zdieľanej osi sa používa v prípade prechodov medzi prvkami používateľského rozhrania, ktoré sú v priestorovom alebo navigačnom vzájomnom vzťahu. Tento vzor používa zdieľanú transformáciu na osiach x, y alebo z na upevnenie vzťahov medzi prvkami.';
  ...
  @override
  String get demoSharedXAxisCoursePageSubtitle => 'Kategórie v balíkoch sa v informačnom kanáli zobrazujú ako skupiny. Toto nastavenie môžete neskôr zmeniť.';
  ...
  @override
  String get demoSharedXAxisSignInTextFieldLabel => 'E‑mail alebo telefónne číslo';
  ...
  @override
  String get demoSharedZAxisShrimpPlateRecipeDescription => 'Recept na krevetový tanier';

  @override
  String get demoSharedZAxisCrabPlateRecipeTitle => 'Krab';

  @override
  String get demoSharedZAxisCrabPlateRecipeDescription => 'Recept na krabí tanier';

  @override
  String get demoSharedZAxisBeefSandwichRecipeTitle => 'Hovädzí sendvič';

  @override
  String get demoSharedZAxisBeefSandwichRecipeDescription => 'Recept na hovädzí sendvič';
  ...
  @override
  String get demoFadeThroughDescription => 'Vzor postupného miznutia sa používa v prípade prechodov medzi prvkami používateľského rozhrania, ktoré nie sú v silnom vzájomnom vzťahu.';
  ...
  @override
  String get demoFadeScaleDescription => 'Vzor miznutia sa používa v prípade prvkov používateľského rozhrania, ktoré sa zobrazujú alebo miznú niekde na obrazovke. Môže to byť napríklad dialógové okno, ktoré postupne zmizne v strede obrazovky.';

  @override
  String get demoFadeScaleShowAlertDialogButton => 'ZOBRAZIŤ MODÁLNE DIALÓGOVÉ OKNO';
  ...
  @override
  String get demoColorsDescription => 'Konštantné farby a vzorka farieb, ktoré predstavujú paletu farieb vzhľadu Material Design.';
  ...
  @override
  String get demoTypographyDescription => 'Definície rôznych typografických štýlov vo vzhľade Material Design.';

  @override
  String get demo2dTransformationsTitle => '2D transformácie';

  @override
  String get demo2dTransformationsSubtitle => 'Posunutie, priblíženie a otočenie';

  @override
  String get demo2dTransformationsDescription => 'Klepnutím upavujte dlaždice a gestami sa pohybujte po okolí. Posúvajte presunutím, približujte stiahnutím prstov a otáčajte dvoma prstami. Na začiatočnú orientáciu sa vrátite stlačením tlačidla Resetovať.';
  ...
  @override
  String get demoBottomSheetPersistentDescription => 'Trvalý dolný hárok zobrazuje informácie doplňujúce hlavný obsah aplikácie. Zobrazuje sa neustále, aj keď používateľ interaguje s inými časťami aplikácie.';

  @override
  String get demoBottomSheetModalTitle => 'Modálny dolný hárok';

  @override
  String get demoBottomSheetModalDescription => 'Modálny dolný hárok je alternatíva k ponuke alebo dialógovému oknu. Bráni používateľovi interagovať so zvyškom aplikácie.';
  ...
  @override
  String get demoListsDescription => 'Jeden riadok s pevnou výškou, ktorý obvykle obsahuje text a ikonu na začiatku alebo na konci.';
  ...
  @override
  String get demoCircularProgressIndicatorDescription => 'Kruhový indikátor priebehu so vzhľadom Material Design, ktorý sa otáča, keď je aplikácia zaneprázdnená.';

  @override
  String get demoLinearProgressIndicatorTitle => 'Lineárny indikátor priebehu';

  @override
  String get demoLinearProgressIndicatorDescription => 'Lineárny indikátor priebehu so vzhľadom Material Design, ktorý sa nazýva aj ukazovateľ priebehu.';
  ...
  @override
  String get demoDatePickerDescription => 'Zobrazuje dialógové okno s výberom dátumu so vzhľadom Material Design.';

  @override
  String get demoTimePickerTitle => 'Výber času';

  @override
  String get demoTimePickerDescription => 'Zobrazuje dialógové okno s výberom času so vzhľadom Material Design.';

  @override
  String get demoDateRangePickerTitle => 'Výber obdobia';

  @override
  String get demoDateRangePickerDescription => 'Zobrazuje dialógové okno výberu dátumu so vzhľadom Material Design.';
  ...
  @override
  String get demoTabsSubtitle => 'Karty so samostatne posúvateľnými zobrazeniami';

  @override
  String get demoTabsDescription => 'Karty usporiadajú obsah z rôznych obrazoviek, množín údajov a ďalších interakcií.';

  @override
  String get demoSnackbarsTitle => 'Oznámenia';

  @override
  String get demoSnackbarsSubtitle => 'Oznámenia zobrazujú správy v dolnej časti obrazovky';

  @override
  String get demoSnackbarsDescription => 'Oznámenia informujú používateľov o procese, ktorý aplikácia vykonáva alebo bude vykonávať. Zobrazujú sa dočasne v dolnej časti obrazovky. Nemali by rušiť dojem používateľov a na zrušenie ich zobrazovania nie je zo strany používateľa potrebná žiadna akcia.';
  ...
  @override
  String get demoSelectionControlsSubtitle => 'Začiarkavacie políčka a prepínače';

  @override
  String get demoSelectionControlsCheckboxTitle => 'Začiarkavacie políčko';

  @override
  String get demoSelectionControlsCheckboxDescription => 'Začiarkavacie políčka umožňujú používateľovi vybrať viacero možností zo skupiny možností. Hodnota bežného začiarkavacieho políčka je pravda alebo nepravda. Hodnota začiarkavacieho políčka s troma stavmi môže byť tiež nulová.';

  @override
  String get demoSelectionControlsRadioTitle => 'Prepínač';

  @override
  String get demoSelectionControlsRadioDescription => 'Prepínače umožňujú používateľovi vybrať jednu položku zo skupiny možností. Prepínače použite na výhradný výber, ak sa domnievate, že používateľ by mal vidieť všetky dostupné možnosti vedľa seba.';

  @override
  String get demoSelectionControlsSwitchTitle => 'Prepínač';

  @override
  String get demoSelectionControlsSwitchDescription => 'Prepínače na zapnutie alebo vypnutie stavu jednej možnosti nastavení. Príslušná možnosť, ktorú prepínač ovláda, ako aj stav, v ktorom sa nachádza, by mali jasne vyplývať zo zodpovedajúceho vloženého štítka.';
  ...
  @override
  String get demoTextFieldSubtitle => 'Jeden riadok upraviteľného textu a čísel';

  @override
  String get demoTextFieldDescription => 'Textové polia umožňujú používateľom zadávať text do používateľského rozhrania. Zvyčajne sa nachádzajú vo formulároch a dialógových oknách.';
  ...
  @override
  String get demoTextFieldFormErrors => 'Pred odoslaním odstráňte chyby označené červenou.';

  @override
  String get demoTextFieldNameRequired => 'Meno je povinné.';

  @override
  String get demoTextFieldOnlyAlphabeticalChars => 'Zadajte iba abecedné znaky.';

  @override
  String get demoTextFieldEnterUSPhoneNumber => '(###) ###-#### – Zadajte telefónne číslo v USA.';
  ...
  @override
  String get demoTextFieldWhatDoPeopleCallYou => 'V súvislosti s čím vám ľudia volajú?';

  @override
  String get demoTextFieldNameField => 'Názov*';

  @override
  String get demoTextFieldWhereCanWeReachYou => 'Na akom čísle sa môžeme s vami spojiť?';
  ...
  @override
  String get demoTextFieldTellUsAboutYourself => 'Povedzte nám o sebe (napíšte napríklad, kde pracujete alebo aké máte záľuby)';

  @override
  String get demoTextFieldKeepItShort => 'Napíšte stručný text. Toto je iba ukážka.';
  ...
  @override
  String get demoTooltipSubtitle => 'Krátka správa zobrazujúca sa po dlhom stlačení alebo umiestnení kurzora myši';

  @override
  String get demoTooltipDescription => 'Popisy poskytujú textové štítky, ktoré pomáhajú vysvetliť funkciu tlačidla alebo inej akcie v používateľskom rozhraní. Zobrazujú informatívny text, keď používatelia umiestnia kurzor myši na prvok, označia ho alebo ho dlho stlačia.';

  @override
  String get demoTooltipInstructions => 'Popis zobrazíte dlhým stlačením alebo umiestnením kurzora myši.';
  ...
  @override
  String get dialogLocationTitle => 'Chcete použiť službu určovania polohy od Googlu?';

  @override
  String get dialogLocationDescription => 'Povoľte, aby mohol Google pomáhať aplikáciám určovať polohu. Znamená to, že do Googlu budú odosielané anonymné údaje o polohe, aj keď nebudú spustené žiadne aplikácie.';
  ...
  @override
  String get dialogFullscreenDescription => 'Ukážka dialógového okna na celú obrazovku';
  ...
  @override
  String get cupertinoAlertLocationTitle => 'Chcete povoliť Mapám prístup k vašej polohe, keď túto aplikáciu používate?';

  @override
  String get cupertinoAlertLocationDescription => 'Vaša aktuálna poloha sa zobrazí na mape a budú sa pomocou nej vyhľadávať trasy, výsledky vyhľadávania v okolí a odhadované časy cesty.';
  ...
  @override
  String get cupertinoAlertDessertDescription => 'Vyberte si v zozname nižšie svoj obľúbený typ dezertu. Na základe vášho výberu sa prispôsobí zoznam navrhovaných reštaurácií vo vašom okolí.';
  ...
  @override
  String get starterAppDescription => 'Responzívne rozloženie štartovacej aplikácie';
  ...
  @override
  String get shrineProductWalterHenleyWhite => 'Tričko bez límca so zapínaním Walter (biele)';
  ...
  @override
  String get shrineProductClassicWhiteCollar => 'Klasická košeľa s bielym límcom';
  ...
  @override
  String get craneFly0SemanticLabel => 'Chata v zasneženej krajine s ihličnatými stromami';

  @override
  String get craneFly1SemanticLabel => 'Stan na poli';

  @override
  String get craneFly2SemanticLabel => 'Modlitebné vlajky so zasneženou horou v pozadí';
  ...
  @override
  String get craneFly5SemanticLabel => 'Hotel na brehu jazera s horami v pozadí';

  @override
  String get craneFly6SemanticLabel => 'Letecký pohľad na palác Palacio de Bellas Artes';
  ...
  @override
  String get craneFly9SemanticLabel => 'Muž opierajúci sa o starodávne modré auto';
  ...
  @override
  String get craneSleep1SemanticLabel => 'Chata v zasneženej krajine s ihličnatými stromami';

  @override
  String get craneSleep2SemanticLabel => 'Citadela Machu Picchu';

  @override
  String get craneSleep3SemanticLabel => 'Muž opierajúci sa o starodávne modré auto';

  @override
  String get craneSleep4SemanticLabel => 'Hotel na brehu jazera s horami v pozadí';
  ...
  @override
  String get craneSleep7SemanticLabel => 'Pestrofarebné byty na námestí Riberia';
  ...
  @override
  String get craneSleep10SemanticLabel => 'Veže mešity Al-Azhar pri západe slnka';

  @override
  String get craneSleep11SemanticLabel => 'Mrakodrap Taipei 101';

  @override
  String get craneEat0SemanticLabel => 'Pizza v peci na drevo';

  @override
  String get craneEat1SemanticLabel => 'Prázdny bar so stoličkami v bufetovom štýle';
  ...
  @override
  String get craneEat5SemanticLabel => 'Priestor na sedenie v umeleckej reštaurácii';
  ...
  @override
  String get fortnightlyTrendingHealthcareRevolution => 'Revolúcia v zdravotníctve';
  ...
  @override
  String get fortnightlyHeadlineHealthcare => 'Tichá, ale zároveň účinná revolúcia v zdravotníctve';

  @override
  String get fortnightlyHeadlineWar => 'Rozdelené životy američanov počas vojny';
  ...
  @override
  String get fortnightlyHeadlineStocks => 'V čase stagnácie akcií sa mnohí sústreďujú na menu';

  @override
  String get fortnightlyHeadlineFabrics => 'Pomocou technológií vyrábajú návrhári futuristické látky';

  @override
  String get fortnightlyHeadlineFeminists => 'Feministky sa vrhli na partizánstvo';
  ...
  @override
  String get replyStarredLabel => 'S hviezdičkou';

  @override
  String get replySentLabel => 'Odoslané';

  @override
  String get replyTrashLabel => 'Kôš';

  @override
  String get replySpamLabel => 'Spam';

  @override
  String get replyDraftsLabel => 'Koncepty';

  @override
  String get demoTwoPaneFoldableLabel => 'Skladacie';

  @override
  String get demoTwoPaneFoldableDescription => 'Takto sa TwoPane správa v skladacom zariadení.';

  @override
  String get demoTwoPaneSmallScreenLabel => 'Malá obrazovka';

  @override
  String get demoTwoPaneSmallScreenDescription => 'Takto sa TwoPane správa v zariadení s malou obrazovkou.';

  @override
  String get demoTwoPaneTabletLabel => 'Tablet a počítač';

  @override
  String get demoTwoPaneTabletDescription => 'Takto sa TwoPane správa na väčšej obrazovke, napríklad v tablete alebo počítači';

  @override
  String get demoTwoPaneTitle => 'TwoPane';

  @override
  String get demoTwoPaneSubtitle => 'Responzívne rozloženia v skladacích zariadeniach a zariadeniach s veľkými a malými obrazovkami';

  @override
  String get splashSelectDemo => 'Vyberte demo';

  @override
  String get demoTwoPaneList => 'Zoznam';

  @override
  String get demoTwoPaneDetails => 'Podrobnosti';

  @override
  String get demoTwoPaneSelectItem => 'Vyberte položku';
