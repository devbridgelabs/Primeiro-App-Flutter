...
Future<Map> getData() async {
  var request =
      Uri.parse('https://api.hgbrasil.com/finance?format=json&key=ede84ae8');
...
class ConversorDeMoedasPage extends StatefulWidget {
  const ConversorDeMoedasPage({Key? key}) : super(key: key);

  @override
  State<ConversorDeMoedasPage> createState() => _ConversorDeMoedasPageState();
}
