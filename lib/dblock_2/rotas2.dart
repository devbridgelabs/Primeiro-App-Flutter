...
class Rotas2 extends StatefulWidget {
  const Rotas2({Key? key}) : super(key: key);

  @override
  State<Rotas2> createState() => _Rotas2State();
}

class _Rotas2State extends State<Rotas2> {
  ...
  GoogleMapPolyline googleMapPolyline =
      new GoogleMapPolyline(apiKey: "here your key");
